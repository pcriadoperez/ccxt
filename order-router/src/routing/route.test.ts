...
const OPTS = (o: Partial<RouteOptions> = {}): RouteOptions => ({
    ...
    minLegNotional: 0, staleBookMs: 5000, requestId: 'test-req', certifiedOnly: false, requireFullFill: false, stalenessPenaltyBps: 0, hopPenaltyBps: 0, includeQuotes: true, ...o,
});
