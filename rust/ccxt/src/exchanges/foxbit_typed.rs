...
//
// Typed wrapper for foxbit.
//
// Owns a `Box<FoxbitCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::foxbit::FoxbitCore;
use crate::types::*;
...
impl Foxbit {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(FoxbitCore::new(config)) }
    }

    pub fn from_core(core: FoxbitCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut FoxbitCore {
        &mut self.core
    }
...
impl std::ops::Deref for Foxbit {
    type Target = FoxbitCore;
...
impl crate::typed::TypedExchange for Foxbit {
