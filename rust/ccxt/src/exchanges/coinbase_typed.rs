...
//
// Typed wrapper for coinbase.
//
// Owns a `Box<CoinbaseCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::coinbase::CoinbaseCore;
use crate::types::*;
...
pub struct Coinbase {
    ...
    core: Box<CoinbaseCore>,
}

impl Coinbase {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(CoinbaseCore::new(config)) }
    }

    pub fn from_core(core: CoinbaseCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut CoinbaseCore {
        &mut self.core
    }
...
impl std::ops::Deref for Coinbase {
    type Target = CoinbaseCore;
...
impl crate::typed::TypedExchange for Coinbase {
