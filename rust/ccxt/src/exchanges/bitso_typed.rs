...
//
// Typed wrapper for bitso.
//
// Owns a `Box<BitsoCore>` and exposes the unified CCXT API
...
impl Bitso {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BitsoCore::new(config)) }
    }

    pub fn from_core(core: BitsoCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BitsoCore {
        &mut self.core
    }
...
impl std::ops::Deref for Bitso {
    type Target = BitsoCore;
...
impl crate::typed::TypedExchange for Bitso {
