...
//
// Typed wrapper for kraken.
//
// Owns a `Box<KrakenCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::kraken::KrakenCore;
use crate::types::*;
...
impl Kraken {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(KrakenCore::new(config)) }
    }

    pub fn from_core(core: KrakenCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut KrakenCore {
        &mut self.core
    }
...
impl std::ops::Deref for Kraken {
    type Target = KrakenCore;
...
impl crate::typed::TypedExchange for Kraken {
