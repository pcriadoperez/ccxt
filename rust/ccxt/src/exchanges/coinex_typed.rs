...
//
// Typed wrapper for coinex.
//
// Owns a `Box<CoinexCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::coinex::CoinexCore;
use crate::types::*;
...
impl Coinex {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(CoinexCore::new(config)) }
    }

    pub fn from_core(core: CoinexCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut CoinexCore {
        &mut self.core
    }
...
impl std::ops::Deref for Coinex {
    type Target = CoinexCore;
...
impl crate::typed::TypedExchange for Coinex {
