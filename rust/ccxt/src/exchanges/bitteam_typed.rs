...
//
// Typed wrapper for bitteam.
//
// Owns a `Box<BitteamCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::bitteam::BitteamCore;
use crate::types::*;
...
pub struct Bitteam {
    ...
    core: Box<BitteamCore>,
}

impl Bitteam {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BitteamCore::new(config)) }
    }

    pub fn from_core(core: BitteamCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BitteamCore {
        &mut self.core
    }
...
impl std::ops::Deref for Bitteam {
    type Target = BitteamCore;
