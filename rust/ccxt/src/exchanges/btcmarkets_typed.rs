...
//
// Typed wrapper for btcmarkets.
//
// Owns a `Box<BtcmarketsCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::btcmarkets::BtcmarketsCore;
use crate::types::*;
...
pub struct Btcmarkets {
    ...
    core: Box<BtcmarketsCore>,
}

impl Btcmarkets {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BtcmarketsCore::new(config)) }
    }

    pub fn from_core(core: BtcmarketsCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BtcmarketsCore {
        &mut self.core
    }
...
impl std::ops::Deref for Btcmarkets {
    type Target = BtcmarketsCore;
...
impl crate::typed::TypedExchange for Btcmarkets {
