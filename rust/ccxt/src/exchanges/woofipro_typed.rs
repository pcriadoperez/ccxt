...
//
// Typed wrapper for woofipro.
//
// Owns a `Box<WoofiproCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::woofipro::WoofiproCore;
use crate::types::*;
...
pub struct Woofipro {
    ...
    core: Box<WoofiproCore>,
}

impl Woofipro {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(WoofiproCore::new(config)) }
    }

    pub fn from_core(core: WoofiproCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut WoofiproCore {
        &mut self.core
    }
...
impl std::ops::Deref for Woofipro {
    type Target = WoofiproCore;
...
impl crate::typed::TypedExchange for Woofipro {
