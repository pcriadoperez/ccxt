...
//
// Typed wrapper for binanceusdm.
//
// Owns a `Box<BinanceusdmCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::binanceusdm::BinanceusdmCore;
use crate::types::*;
...
pub struct Binanceusdm {
    ...
    core: Box<BinanceusdmCore>,
}

impl Binanceusdm {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BinanceusdmCore::new(config)) }
    }

    pub fn from_core(core: BinanceusdmCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BinanceusdmCore {
        &mut self.core
    }
...
impl std::ops::Deref for Binanceusdm {
    type Target = BinanceusdmCore;
...
impl crate::typed::TypedExchange for Binanceusdm {
