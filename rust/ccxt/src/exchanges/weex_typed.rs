...
//
// Typed wrapper for weex.
//
// Owns a `Box<WeexCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::weex::WeexCore;
use crate::types::*;
...
impl Weex {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(WeexCore::new(config)) }
    }

    pub fn from_core(core: WeexCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut WeexCore {
        &mut self.core
    }
...
impl std::ops::Deref for Weex {
    type Target = WeexCore;
...
impl crate::typed::TypedExchange for Weex {
