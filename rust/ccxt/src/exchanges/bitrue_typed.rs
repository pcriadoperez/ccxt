...
//
// Typed wrapper for bitrue.
//
// Owns a `Box<BitrueCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::bitrue::BitrueCore;
use crate::types::*;
...
impl Bitrue {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BitrueCore::new(config)) }
    }

    pub fn from_core(core: BitrueCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BitrueCore {
        &mut self.core
    }
...
impl std::ops::Deref for Bitrue {
    type Target = BitrueCore;
...
impl crate::typed::TypedExchange for Bitrue {
