...
//
// Typed wrapper for kucoin.
//
// Owns a `Box<KucoinCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::kucoin::KucoinCore;
use crate::types::*;
...
impl Kucoin {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(KucoinCore::new(config)) }
    }

    pub fn from_core(core: KucoinCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut KucoinCore {
        &mut self.core
    }
...
impl std::ops::Deref for Kucoin {
    type Target = KucoinCore;
...
impl crate::typed::TypedExchange for Kucoin {
