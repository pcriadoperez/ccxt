...
//
// Typed wrapper for grvt.
//
// Owns a `Box<GrvtCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::grvt::GrvtCore;
use crate::types::*;
...
impl Grvt {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(GrvtCore::new(config)) }
    }

    pub fn from_core(core: GrvtCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut GrvtCore {
        &mut self.core
    }
...
impl std::ops::Deref for Grvt {
    type Target = GrvtCore;
...
impl crate::typed::TypedExchange for Grvt {
