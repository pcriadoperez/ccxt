...
//
// Typed wrapper for binanceus.
//
// Owns a `Box<BinanceusCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::binanceus::BinanceusCore;
use crate::types::*;
...
pub struct Binanceus {
    ...
    core: Box<BinanceusCore>,
}

impl Binanceus {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BinanceusCore::new(config)) }
    }

    pub fn from_core(core: BinanceusCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BinanceusCore {
        &mut self.core
    }
...
impl std::ops::Deref for Binanceus {
    type Target = BinanceusCore;
...
impl crate::typed::TypedExchange for Binanceus {
