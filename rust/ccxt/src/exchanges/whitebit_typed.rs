...
//
// Typed wrapper for whitebit.
//
// Owns a `Box<WhitebitCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::whitebit::WhitebitCore;
use crate::types::*;
...
pub struct Whitebit {
    ...
    core: Box<WhitebitCore>,
}

impl Whitebit {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(WhitebitCore::new(config)) }
    }

    pub fn from_core(core: WhitebitCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut WhitebitCore {
        &mut self.core
    }
...
impl std::ops::Deref for Whitebit {
    type Target = WhitebitCore;
...
impl crate::typed::TypedExchange for Whitebit {
