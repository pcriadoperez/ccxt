...
//
// Typed wrapper for tokocrypto.
//
// Owns a `Box<TokocryptoCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::tokocrypto::TokocryptoCore;
use crate::types::*;
...
pub struct Tokocrypto {
    ...
    core: Box<TokocryptoCore>,
}

impl Tokocrypto {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(TokocryptoCore::new(config)) }
    }

    pub fn from_core(core: TokocryptoCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut TokocryptoCore {
        &mut self.core
    }
...
impl std::ops::Deref for Tokocrypto {
    type Target = TokocryptoCore;
...
impl crate::typed::TypedExchange for Tokocrypto {
