...
//
// Typed wrapper for zaif.
//
// Owns a `Box<ZaifCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::zaif::ZaifCore;
use crate::types::*;
...
impl Zaif {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(ZaifCore::new(config)) }
    }

    pub fn from_core(core: ZaifCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut ZaifCore {
        &mut self.core
    }
...
impl std::ops::Deref for Zaif {
    type Target = ZaifCore;
...
impl crate::typed::TypedExchange for Zaif {
