...
//
// Typed wrapper for coinsph.
//
// Owns a `Box<CoinsphCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::coinsph::CoinsphCore;
use crate::types::*;
...
pub struct Coinsph {
    ...
    core: Box<CoinsphCore>,
}

impl Coinsph {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(CoinsphCore::new(config)) }
    }

    pub fn from_core(core: CoinsphCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut CoinsphCore {
        &mut self.core
    }
...
impl std::ops::Deref for Coinsph {
    type Target = CoinsphCore;
...
impl crate::typed::TypedExchange for Coinsph {
