...
//
// Typed wrapper for onetrading.
//
// Owns a `Box<OnetradingCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::onetrading::OnetradingCore;
use crate::types::*;
...
pub struct Onetrading {
    ...
    core: Box<OnetradingCore>,
}

impl Onetrading {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(OnetradingCore::new(config)) }
    }

    pub fn from_core(core: OnetradingCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut OnetradingCore {
        &mut self.core
    }
...
impl std::ops::Deref for Onetrading {
    type Target = OnetradingCore;
...
impl crate::typed::TypedExchange for Onetrading {
