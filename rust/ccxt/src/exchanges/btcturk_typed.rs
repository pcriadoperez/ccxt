...
//
// Typed wrapper for btcturk.
//
// Owns a `Box<BtcturkCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::btcturk::BtcturkCore;
use crate::types::*;
...
pub struct Btcturk {
    ...
    core: Box<BtcturkCore>,
}

impl Btcturk {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BtcturkCore::new(config)) }
    }

    pub fn from_core(core: BtcturkCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BtcturkCore {
        &mut self.core
    }
...
impl std::ops::Deref for Btcturk {
    type Target = BtcturkCore;
...
impl crate::typed::TypedExchange for Btcturk {
