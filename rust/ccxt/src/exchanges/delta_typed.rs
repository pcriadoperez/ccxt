...
//
// Typed wrapper for delta.
//
// Owns a `Box<DeltaCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::delta::DeltaCore;
use crate::types::*;
...
impl Delta {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(DeltaCore::new(config)) }
    }

    pub fn from_core(core: DeltaCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut DeltaCore {
        &mut self.core
    }
...
impl crate::typed::TypedExchange for Delta {
