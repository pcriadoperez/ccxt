...
//
// Typed wrapper for okxus.
//
// Owns a `Box<OkxusCore>` and exposes the unified CCXT API
...
impl Okxus {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(OkxusCore::new(config)) }
    }

    pub fn from_core(core: OkxusCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut OkxusCore {
        &mut self.core
    }
...
impl std::ops::Deref for Okxus {
    type Target = OkxusCore;
...
impl crate::typed::TypedExchange for Okxus {
