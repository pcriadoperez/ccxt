...
//
// Typed wrapper for paradex.
//
// Owns a `Box<ParadexCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::pro::paradex::ParadexCore;
use crate::types::*;
...
pub struct Paradex {
    ...
    core: Box<ParadexCore>,
}

impl Paradex {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(ParadexCore::new(config)) }
    }

    pub fn from_core(core: ParadexCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut ParadexCore {
        &mut self.core
    }
...
impl std::ops::Deref for Paradex {
    type Target = ParadexCore;
...
impl crate::typed::TypedExchange for Paradex {
