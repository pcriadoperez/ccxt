...
public class TestMain extends BaseTest
{
    ...
    public java.util.concurrent.CompletableFuture<Object> initInner(Object exchangeId, Object symbolArgv, Object methodArgv)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Assert(Helpers.isGreaterThan(Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.testFiles).keySet())), 0), "Test files were not loaded"); // ensure test files are found & filled
    ...
    public void checkIfSpecificTestIsChosen(Object methodArgv)
    {
        ...
        {
            Object testFileNames = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.testFiles).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> importFiles(Exchange exchange)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object properties = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)exchange.has).keySet());
    ...
    public void loadCredentialsFromEnv(Exchange exchange)
    {
        ...
        Object objkeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)reqCreds).keySet());
    ...
    public void expandSettings(Exchange exchange)
    {
        ...
        {
            Object settingKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)exchangeSettings).keySet());
    ...
    public Object getSkips(Exchange exchange, Object methodName)
    {
        ...
        Object objectNames = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)objectSkips).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> runTests(Exchange exchange, Object tests, Object isPublicTest)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object testNames = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tests).keySet());
    ...
    public Object getMarketsFromExchange(Exchange exchange, Object... optionalArgs)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)markets).keySet());
    ...
    public Object getValidSymbol(Exchange exchange, Object... optionalArgs)
    {
        ...
        Object swapSymbols = new java.util.ArrayList<Object>(java.util.Arrays.asList("BTC/USDT:USDT", "BTC/USDC:USDC", "BTC/USD:USD", "ETH/USDT:USDT", "ETH/USDC:USDC", "ETH/USD:USD", "BTC/USD:BTC", "ETH/USD:ETH"));
        ...
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(codes)); i++)
            {
                ...
                Object symbolsArrayForCurrentCode = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)indexedMkts).keySet());
        ...
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            Object values = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currentTypeMarkets).values());
    ...
    public java.util.concurrent.CompletableFuture<Object> testReturnResponseHeaders(Exchange exchange)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object headerValues = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)headers).values());
    ...
    public Object AssertNewAndStoredOutputInner(Exchange exchange, Object skipKeys, Object newOutput, Object storedOutput, Object... optionalArgs)
    {
        ...
        {
            Object storedOutputKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)storedOutput).keySet());
            Object newOutputKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)newOutput).keySet());
    ...
    public Exchange initOfflineExchange(Object exchangeName)
    {
        ...
        Exchange exchange = initExchange(exchangeName, new java.util.HashMap<String, Object>() {{
            put( "markets", markets );
    ...
    public java.util.concurrent.CompletableFuture<Object> testExchangeRequestStatically(Object exchangeName, Object exchangeData, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object methodsNames = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)methods).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> runStaticTests(Object type2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object exchanges = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)staticData).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> testKucoin()
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object id = "ccxt";
            Assert(Helpers.isEqual(Helpers.GetValue(reqHeaders, "KC-API-PARTNER"), id), Helpers.add(Helpers.add("kucoin - id: ", id), " not in headers."));
            if (!Helpers.isTrue(isSync()))
            {
                (close(exchange)).join();
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> testDefx()
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                (exchange.createOrder("DOGE/USDC:USDC", "limit", "buy", 100, 1)).join();
            } catch(Exception e)
            {
                // we expect an error here, we're only interested in the headers
                reqHeaders = exchange.last_request_headers;
            ...
            Object id = "ccxt";
            Assert(Helpers.isEqual(Helpers.GetValue(reqHeaders, "X-DEFX-SOURCE"), id), Helpers.add(Helpers.add("defx - id: ", id), " not in headers."));
            if (!Helpers.isTrue(isSync()))
            {
                (close(exchange)).join();
            }
