...
public class TestSharedMethods extends BaseTest {
    ...
    public static Object AssertType(Exchange exchange, Object skippedProperties, Object entry, Object key, Object format)
    {
        ...
        Object same_array = Helpers.isTrue(((entryKeyVal instanceof java.util.List) || (entryKeyVal.getClass().isArray()))) && Helpers.isTrue(((formatKeyVal instanceof java.util.List) || (formatKeyVal.getClass().isArray())));
    ...
    public static void AssertStructure(Exchange exchange, Object skippedProperties, Object method, Object entry, Object format, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(((format instanceof java.util.List) || (format.getClass().isArray()))))
        {
            Assert(((entry instanceof java.util.List) || (entry.getClass().isArray())), Helpers.add("entry is not an array", logText));
    ...
    public static void AssertFeeStructure(Exchange exchange, Object skippedProperties, Object method, Object entry, Object key, Object... optionalArgs)
    {
        ...
        {
            Assert(((entry instanceof java.util.List) || (entry.getClass().isArray())), Helpers.add("fee container is expected to be an array", logText));
    ...
    public static void checkPrecisionAccuracy(Exchange exchange, Object skippedProperties, Object method, Object entry, Object key)
    {
        ...
        if (Helpers.isTrue(exchange.isTickPrecision()))
        {
            ...
            // the below array of integers are inexistent tick-sizes (theoretically technically possible, but not in real-world cases), so their existence in our case indicates to incorrectly implemented tick-sizes, which might mistakenly be implemented with DECIMAL_PLACES, so we throw new RuntimeException(e)rror
    ...
    public static java.util.concurrent.CompletableFuture<Object> fetchOrder(Exchange exchange, Object symbol, Object orderId, Object skippedProperties)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(methods_singular)); i++)
        {
            ...
            {
                Object currentOrder = (Helpers.callDynamically(exchange, singularFetchName, new Object[] { originalId, symbol })).join();
        ...
        if (Helpers.isTrue(Helpers.isEqual(fetchedOrder, null)))
        {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(methods_plural)); i++)
            {
                ...
                {
                    Object orders = (Helpers.callDynamically(exchange, pluralFetchName, new Object[] { symbol, sinceTime })).join();
                    Object found = false;
    ...
    public static void AssertNonEmtpyArray(Exchange exchange, Object skippedProperties, Object method, Object entry, Object... optionalArgs)
    {
        ...
        Assert(((entry instanceof java.util.List) || (entry.getClass().isArray())), Helpers.add("response is expected to be an array", logText));
    ...
    {
        return Helpers.isEqual(Helpers.json(a), Helpers.json(b));
    }
    public static void AssertDeepEqual(Exchange exchange, Object skippedProperties, Object method, Object a, Object b)
    {
        Object logText = logTemplate(exchange, method, new java.util.HashMap<String, Object>() {{}});
        Assert(deepEqual(a, b), Helpers.add(Helpers.add(Helpers.add(Helpers.add("two dicts do not match: ", Helpers.json(a)), " != "), Helpers.json(b)), logText));
    }
