...
public class Wavesexchange extends WavesexchangeApi
{
   public Wavesexchange () {
       super();
   }

   public Wavesexchange (Object options) {
       super(options);
   }
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "currencies", new java.util.HashMap<String, Object>() {{
                put( "WX", Wavesexchange.this.safeCurrencyStructure(new java.util.HashMap<String, Object>() {{
                    put( "id", "EMAMLxDnv3xiz8RXg8Btj33jcEw3wLczL3JKYYmuubpc" );
                    put( "numericId", null );
                    put( "code", "WX" );
                    put( "precision", Wavesexchange.this.parseNumber("1e-8") );
                }}) );
            }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> customCalculateFee(Object symbol, Object type, Object side, Object amount, Object price, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                ...
                put( "rate", Wavesexchange.this.parseNumber(feeRate) );
                put( "cost", Wavesexchange.this.parseNumber(feeCost) );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    final Object finalBase = base;
                ...
                final Object finalBaseId = baseId;
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Wavesexchange.this.parseNumber(Wavesexchange.this.parsePrecision(Wavesexchange.this.safeString(entry, "amountAssetDecimals"))) );
                        put( "price", Wavesexchange.this.parseNumber(Wavesexchange.this.parsePrecision(Wavesexchange.this.safeString(entry, "priceAssetDecimals"))) );
                    }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                ...
                put( "datetime", Wavesexchange.this.iso8601(timestamp) );
                put( "nonce", null );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (!Helpers.isTrue(this.safeString(this.options, "accessToken")))
            {
                ...
                Object request = new java.util.HashMap<String, Object>() {{
                    ...
                    put( "scope", "general" );
                    put( "username", Wavesexchange.this.apiKey );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "baseId", Helpers.GetValue(market, "baseId") );
                put( "quoteId", Helpers.GetValue(market, "quoteId") );
                put( "interval", Wavesexchange.this.safeString(Wavesexchange.this.timeframes, timeframe, timeframe) );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object codes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currencies).keySet());
            ...
            } else
            {
                ...
                {
                    Object supportedNetworkKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)supportedNetworks).keySet());
                ...
                {
                    Object request = new java.util.HashMap<String, Object>() {{
                        put( "publicKey", Wavesexchange.this.apiKey );
                    }};
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type2, Object side, Object amount2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object body = new java.util.HashMap<String, Object>() {{
                put( "senderPublicKey", Wavesexchange.this.apiKey );
                ...
                Object attachment = new java.util.HashMap<String, Object>() {{
                    ...
                    put( "c", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "v", new java.util.HashMap<String, Object>() {{
                            put( "p", Wavesexchange.this.toRealSymbolPrice(symbol, finalTriggerPrice) );
                        }} );
                    }} );
                }};
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.inOp(order, "type")))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "currency", code );
                put( "fee", Wavesexchange.this.parseNumber(Wavesexchange.this.fromRealCurrencyAmount(code, Wavesexchange.this.safeString(order, "filledFee"))) );
            }};
        } else
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "currency", code );
                put( "fee", Wavesexchange.this.parseNumber(Wavesexchange.this.fromRealCurrencyAmount(code, Wavesexchange.this.safeString(order, "matcherFee"))) );
            }};
        }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            // { WAVES: 200300000 }
            Object reservedKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)reservedBalance).keySet());
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        Object fee = new java.util.HashMap<String, Object>() {{
            put( "cost", Wavesexchange.this.safeString(finalOrder, "matcherFee") );
            put( "currency", Wavesexchange.this.safeCurrencyCode(Wavesexchange.this.safeString(finalOrder, "matcherFeeAssetId", "WAVES")) );
        }};
        final Object finalSymbol = symbol;
    ...
    put( "fee", Wavesexchange.this.safeNumber(fees, "flat") );
    put( "percentage", false );
        ...
        Object depositWithdrawFeesKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)depositWithdrawFees).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> withdraw(Object code2, Object amount2, Object address, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "version", version );
                put( "attachment", "" );
                put( "feeAssetId", Wavesexchange.this.getAssetId(feeAssetId) );
                put( "proofs", new java.util.ArrayList<Object>(java.util.Arrays.asList(signature)) );
                put( "assetId", Wavesexchange.this.getAssetId(Helpers.GetValue(currency, "id")) );
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Wavesexchange.this.safeString(transaction, "id") );
            put( "txid", null );
            put( "timestamp", timestamp );
            put( "datetime", Wavesexchange.this.iso8601(timestamp) );
            put( "network", null );
            put( "addressFrom", Wavesexchange.this.safeString(transaction, "sender") );
            put( "address", null );
            put( "addressTo", Wavesexchange.this.safeString(transaction, "recipient") );
            put( "amount", amount );
            put( "type", type );
