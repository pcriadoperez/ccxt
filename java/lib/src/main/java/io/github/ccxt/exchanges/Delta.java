...
public class Delta extends DeltaApi
{
   ...
   public Delta (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "code", code );
        put( "name", Delta.this.safeString(currency, "name") );
        put( "info", currency );
        put( "active", null );
        put( "deposit", Helpers.isEqual(Delta.this.safeString(currency, "deposit_status"), "enabled") );
        put( "withdraw", Helpers.isEqual(Delta.this.safeString(currency, "withdrawal_status"), "enabled") );
        put( "fee", Delta.this.safeNumber(currency, "base_withdrawal_fee") );
        put( "precision", Delta.this.parseNumber(Delta.this.parsePrecision(Delta.this.safeString(currency, "precision"))) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", null );
                put( "max", null );
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Delta.this.safeNumber(currency, "min_withdrawal_amount") );
                put( "max", null );
            }} );
        }} );
    ...
    public Object indexByStringifiedNumericId(Object input)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)input).keySet());
    ...
    final Object finalSymbol = symbol;
                ...
                final Object finalAmountPrecision = amountPrecision;
                    ...
                    put( "option", option );
                    put( "active", (Helpers.isEqual(state, "live")) );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "quoteVolume", Delta.this.safeNumber(ticker, "turnover") );
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", Delta.this.safeCurrencyCode(marketId, currency) );
            put( "network", Delta.this.networkIdToCode(networkId) );
            put( "address", address );
