...
public class Exmo extends io.github.ccxt.exchanges.Exmo
{
   public Exmo () {
       super();
   }
   ...
   public Exmo (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object subscribe = new java.util.HashMap<String, Object>() {{
                ...
                put( "topics", new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.add(type, "/wallet"))) );
                put( "id", Exmo.this.requestId() );
            }};
    ...
    public void parseSpotBalance(Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(eventVar, "snapshot")))
        {
            ...
            Object currencies = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)balances).keySet());
    ...
    public void parseMarginBalance(Object message)
    {
        ...
        Object data = this.safeValue(message, "data");
        Helpers.addElementToObject(this.balance, "info", data);
        Object currencies = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)data).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencies)); i++)
        {
            Object currencyId = Helpers.GetValue(currencies, i);
            Object code = this.safeCurrencyCode(currencyId);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object message = new java.util.HashMap<String, Object>() {{
                put( "method", "subscribe" );
                put( "topics", new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.add(type, "/user_trades"))) );
                put( "id", Exmo.this.requestId() );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object message = new java.util.HashMap<String, Object>() {{
                put( "method", "subscribe" );
                put( "topics", new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.add(type, "/orders"))) );
                put( "id", Exmo.this.requestId() );
            }};
            Object request = this.deepExtend(message, query);
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "status", Exmo.this.parseStatus(Exmo.this.safeString(order, "status")) );
            put( "symbol", symbol );
            put( "type", finalType );
            ...
            put( "cost", null );
            put( "amount", Exmo.this.safeString(order, "original_quantity") );
            put( "filled", null );
            put( "remaining", Exmo.this.safeString(order, "quantity") );
            put( "average", null );
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "id", Exmo.this.safeString(trade, "last_trade_id") );
            put( "symbol", symbol );
            put( "order", id );
            put( "type", finalType );
            put( "side", side );
            put( "price", Exmo.this.safeString(trade, "last_trade_price") );
            put( "amount", Exmo.this.safeString(trade, "last_trade_quantity") );
            put( "cost", null );
            put( "fee", null );
        }}, market);
    }
