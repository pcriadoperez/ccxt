...
public class Bitfinex extends io.github.ccxt.exchanges.Bitfinex
{
   ...
   public Bitfinex (Object options) {
    ...
    public void handleOHLCV(Client client, Object message, Object subscription)
    {
        ...
        if (Helpers.isTrue(((first instanceof java.util.List) || (first.getClass().isArray()))))
        {
            // snapshot
            ohlcvs = data;
        } else
    ...
    public void handleBalance(Client client, Object message, Object subscription)
    {
        ...
        Object updatesKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)updatedTypes).keySet());
    ...
    public void handleOrders(Client client, Object message, Object subscription)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(messageType, "os")))
        {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                Helpers.addElementToObject(symbolIds, symbol, true);
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)symbolIds).keySet());
