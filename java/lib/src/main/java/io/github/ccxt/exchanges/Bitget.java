   ...
   public Bitget (Object options) {
    ...
    final Object finalJ = j;
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(results)); i++)
            {
                ...
                {
                    Object keysList = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.indexBy(data, "symbol")).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                Object chains = this.safeValue(entry, "chains", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
...
final Object finalMinNotional = minNotional;
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "txid", Bitget.this.safeString(transaction, "tradeId") );
            put( "timestamp", timestamp );
            put( "datetime", Bitget.this.iso8601(timestamp) );
            put( "network", Bitget.this.networkIdToCode(networkId) );
            ...
            put( "type", Bitget.this.safeString(transaction, "type") );
            put( "currency", code );
            put( "status", Bitget.this.parseTransactionStatus(status) );
            put( "updated", Bitget.this.safeInteger(transaction, "uTime") );
            put( "tagFrom", null );
            put( "tag", tag );
            put( "tagTo", tag );
            put( "comment", null );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        } else
        {
            if (Helpers.isTrue(!Helpers.isEqual(feeDetail, null)))
            {
                ...
                Object feeValues = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)parsedFeeDetail).values());
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(marketType, "swap"))) || Helpers.isTrue((Helpers.isEqual(marketType, "future")))))
        {
            ...
            } else if (Helpers.isTrue(isStopLossOrTakeProfitTrigger))
            {
                if (!Helpers.isTrue(isMarketOrder))
                {
                    throw new ExchangeError((String)Helpers.add(this.id, " createOrder() bitget stopLoss or takeProfit orders must be market orders")) ;
                }
                if (Helpers.isTrue(hedged))
                {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingHistory(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "businessType", "contract_settle_fee" );
            ...
            Object response = (this.privateMixGetV2MixAccountBill(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            //
            Object data = this.safeValue(response, "data", new java.util.HashMap<String, Object>() {{}});
            Object result = this.safeValue(data, "bills", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public Object parseFundingHistory(Object contract, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "id", Bitget.this.safeString(contract, "billId") );
        }};
    }
    ...
    public Object parseFundingHistories(Object contracts, Object... optionalArgs)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(contracts)); i++)
        {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(business, "contract_settle_fee")))
            {
                continue;
            }
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        {
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)query).keySet());
