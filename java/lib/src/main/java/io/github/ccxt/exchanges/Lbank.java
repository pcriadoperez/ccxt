   ...
   public Lbank (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object groupedKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)grouped).keySet());
    ...
    final Object finalBase = base;
                    ...
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", Lbank.this.safeNumber(market, "priceLimitLowerValue") );
                            put( "max", Lbank.this.safeNumber(market, "priceLimitUpperValue") );
                        }} );
                        put( "cost", new java.util.HashMap<String, Object>() {{
    ...
    public Object parseBalance(Object response)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(toBtc, null)))
        {
            ...
            Object currencies = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)free).keySet());
        ...
        Object isArray = ((data instanceof java.util.List) || (data.getClass().isArray()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddressDefault(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", response );
                put( "currency", code );
                put( "network", Lbank.this.networkIdToCode(Lbank.this.safeString(result, "netWork")) );
                put( "address", address );
                put( "tag", tag );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Lbank.this.iso8601(timestamp) );
            put( "network", Lbank.this.networkIdToCode(Lbank.this.safeString(transaction, "networkName")) );
            put( "address", address );
            ...
            put( "updated", null );
            put( "comment", null );
            put( "internal", (Helpers.isEqual(status, "transfer")) );
            put( "fee", finalFee );
        }};
    }
