...
public class Ascendex extends AscendexApi
{
   public Ascendex () {
       super();
   }
   ...
   public Ascendex (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "taker", Ascendex.this.parseNumber("0.002") );
                    put( "maker", Ascendex.this.parseNumber("0.002") );
                }} );
            }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "fee", Ascendex.this.safeNumber(networkEtnry, "withdrawFee") );
        put( "active", null );
        put( "withdraw", Ascendex.this.safeBool(networkEtnry, "allowWithdraw") );
        put( "deposit", Ascendex.this.safeBool(networkEtnry, "allowDeposit") );
        ...
        put( "limits", new java.util.HashMap<String, Object>() {{
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Ascendex.this.safeNumber(networkEtnry, "minWithdrawal") );
                put( "max", null );
            }} );
            put( "deposit", new java.util.HashMap<String, Object>() {{
                put( "min", Ascendex.this.safeNumber(networkEtnry, "minDepositAmt") );
                put( "max", null );
            }} );
        }} );
    }});
        ...
        put( "type", null );
        put( "margin", null );
        put( "name", Ascendex.this.safeString(currency, "assetName") );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        ...
        put( "limits", new java.util.HashMap<String, Object>() {{
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Ascendex.this.safeNumber(currency, "minWithdrawalAmt") );
                put( "max", null );
            }} );
        }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchSpotMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)dataById).keySet());
    ...
    final Object finalActive = active;
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Ascendex.this.safeNumber(market, "lotSize") );
                        put( "price", Ascendex.this.safeNumber(market, "tickSize") );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Ascendex.this.safeNumber(market, "minNotional") );
                            put( "max", Ascendex.this.safeNumber(market, "maxNotional") );
                        }} );
                    }} );
                    put( "created", Ascendex.this.safeInteger(market, "tradingStartTime") );
                    put( "info", market );
                }});
            }
            return result;
    ...
    final Object finalBase = base;
                final Object finalSettle = settle;
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", Helpers.isEqual(Ascendex.this.safeString(market, "status"), "Normal") );
                    put( "contract", true );
                    put( "linear", linear );
                    put( "inverse", inverse );
                    put( "taker", fee );
                    put( "maker", fee );
                    put( "contractSize", Ascendex.this.parseNumber("1") );
                    put( "expiry", null );
                    put( "expiryDatetime", null );
                    put( "strike", null );
                    put( "optionType", null );
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Ascendex.this.safeNumber(lotSizeFilter, "lotSize") );
                        put( "price", Ascendex.this.safeNumber(priceFilter, "tickSize") );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            put( "min", null );
                        ...
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", Ascendex.this.safeNumber(lotSizeFilter, "minQty") );
                            put( "max", Ascendex.this.safeNumber(lotSizeFilter, "maxQty") );
                        }} );
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", Ascendex.this.safeNumber(priceFilter, "minPrice") );
                            put( "max", Ascendex.this.safeNumber(priceFilter, "maxPrice") );
                        }} );
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Ascendex.this.safeNumber(market, "minNotional") );
                            put( "max", Ascendex.this.safeNumber(market, "maxNotional") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTime(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "requestTime", Ascendex.this.milliseconds() );
            }};
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", null );
            put( "high", Ascendex.this.safeString(ticker, "high") );
            put( "low", Ascendex.this.safeString(ticker, "low") );
            put( "bid", Ascendex.this.safeString(bid, 0) );
            put( "bidVolume", Ascendex.this.safeString(bid, 1) );
            put( "ask", Ascendex.this.safeString(ask, 0) );
            put( "askVolume", Ascendex.this.safeString(ask, 1) );
            put( "vwap", null );
            put( "open", open );
            put( "close", close );
            put( "last", close );
            ...
            put( "percentage", null );
            put( "average", null );
            put( "baseVolume", Ascendex.this.safeString(ticker, "volume") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "interval", Ascendex.this.safeString(Ascendex.this.timeframes, timeframe, timeframe) );
            }};
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "info", trade );
            put( "timestamp", timestamp );
            put( "datetime", Ascendex.this.iso8601(timestamp) );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Ascendex.this.iso8601(finalTimestamp) );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTradingFees(Object... optionalArgs)
    {
        ...
        put( "info", fee );
        put( "symbol", symbol );
        put( "maker", Ascendex.this.safeNumber(takerMaker, "maker") );
        put( "taker", Ascendex.this.safeNumber(takerMaker, "taker") );
        put( "percentage", null );
        put( "tierBased", null );
    }});
            }
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        */
        ...
        Object request = new java.util.HashMap<String, Object>() {{
            ...
            put( "symbol", Helpers.GetValue(market, "id") );
            put( "time", Ascendex.this.milliseconds() );
            put( "orderQty", Ascendex.this.amountToPrecision(symbol, amount) );
            put( "orderType", type );
            put( "side", side );
        }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isGreaterThan(numAddresses, 1)))
            {
                ...
                {
                    Object chainNames = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)addressesByChainName).keySet());
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "id", Ascendex.this.safeString(transaction, "requestId") );
            put( "txid", Ascendex.this.safeString(transaction, "networkTransactionId") );
            put( "type", Ascendex.this.safeString(transaction, "transactionType") );
            put( "currency", code );
            put( "network", null );
            put( "amount", Ascendex.this.parseNumber(finalAmountString) );
            put( "status", Ascendex.this.parseTransactionStatus(Ascendex.this.safeString(transaction, "status")) );
            put( "timestamp", timestamp );
            put( "datetime", Ascendex.this.iso8601(timestamp) );
            put( "address", address );
            ...
            put( "fee", new java.util.HashMap<String, Object>() {{
                put( "currency", code );
                put( "cost", Ascendex.this.parseNumber(feeCostString) );
                put( "rate", null );
            }} );
            put( "internal", false );
        }};
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "id", null );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "notional", Ascendex.this.parseNumber(finalNotional) );
            put( "marginMode", finalMarginMode );
            put( "liquidationPrice", null );
            put( "entryPrice", Ascendex.this.safeNumber(position, "avgOpenPrice") );
            put( "unrealizedPnl", Ascendex.this.safeNumber(position, "unrealizedPnl") );
            put( "percentage", null );
            put( "contracts", Ascendex.this.safeNumber(position, "position") );
            put( "contractSize", Ascendex.this.safeNumber(finalMarket, "contractSize") );
            put( "markPrice", Ascendex.this.safeNumber(position, "markPrice") );
            put( "lastPrice", null );
            put( "side", Ascendex.this.safeStringLower(position, "side") );
            put( "hedged", null );
            put( "timestamp", null );
            put( "datetime", null );
            ...
            put( "leverage", Ascendex.this.safeInteger(position, "leverage") );
            put( "marginRatio", null );
            put( "stopLossPrice", Ascendex.this.safeNumber(position, "stopLossPrice") );
            put( "takeProfitPrice", Ascendex.this.safeNumber(position, "takeProfitPrice") );
        }});
    }
    ...
    public Object parseFundingRate(Object contract, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", contract );
            put( "symbol", symbol );
            put( "markPrice", Ascendex.this.safeNumber(contract, "markPrice") );
            put( "indexPrice", Ascendex.this.safeNumber(contract, "indexPrice") );
            put( "interestRate", Ascendex.this.parseNumber("0") );
            put( "estimatedSettlePrice", null );
            put( "timestamp", currentTime );
            put( "datetime", Ascendex.this.iso8601(currentTime) );
            ...
            put( "fundingDatetime", Ascendex.this.iso8601(nextFundingRateTimestamp) );
            put( "interval", null );
        }};
    }
...
final Object finalI = i;
            final Object finalMarket = market;
                ...
                put( "tier", Ascendex.this.sum(finalI, 1) );
                put( "symbol", Ascendex.this.safeSymbol(marketId, finalMarket, null, "contract") );
                put( "currency", Helpers.GetValue(finalMarket, "quote") );
                put( "minNotional", Ascendex.this.safeNumber(tier, "positionNotionalLowerBound") );
                put( "maxNotional", Ascendex.this.safeNumber(tier, "positionNotionalUpperBound") );
                put( "maintenanceMarginRate", Ascendex.this.safeNumber(tier, "maintenanceMarginRate") );
                put( "maxLeverage", Ascendex.this.parseNumber(Precise.stringDiv("1", initialMarginRate)) );
                put( "info", tier );
            }});
        }
        return tiers;
    ...
    put( "withdraw", new java.util.HashMap<String, Object>() {{
        put( "fee", Ascendex.this.safeNumber(blockChain, "withdrawFee") );
    ...
    public java.util.concurrent.CompletableFuture<Object> transfer(Object code, Object amount, Object fromAccount, Object toAccount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "account-group", accountGroup );
                put( "amount", Ascendex.this.currencyToPrecision(code, amount) );
                put( "asset", Helpers.GetValue(currency, "id") );
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "toAccount", null );
            put( "status", Ascendex.this.parseTransferStatus(status) );
        }};
    }
    ...
    public Object parseIncome(Object income, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", income );
            put( "symbol", Ascendex.this.safeSymbol(marketId, market, "-", "swap") );
            put( "code", "USDT" );
            put( "timestamp", timestamp );
            put( "datetime", Ascendex.this.iso8601(timestamp) );
            put( "id", null );
            put( "amount", Ascendex.this.safeNumber(income, "paymentInUSDT") );
        }};
    }
    ...
    public Object parseMarginMode(Object marginMode, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", marginMode );
            put( "symbol", Ascendex.this.safeSymbol(marketId, market) );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        } else
        {
            ...
            headers = new java.util.HashMap<String, Object>() {{
                put( "x-auth-key", Ascendex.this.apiKey );
