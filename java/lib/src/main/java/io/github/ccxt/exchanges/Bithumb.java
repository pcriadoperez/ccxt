   ...
   public Bithumb (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "options", new java.util.HashMap<String, Object>() {{
                put( "quoteCurrencies", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "USDT", new java.util.HashMap<String, Object>() {{
                        put( "limits", new java.util.HashMap<String, Object>() {{
                            put( "cost", new java.util.HashMap<String, Object>() {{
                                put( "min", null );
                                put( "max", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object quotes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)quoteCurrencies).keySet());
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(quotes)); i++)
            {
                ...
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(currencyIds)); j++)
                {
                    ...
                    Object active = true;
                    if (Helpers.isTrue(((market instanceof java.util.List) || (market.getClass().isArray()))))
                    {
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object codes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.currencies).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(quotes)); i++)
            {
                ...
                Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tickers).keySet());
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(currencyIds)); j++)
                {
                    Object currencyId = Helpers.GetValue(currencyIds, j);
