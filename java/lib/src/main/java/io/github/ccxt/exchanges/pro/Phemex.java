    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object subscribe = new java.util.HashMap<String, Object>() {{
                put( "method", method );
                put( "id", requestId );
                put( "params", new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.GetValue(market, "id"), Phemex.this.safeInteger("timeframes", timeframe))) );
            }};
            Object request = this.deepExtend(subscribe, parameters);
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(future, null)))
            {
                ...
                Object request = new java.util.HashMap<String, Object>() {{
                    put( "method", method );
                    put( "params", new java.util.ArrayList<Object>(java.util.Arrays.asList("API", "apiKey", signature, expiration)) );
                    put( "id", requestId );
                }};
