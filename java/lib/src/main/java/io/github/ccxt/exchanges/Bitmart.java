...
public class Bitmart extends BitmartApi
{
   public Bitmart () {
       super();
   }
   ...
   public Bitmart (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "taker", Bitmart.this.parseNumber("0.0040") );
                    put( "maker", Bitmart.this.parseNumber("0.0035") );
                    put( "tiers", new java.util.HashMap<String, Object>() {{
                        put( "taker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("0"), Bitmart.this.parseNumber("0.0020"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("10"), Bitmart.this.parseNumber("0.18"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("50"), Bitmart.this.parseNumber("0.0016"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("250"), Bitmart.this.parseNumber("0.0014"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("1000"), Bitmart.this.parseNumber("0.0012"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("5000"), Bitmart.this.parseNumber("0.0010"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("25000"), Bitmart.this.parseNumber("0.0008"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("50000"), Bitmart.this.parseNumber("0.0006"))))) );
                        put( "maker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("0"), Bitmart.this.parseNumber("0.001"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("10"), Bitmart.this.parseNumber("0.0009"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("50"), Bitmart.this.parseNumber("0.0008"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("250"), Bitmart.this.parseNumber("0.0007"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("1000"), Bitmart.this.parseNumber("0.0006"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("5000"), Bitmart.this.parseNumber("0.0005"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("25000"), Bitmart.this.parseNumber("0.0004"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Bitmart.this.parseNumber("50000"), Bitmart.this.parseNumber("0.0003"))))) );
                    }} );
                }} );
            }} );
    ...
    final Object finalBase = base;
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", Helpers.isEqual(Bitmart.this.safeStringLower2(market, "status", "trade_status"), "trading") );
                    put( "contract", false );
                    put( "linear", null );
                    put( "inverse", null );
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "price", Bitmart.this.parseNumber(Bitmart.this.parsePrecision(Bitmart.this.safeString(market, "price_max_precision"))) );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", baseMinSize );
                            put( "max", Bitmart.this.safeNumber(market, "base_max_size") );
                        }} );
                        ...
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Bitmart.this.parseNumber(minCost) );
                            put( "max", null );
                        }} );
                    }} );
                    put( "created", null );
    ...
    final Object finalBase = base;
                final Object finalExpiry = expiry;
                    ...
                    put( "option", false );
                    put( "active", Helpers.isEqual(Bitmart.this.safeStringLower(market, "status"), "trading") );
                    put( "contract", true );
                    put( "linear", true );
                    put( "inverse", false );
                    put( "contractSize", Bitmart.this.safeNumber(market, "contract_size") );
                    put( "expiry", finalExpiry );
                    put( "expiryDatetime", Bitmart.this.iso8601(finalExpiry) );
                    put( "strike", null );
                    put( "optionType", null );
                    put( "maker", Helpers.GetValue(fees, "maker") );
                    put( "taker", Helpers.GetValue(fees, "taker") );
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Bitmart.this.safeNumber(market, "vol_precision") );
                        put( "price", Bitmart.this.safeNumber(market, "price_precision") );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            put( "min", Bitmart.this.safeNumber(market, "min_leverage") );
                            put( "max", Bitmart.this.safeNumber(market, "max_leverage") );
                        }} );
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", Bitmart.this.safeNumber(market, "min_volume") );
                            put( "max", Bitmart.this.safeNumber(market, "max_volume") );
                        }} );
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", null );
                            put( "max", null );
                    ...
                    put( "created", Bitmart.this.safeInteger(market, "open_timestamp") );
                    put( "info", market );
                }}));
            }
            return result;
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object spot = (this.fetchSpotMarkets(parameters)).join();
            Object contract = (this.fetchContractMarkets(parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencies)); i++)
            {
                ...
                if (Helpers.isTrue(Helpers.isEqual(entry, null)))
                {
                    ...
                    entry = new java.util.HashMap<String, Object>() {{
                        ...
                        put( "precision", null );
                        put( "name", Bitmart.this.safeString(currency, "name") );
                        put( "deposit", null );
                        put( "withdraw", null );
                        put( "active", null );
                        put( "networks", new java.util.HashMap<String, Object>() {{}} );
        ...
        put( "deposit", deposit );
        put( "active", Helpers.isTrue(withdraw) && Helpers.isTrue(deposit) );
        put( "fee", Bitmart.this.safeNumber(currency, "withdraw_fee") );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Bitmart.this.safeNumber(currency, "withdraw_minsize") );
                put( "max", null );
            }} );
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)result).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionFee(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "currency", Bitmart.this.getCurrencyIdFromCodeAndNetwork(Helpers.GetValue(currency, "code"), finalNetwork) );
            }};
    ...
    public Object parseDepositWithdrawFee(Object fee, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", fee );
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "fee", Bitmart.this.safeNumber(fee, "withdraw_fee") );
                put( "percentage", null );
            }} );
            put( "deposit", new java.util.HashMap<String, Object>() {{
                put( "fee", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositWithdrawFee(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            final Object finalNetwork = network;
            Object request = new java.util.HashMap<String, Object>() {{
                put( "currency", Bitmart.this.getCurrencyIdFromCodeAndNetwork(code, finalNetwork) );
            }};
            Object response = (this.privateGetAccountV1WithdrawCharge(this.extend(request, parameters))).join();
            //
            //     {
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Bitmart.this.iso8601(finalTimestamp) );
            put( "high", finalHigh );
            put( "low", finalLow );
            put( "bid", finalBid );
            ...
            put( "indexPrice", Bitmart.this.safeString(ticker, "index_price") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "info", trade );
            put( "id", Bitmart.this.safeStringN(trade, new java.util.ArrayList<Object>(java.util.Arrays.asList("tradeId", "trade_id", "lastTradeID"))) );
            put( "order", Bitmart.this.safeString2(trade, "orderId", "order_id") );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", finalType );
            put( "side", finalSide );
            put( "price", Bitmart.this.safeStringN(trade, new java.util.ArrayList<Object>(java.util.Arrays.asList("price", "fillPrice", 2))) );
            put( "amount", finalAmount );
            put( "cost", finalCost );
            put( "takerOrMaker", Bitmart.this.safeStringLower2(trade, "tradeRole", "exec_type") );
            put( "fee", finalFee );
        }}, market);
    }
    ...
    public Object parseTradingFee(Object fee, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", fee );
            put( "symbol", symbol );
            put( "maker", Bitmart.this.safeNumber(fee, "maker_fee_rate") );
            put( "taker", Bitmart.this.safeNumber(fee, "taker_fee_rate") );
            put( "percentage", null );
            put( "tierBased", null );
        }};
    }
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "id", finalId );
            put( "clientOrderId", Bitmart.this.safeString2(finalOrder, "client_order_id", "clientOrderId") );
            put( "info", finalOrder );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "lastTradeTimestamp", Bitmart.this.safeInteger(finalOrder, "update_time") );
            put( "symbol", symbol );
            put( "type", finalType );
            put( "timeInForce", finalTimeInForce );
            put( "postOnly", finalPostOnly );
            put( "side", Bitmart.this.parseOrderSide(Bitmart.this.safeString(finalOrder, "side")) );
            put( "price", Bitmart.this.omitZero(finalPriceString) );
            put( "triggerPrice", trailingActivationPrice );
            put( "amount", Bitmart.this.omitZero(Bitmart.this.safeString(finalOrder, "size")) );
            put( "cost", Bitmart.this.safeString2(finalOrder, "filled_notional", "filledNotional") );
            put( "average", Bitmart.this.safeStringN(finalOrder, new java.util.ArrayList<Object>(java.util.Arrays.asList("price_avg", "priceAvg", "deal_avg_price"))) );
            put( "filled", Bitmart.this.safeStringN(finalOrder, new java.util.ArrayList<Object>(java.util.Arrays.asList("filled_size", "filledSize", "deal_size"))) );
            put( "remaining", null );
            put( "status", Bitmart.this.parseOrderStatusByType(orderType, Bitmart.this.safeString2(finalOrder, "status", "state")) );
            put( "fee", null );
            put( "trades", null );
        }}, market);
    }
    ...
    public Object createSwapOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        */
        ...
        Object request = new java.util.HashMap<String, Object>() {{
            put( "symbol", Helpers.GetValue(market, "id") );
            put( "size", Helpers.parseInt(Bitmart.this.amountToPrecision(symbol, amount)) );
        }};
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", Bitmart.this.safeString(finalCurrency, "code") );
            put( "network", Bitmart.this.networkIdToCode(finalNetwork) );
            put( "address", address );
            put( "tag", Bitmart.this.safeString2(depositAddress, "address_memo", "memo") );
        }};
    }
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", code );
            put( "amount", amount );
            put( "network", Bitmart.this.networkIdToCode(finalNetworkId) );
            put( "address", address );
            ...
            put( "internal", null );
            put( "comment", null );
            put( "timestamp", ((Helpers.isTrue((!Helpers.isEqual(timestamp, 0))))) ? timestamp : null );
            put( "datetime", ((Helpers.isTrue((!Helpers.isEqual(timestamp, 0))))) ? Bitmart.this.iso8601(timestamp) : null );
            put( "fee", finalFee );
        }};
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> repayIsolatedMargin(Object symbol, Object code, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "amount", Bitmart.this.currencyToPrecision(code, amount) );
            }};
    ...
    public Object parseMarginLoan(Object info, Object... optionalArgs)
    {
        ...
        Object currency = Helpers.getArg(optionalArgs, 0, null);
        return new java.util.HashMap<String, Object>() {{
            put( "id", Bitmart.this.safeString2(info, "borrow_id", "repay_id") );
            put( "currency", Bitmart.this.safeCurrencyCode(null, currency) );
            put( "amount", null );
            put( "symbol", null );
            put( "timestamp", null );
            put( "datetime", null );
    ...
    public Object parseIsolatedBorrowRate(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "symbol", symbol );
            put( "base", Bitmart.this.safeCurrencyCode(baseId) );
            put( "baseRate", Bitmart.this.safeNumber(baseData, "hourly_interest") );
            put( "quote", Bitmart.this.safeCurrencyCode(quoteId) );
            put( "quoteRate", Bitmart.this.safeNumber(quoteData, "hourly_interest") );
            put( "period", 3600000 );
            put( "timestamp", null );
            put( "datetime", null );
            put( "info", info );
    ...
    public java.util.concurrent.CompletableFuture<Object> transfer(Object code, Object amount, Object fromAccount2, Object toAccount2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return this.extend(this.parseTransfer(data, currency), new java.util.HashMap<String, Object>() {{
                put( "status", Bitmart.this.parseTransferStatus(Bitmart.this.safeString2(finalResponse, "code", "message")) );
            }});
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Bitmart.this.safeString(transfer, "transfer_id") );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "currency", Bitmart.this.safeCurrencyCode(currencyId, currency) );
            put( "amount", Bitmart.this.safeNumber(transfer, "amount") );
            put( "fromAccount", Bitmart.this.parseTransferFromAccount(Bitmart.this.safeString(transfer, "type")) );
            put( "toAccount", Bitmart.this.parseTransferToAccount(Bitmart.this.safeString(transfer, "type")) );
            put( "status", Bitmart.this.parseTransferStatus(Bitmart.this.safeString(transfer, "state")) );
        }};
    }
    ...
    public Object parseBorrowInterest(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", info );
            put( "symbol", Bitmart.this.safeString(finalMarket, "symbol") );
            put( "currency", Bitmart.this.safeCurrencyCode(Bitmart.this.safeString(info, "currency")) );
            put( "interest", Bitmart.this.safeNumber(info, "interest_amount") );
            put( "interestRate", Bitmart.this.safeNumber(info, "hourly_interest") );
            put( "amountBorrowed", Bitmart.this.safeNumber(info, "borrow_amount") );
    ...
    public Object parseOpenInterest(Object interest, Object... optionalArgs)
    {
        ...
        return this.safeOpenInterest(new java.util.HashMap<String, Object>() {{
            put( "symbol", Bitmart.this.safeSymbol(id, market) );
            put( "openInterestAmount", Bitmart.this.safeNumber(interest, "open_interest") );
            put( "openInterestValue", Bitmart.this.safeNumber(interest, "open_interest_value") );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "info", interest );
        }}, market);
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(result)); i++)
            {
                ...
                ((java.util.List<Object>)rates).add(new java.util.HashMap<String, Object>() {{
                    ...
                    put( "fundingRate", Bitmart.this.safeNumber(entry, "funding_rate") );
                    put( "timestamp", timestamp );
                    put( "datetime", Bitmart.this.iso8601(timestamp) );
                }});
            }
    ...
    public Object parseFundingRate(Object contract, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", contract );
            put( "symbol", Bitmart.this.safeSymbol(marketId, market) );
            put( "markPrice", null );
            put( "indexPrice", null );
            ...
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "fundingRate", Bitmart.this.safeNumber(contract, "expected_rate") );
            put( "fundingTimestamp", fundingTimestamp );
            put( "fundingDatetime", Bitmart.this.iso8601(fundingTimestamp) );
            put( "nextFundingRate", null );
            put( "nextFundingTimestamp", null );
            put( "nextFundingDatetime", null );
            put( "previousFundingRate", Bitmart.this.safeNumber(contract, "rate_value") );
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "hedged", null );
            put( "side", ((Helpers.isTrue((Helpers.isEqual(side, 1))))) ? "long" : "short" );
            put( "contracts", Bitmart.this.safeNumber(position, "current_amount") );
            put( "contractSize", Bitmart.this.safeNumber(finalMarket, "contractSize") );
            put( "entryPrice", Bitmart.this.safeNumber(position, "entry_price") );
            put( "markPrice", Bitmart.this.safeNumber(position, "mark_price") );
            put( "lastPrice", null );
            put( "notional", Bitmart.this.parseNumber(notional) );
            put( "leverage", Bitmart.this.safeNumber(position, "leverage") );
            put( "collateral", Bitmart.this.parseNumber(collateral) );
            put( "initialMargin", null );
            put( "initialMarginPercentage", null );
            put( "maintenanceMargin", Bitmart.this.parseNumber(maintenanceMargin) );
            put( "maintenanceMarginPercentage", Bitmart.this.parseNumber(maintenanceMarginPercentage) );
            put( "unrealizedPnl", Bitmart.this.safeNumber(position, "unrealized_value") );
            put( "realizedPnl", Bitmart.this.safeNumber(position, "realized_value") );
            put( "liquidationPrice", null );
            put( "marginMode", null );
            put( "percentage", null );
            put( "marginRatio", Bitmart.this.parseNumber(marginRatio) );
    ...
    public Object parseLiquidation(Object liquidation, Object... optionalArgs)
    {
        ...
        return this.safeLiquidation(new java.util.HashMap<String, Object>() {{
            ...
            put( "symbol", Bitmart.this.safeSymbol(marketId, market) );
            put( "contracts", Bitmart.this.parseNumber(contractsString) );
            put( "contractSize", Bitmart.this.parseNumber(contractSizeString) );
            put( "price", Bitmart.this.parseNumber(priceString) );
            put( "baseValue", Bitmart.this.parseNumber(baseValueString) );
            put( "quoteValue", Bitmart.this.parseNumber(quoteValueString) );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
        }});
    }
    ...
    public Object parseLedgerEntry(Object item, Object... optionalArgs)
    {
        ...
        return this.safeLedgerEntry(new java.util.HashMap<String, Object>() {{
            put( "info", item );
            put( "id", Bitmart.this.safeString(item, "tran_id") );
            put( "direction", finalDirection );
            put( "account", null );
            put( "referenceAccount", null );
            put( "referenceId", Bitmart.this.safeString(item, "tradeId") );
            put( "type", Bitmart.this.parseLedgerEntryType(type) );
            put( "currency", Helpers.GetValue(finalCurrency, "code") );
            put( "amount", Bitmart.this.parseNumber(finalAmount) );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "before", null );
            put( "after", null );
    ...
    public Object parseFundingHistory(Object contract, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", contract );
            put( "symbol", Bitmart.this.safeSymbol(marketId, market, null, "swap") );
            put( "code", Bitmart.this.safeCurrencyCode(currencyId) );
            put( "timestamp", timestamp );
            put( "datetime", Bitmart.this.iso8601(timestamp) );
            put( "id", Bitmart.this.safeString(contract, "tran_id") );
            put( "amount", Bitmart.this.safeNumber(contract, "amount") );
        }};
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositionMode(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", response );
                put( "hedged", (Helpers.isEqual(positionMode, "hedge_mode")) );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(api, "private")))
        {
            ...
            headers = new java.util.HashMap<String, Object>() {{
                put( "X-BM-KEY", Bitmart.this.apiKey );
                put( "X-BM-TIMESTAMP", timestamp );
