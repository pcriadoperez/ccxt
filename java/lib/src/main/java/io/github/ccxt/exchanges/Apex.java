...
public class Apex extends ApexApi
{
   ...
   public Apex (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "active", null );
        put( "deposit", !Helpers.isTrue(Apex.this.safeBool(chain, "depositDisable")) );
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "expiry", ((Helpers.isTrue((Helpers.isEqual(expiry, 0))))) ? null : expiry );
            put( "expiryDatetime", ((Helpers.isTrue((Helpers.isEqual(expiry, 0))))) ? null : Apex.this.iso8601(expiry) );
            put( "strike", null );
            put( "optionType", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "expiration", (Math.floor(Double.parseDouble(Helpers.toString(Helpers.add(Helpers.divide(timeNow, 1000), Helpers.multiply(Helpers.multiply(Helpers.multiply(30, 24), 60), 60)))))) );
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            } else
            {
                ...
                return this.extend(this.parseTransfer(data, this.currency(code)), new java.util.HashMap<String, Object>() {{
                    put( "timestamp", currentTime );
                    put( "datetime", Apex.this.iso8601(currentTime) );
                    put( "amount", Apex.this.parseNumber(finalAmount) );
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", transfer );
            put( "id", Apex.this.safeStringN(transfer, new java.util.ArrayList<Object>(java.util.Arrays.asList("transferId", "id"))) );
            put( "timestamp", timestamp );
            put( "datetime", Apex.this.iso8601(timestamp) );
