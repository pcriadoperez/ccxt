...
public class Coinmetro extends CoinmetroApi
{
   public Coinmetro () {
       super();
   }

   public Coinmetro (Object options) {
       super(options);
   }
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "tierBased", false );
                    put( "percentage", true );
                    put( "taker", Coinmetro.this.parseNumber("0.001") );
                    put( "maker", Coinmetro.this.parseNumber("0") );
                }} );
            }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(response)); i++)
            {
                ...
                Object type = null;
                if (Helpers.isTrue(Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(typeRaw, "coin")) || Helpers.isTrue(Helpers.isEqual(typeRaw, "token"))) || Helpers.isTrue(Helpers.isEqual(typeRaw, "erc20"))))
                {
                    type = "crypto";
        ...
        put( "type", finalType );
        put( "info", currency );
        put( "active", Coinmetro.this.safeBool(currency, "canTrade") );
        put( "deposit", Coinmetro.this.safeBool(currency, "canDeposit") );
        put( "withdraw", Coinmetro.this.safeBool(currency, "canWithdraw") );
        put( "fee", null );
        put( "precision", Coinmetro.this.parseNumber(Coinmetro.this.parsePrecision(finalPrecisionDigits)) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", Coinmetro.this.safeNumber(currency, "minQty") );
                put( "max", null );
            }} );
        ...
        put( "networks", new java.util.HashMap<String, Object>() {{}} );
            ...
            if (Helpers.isTrue(Helpers.isEqual(this.safeValue(this.options, "currenciesByIdForParseMarket"), null)))
            {
                ...
                Object currencyIdsList = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currenciesById).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(this.safeValue(this.options, "currenciesByIdForParseMarket"), null)))
            {
                ((java.util.List<Object>)promises).add(this.fetchCurrencies());
            }
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "linear", null );
            put( "inverse", null );
            put( "taker", Coinmetro.this.safeNumber(tradingFees, "taker") );
            put( "maker", Coinmetro.this.safeNumber(tradingFees, "maker") );
            ...
            put( "precision", new java.util.HashMap<String, Object>() {{
                ...
                put( "price", Coinmetro.this.parseNumber(Coinmetro.this.parsePrecision(Coinmetro.this.safeString(market, "precision"))) );
            }} );
            put( "limits", new java.util.HashMap<String, Object>() {{
    ...
    public Object parseMarketPrecisionAndLimits(Object currencyId)
    {
        ...
        Object result = new java.util.HashMap<String, Object>() {{
            put( "precision", Coinmetro.this.safeNumber(currency, "precision") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "timeframe", Coinmetro.this.safeString(Coinmetro.this.timeframes, timeframe, timeframe) );
            }};
            Object until = null;
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Coinmetro.this.iso8601(timestamp) );
            put( "symbol", symbol );
            put( "type", null );
            put( "side", side );
    ...
    public Object parseBidsAsks(Object bidasks, Object... optionalArgs)
    {
        ...
        Object prices = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)bidasks).keySet());
        Object result = new java.util.ArrayList<Object>(java.util.Arrays.asList());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object tickers = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tickersObject).values());
    ...
    public Object parseLedgerEntry(Object item, Object... optionalArgs)
    {
        ...
        return this.safeLedgerEntry(new java.util.HashMap<String, Object>() {{
            put( "info", finalItem );
            put( "id", null );
            put( "timestamp", Coinmetro.this.parse8601(datetime) );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "id", Coinmetro.this.safeString(finalOrder, "orderID") );
            put( "clientOrderId", clientOrderId );
            put( "timestamp", finalTimestamp );
            put( "datetime", Coinmetro.this.iso8601(finalTimestamp) );
            put( "lastTradeTimestamp", Coinmetro.this.safeInteger(finalOrder, "lastFillTime") );
            put( "status", finalStatus );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", finalType );
            put( "timeInForce", Coinmetro.this.parseOrderTimeInForce(Coinmetro.this.safeInteger(finalOrder, "timeInForce")) );
            put( "side", finalSide );
            put( "price", finalPrice );
            put( "triggerPrice", Coinmetro.this.safeString(finalOrder, "stopPrice") );
    ...
    public Object parseMarginLoan(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", null );
            put( "currency", Coinmetro.this.safeCurrencyCode(currencyId, currency) );
            put( "amount", null );
            put( "symbol", null );
            put( "timestamp", null );
            put( "datetime", null );
