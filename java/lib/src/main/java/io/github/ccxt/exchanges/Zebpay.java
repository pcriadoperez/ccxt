...
public class Zebpay extends ZebpayApi
{
   ...
   public Zebpay (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "active", Helpers.isTrue(depositAllowed) && Helpers.isTrue(withdrawAllowed) );
        put( "deposit", depositAllowed );
    ...
    final Object finalBase = base;
                    ...
                    put( "id", id );
                    put( "symbol", Helpers.add(Helpers.add(symbol, ":"), settle) );
                    put( "base", finalBase );
                    put( "quote", quote );
                    put( "baseId", baseId );
                    put( "quoteId", quoteId );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        Object queryLength = Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)query).keySet()));
