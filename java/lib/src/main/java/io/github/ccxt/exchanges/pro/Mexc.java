...
public class Mexc extends io.github.ccxt.exchanges.Mexc
{
   ...
   public Mexc (Object options) {
    ...
    public Object parseWsOHLCV(Object ohlcv, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        return new java.util.ArrayList<Object>(java.util.Arrays.asList(this.safeTimestamp2(ohlcv, "t", "windowStart"), this.safeNumber2(ohlcv, "o", "openingPrice"), this.safeNumber2(ohlcv, "h", "highestPrice"), this.safeNumber2(ohlcv, "l", "lowestPrice"), this.safeNumber2(ohlcv, "c", "closingPrice"), this.safeNumber2(ohlcv, "v", "volume")));
    }
    ...
    public void handleBooksideDelta(Object bookside, Object bidasks)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(bidasks)); i++)
        {
            ...
            if (Helpers.isTrue(((bidask instanceof java.util.List) || (bidask.getClass().isArray()))))
            {
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "side", ((Helpers.isTrue((Helpers.isEqual(side, "1"))))) ? "buy" : "sell" );
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object subscriptionHash, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            final Object _final_listenKey = listenKey;
            this.spawn(() -> { try { Thread.sleep(((Number)listenKeyRefreshRate).longValue()); this.keepAliveListenKey(_final_listenKey, parameters); } catch(Exception _e) {} });
            return listenKey;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> keepAliveListenKey(Object listenKey2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                ...
                Object listenKeyRefreshRate = this.safeInteger(this.options, "listenKeyRefreshRate", 1200000);
                this.spawn(() -> { try { Thread.sleep(((Number)listenKeyRefreshRate).longValue()); this.keepAliveListenKey(listenKey, parameters); } catch(Exception _e) {} });
