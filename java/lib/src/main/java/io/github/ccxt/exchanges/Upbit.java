...
public class Upbit extends UpbitApi
{
   ...
   public Upbit (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarketById(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
                ...
                put( "future", false );
                put( "option", false );
                put( "active", (Helpers.isEqual(state, "active")) );
                put( "contract", false );
                put( "linear", null );
                put( "inverse", null );
                put( "taker", fee );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderBooks(Object... optionalArgs)
    {
        ...
        put( "symbol", symbol );
        put( "bids", Upbit.this.sortBy(Upbit.this.parseBidsAsks(Helpers.GetValue(orderbook, "orderbook_units"), "bid_price", "bid_size"), 0, true) );
        put( "asks", Upbit.this.sortBy(Upbit.this.parseBidsAsks(Helpers.GetValue(orderbook, "orderbook_units"), "ask_price", "ask_size"), 0) );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "percentage", Upbit.this.safeString(ticker, "signed_change_rate") );
            put( "average", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //
            Object result = new java.util.HashMap<String, Object>() {{}};
            for (var t = 0; Helpers.isLessThan(t, Helpers.getArrayLength(response)); t++)
            {
                Object ticker = this.parseTicker(Helpers.GetValue(response, t));
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        Object parsedType = type; // java req;
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", code );
            put( "network", Upbit.this.networkIdToCode(networkId) );
            put( "address", address );
            put( "tag", tag );
        }};
    }
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(api, "private")))
        {
            ...
            Object hasQuery = Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)query).keySet()));
            Object auth = null;
