   ...
   public Okx (Object options) {
    ...
    public Object createExpiredOptionMarket(Object symbol)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(finalBase, "-"), quote), "-"), expiry), "-"), strike), "-"), optionType) );
            put( "symbol", Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(finalBase, "/"), quote), ":"), settle), "-"), expiry), "-"), strike), "-"), optionType) );
            put( "base", finalBase );
            put( "quote", quote );
            put( "settle", settle );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object update = new java.util.HashMap<String, Object>() {{
                put( "updated", null );
                put( "status", ((Helpers.isTrue((Helpers.isEqual(dataLength, 0))))) ? "ok" : "maintenance" );
                put( "eta", null );
                put( "url", null );
                put( "info", response );
            }};
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.extend(fees, new java.util.HashMap<String, Object>() {{
            ...
            put( "type", finalType );
            put( "spot", spot );
            put( "margin", Helpers.isTrue(spot) && Helpers.isTrue(leverageAboveOne) );
            put( "swap", finalSwap );
            put( "future", future );
            put( "option", option );
            put( "active", Helpers.isEqual(status, "live") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarketsByType(Object type2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "instType", Okx.this.convertToInstrumentType(type) );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)dataByCurrencyId).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyIds)); i++)
            {
                ...
                Object chains = Helpers.GetValue(dataByCurrencyId, currencyId);
                ...
                for (var j = 0; Helpers.isLessThan(j, chainsLength); j++)
                {
                    ...
                    Object networkCode = this.networkIdToCode(chainPart, Helpers.GetValue(currency, "code"));
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        Object request = new java.util.HashMap<String, Object>() {{
            ...
            put( "side", side );
            put( "ordType", type );
            put( "sz", Okx.this.amountToPrecision(symbol, amount) );
        }};
        ...
        } else if (Helpers.isTrue(Helpers.isTrue(hasStopLoss) || Helpers.isTrue(hasTakeProfit)))
        {
            ...
            Object attachOrdKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)attachAlgoOrd).keySet());
    ...
    final Object finalIds = ids;
                        final Object finalI = i;
                                            ((java.util.List<Object>)request).add(new java.util.HashMap<String, Object>() {{
                            put( "ordId", Helpers.GetValue(finalIds, finalI) );
                            put( "instId", Helpers.GetValue(market, "id") );
                        }});
                    }
                }
    ...
    final Object finalClientOrderIds = clientOrderIds;
                        final Object finalI = i;
                                            ((java.util.List<Object>)request).add(new java.util.HashMap<String, Object>() {{
                            put( "instId", Helpers.GetValue(market, "id") );
                            put( "clOrdId", Helpers.GetValue(finalClientOrderIds, finalI) );
                        }});
                    }
                }
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrdersAfter(Object timeout2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            Object request = new java.util.HashMap<String, Object>() {{
                put( "timeOut", ((Helpers.isTrue((Helpers.isGreaterThan(timeout, 0))))) ? Okx.this.parseToInt(Helpers.divide(timeout, 1000)) : 0 );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> withdraw(Object code, Object amount, Object address2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(fee, null)))
            {
                ...
                Object targetNetwork = this.safeDict(Helpers.GetValue(currency, "networks"), this.networkIdToCode(network), new java.util.HashMap<String, Object>() {{}});
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", code );
            put( "amount", finalAmount );
            put( "fromAccount", Okx.this.safeString(accountsById, fromAccountId) );
            put( "toAccount", Okx.this.safeString(accountsById, toAccountId) );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        Object isArray = ((parameters instanceof java.util.List) || (parameters.getClass().isArray()));
        ...
        } else if (Helpers.isTrue(Helpers.isEqual(api, "private")))
        {
            ...
            if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(method, "POST")) && Helpers.isTrue((Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(path, "trade/batch-orders")) || Helpers.isTrue(Helpers.isEqual(path, "trade/order-algo"))) || Helpers.isTrue(Helpers.isEqual(path, "trade/order"))))))
            {
                ...
                if (Helpers.isTrue(((parameters instanceof java.util.List) || (parameters.getClass().isArray()))))
                {
            ...
            {
                if (Helpers.isTrue(Helpers.isTrue(isArray) || Helpers.isTrue(Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)query).keySet())))))
                {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                ((java.util.List<Object>)result).add(new java.util.HashMap<String, Object>() {{
                    ...
                    put( "amount", Okx.this.safeNumber(entry, "balChg") );
                }});
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> modifyMarginHelper(Object symbol, Object amount, Object type, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return this.extend(this.parseMarginModification(entry, market), new java.util.HashMap<String, Object>() {{
                put( "status", ((Helpers.isTrue((Helpers.isEqual(errorCode, "0"))))) ? "ok" : "failed" );
            }});
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object parseOpenInterest(Object interest, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(((interest instanceof java.util.List) || (interest.getClass().isArray()))))
        {
            if (Helpers.isTrue(Helpers.isEqual(type, "option")))
            {
