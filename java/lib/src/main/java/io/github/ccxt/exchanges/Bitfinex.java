...
public class Bitfinex extends BitfinexApi
{
   ...
   public Bitfinex (Object options) {
    ...
    public Object getCurrencyId(Object code)
    {
        return Helpers.add("f", code);
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            var spotMarketsInfofuturesMarketsInfomarginIdsVariable = (Helpers.promiseAll(new java.util.ArrayList<Object>(java.util.Arrays.asList(spotMarketsInfoPromise, futuresMarketsInfoPromise, marginIdsPromise)))).join();
            var spotMarketsInfo = ((java.util.List<Object>) spotMarketsInfofuturesMarketsInfomarginIdsVariable).get(0);
            var futuresMarketsInfo = ((java.util.List<Object>) spotMarketsInfofuturesMarketsInfomarginIdsVariable).get(1);
            var marginIds = ((java.util.List<Object>) spotMarketsInfofuturesMarketsInfomarginIdsVariable).get(2);
            spotMarketsInfo = this.safeList(spotMarketsInfo, 0, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            futuresMarketsInfo = this.safeList(futuresMarketsInfo, 0, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            Object markets = this.arrayConcat(spotMarketsInfo, futuresMarketsInfo);
            marginIds = this.safeValue(marginIds, 0, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            //
            //    [
            //        "1INCH:USD",
            //        [
            ...
            {
                Object pair = Helpers.GetValue(markets, i);
                Object id = this.safeStringUpper(pair, 0);
                Object market = this.safeValue(pair, 1, new java.util.HashMap<String, Object>() {{}});
                Object spot = true;
                ...
                Object margin = false;
                if (Helpers.isTrue(Helpers.isTrue(spot) && Helpers.isTrue(this.inArray(id, marginIds))))
                {
                    margin = true;
                }
                Object type = ((Helpers.isTrue(spot))) ? "spot" : "swap";
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
            Object labels = new java.util.ArrayList<Object>(java.util.Arrays.asList("pub:list:currency", "pub:map:currency:sym", "pub:map:currency:label", "pub:map:currency:unit", "pub:map:currency:undl", "pub:map:currency:pool", "pub:map:currency:explorer", "pub:map:currency:tx:fee", "pub:map:tx:method", "pub:info:tx:status"));
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(ids)); i++)
            {
                ...
                Object type = null;
                if (Helpers.isTrue(isCryptoCoin))
                {
                    type = "crypto";
                }
                ...
                Object fid = Helpers.add("f", id);
                Object dwStatuses = this.safeList(Helpers.GetValue(indexed, "statuses"), id, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
                Object depositEnabled = Helpers.isEqual(this.safeInteger(dwStatuses, 1), 1);
                Object withdrawEnabled = Helpers.isEqual(this.safeInteger(dwStatuses, 2), 1);
        ...
        put( "id", fid );
        put( "uppercaseId", finalId );
        put( "code", code );
        put( "info", new java.util.ArrayList<Object>(java.util.Arrays.asList(id, label, pool, feeValues, undl)) );
        put( "type", finalType );
        put( "name", name );
        put( "active", true );
        ...
        put( "fee", fee );
        put( "precision", Helpers.parseInt(precision) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", Bitfinex.this.parseNumber(Bitfinex.this.parsePrecision(precision)) );
                put( "max", null );
            }} );
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", fee );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        Object isFetchTicker = Helpers.isTrue((Helpers.isEqual(length, 10))) || Helpers.isTrue((Helpers.isEqual(length, 16)));
        Object symbol = null;
        Object minusIndex = 0;
        ...
        {
            minusIndex = 1;
            isFundingCurrency = (Helpers.isEqual(length, 16));
        } else
        {
            Object marketId = this.safeString(ticker, 0);
            market = this.safeMarket(marketId, market);
            isFundingCurrency = (Helpers.isEqual(length, 17));
        }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositsWithdrawals(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(code, null)))
            {
                ...
                Helpers.addElementToObject(request, "currency", Helpers.GetValue(currency, "uppercaseId"));
