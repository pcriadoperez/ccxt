...
public class Oxfun extends io.github.ccxt.exchanges.Oxfun
{
   public Oxfun () {
       super();
   }
   ...
   public Oxfun (Object options) {
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "id", Oxfun.this.safeString(trade, "tradeId") );
            put( "order", null );
            put( "type", null );
            put( "takerOrMaker", Oxfun.this.safeStringLower(trade, "matchType") );
            put( "side", Oxfun.this.safeStringLower(trade, "side") );
            put( "price", Oxfun.this.safeNumber(trade, "price") );
            put( "amount", Oxfun.this.safeNumber(trade, "quantity") );
            put( "cost", null );
            put( "fee", null );
        }});
    }
    ...
    public Object parseWsBidAsk(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Oxfun.this.iso8601(timestamp) );
            put( "ask", Oxfun.this.safeNumber(ask, 0) );
            put( "askVolume", Oxfun.this.safeNumber(ask, 1) );
            put( "bid", Oxfun.this.safeNumber(bid, 0) );
            put( "bidVolume", Oxfun.this.safeNumber(bid, 1) );
            put( "info", ticker );
        }}, market);
    }
    ...
    public Object parseWsPosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "percentage", null );
            put( "contracts", Oxfun.this.safeNumber(position, "quantity") );
            ...
            put( "timestamp", null );
            put( "datetime", null );
            put( "lastUpdateTimestamp", Oxfun.this.safeInteger(position, "lastUpdated") );
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "op", "subscribe" );
                put( "finalArgs", new java.util.ArrayList<Object>(java.util.Arrays.asList(finalArgs)) );
            }};
            Object url = Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws");
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrderWs(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object data = new java.util.HashMap<String, Object>() {{
                put( "marketCode", Oxfun.this.marketId(finalSymbol) );
                put( "orderId", id );
            }};
            Object request = new java.util.HashMap<String, Object>() {{
                put( "op", "cancelorder" );
