   ...
   public Woo (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tokensById).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyIds)); i++)
            {
                ...
                Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)chainsByNetworkId).keySet());
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "symbol", symbol );
            put( "type", orderType );
            put( "timeInForce", Woo.this.parseTimeInForce(orderType) );
            put( "postOnly", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "network", Woo.this.networkCodeToId(finalNetworkCode) );
            }};
    ...
    public Object getDedicatedNetworkId(Object currency, Object parameters)
    {
        ...
        {
            Object supportedNetworks = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)Helpers.GetValue(currency, "networks")).keySet());
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "internal", null );
            put( "fee", fee );
            put( "network", Woo.this.networkIdToCode(Woo.this.safeString(transaction, "network")) );
        }};
    }
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "status", Woo.this.parseTransferStatus(Woo.this.safeString(transfer, "status", finalStatus)) );
            put( "info", transfer );
        }};
    }
    ...
    public Object parseFundingRate(Object fundingRate, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "fundingRate", Woo.this.safeNumber(fundingRate, "estFundingRate") );
            ...
            put( "interval", Helpers.add(intervalString, "h") );
        }};
    }
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "side", finalSide );
            put( "percentage", null );
            put( "hedged", !Helpers.isEqual(positionSide, "BOTH") );
            put( "stopLossPrice", null );
            put( "takeProfitPrice", null );
        }});
    }
