...
public class Cex extends io.github.ccxt.exchanges.Cex
{
   ...
   public Cex (Object options) {
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)freeBalance).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTrades(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Helpers.addElementToObject(this.options, "currentWatchTradeSymbol", symbol); // exchange supports only 1 symbol for this watchTrades channel
            ...
            {
                Helpers.addElementToObject(Helpers.GetValue(trades, i), "symbol", symbol);
            }
