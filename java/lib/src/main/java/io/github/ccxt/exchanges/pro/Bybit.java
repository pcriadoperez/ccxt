...
public class Bybit extends io.github.ccxt.exchanges.Bybit
{
   ...
   public Bybit (Object options) {
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "streaming", new java.util.HashMap<String, Object>() {{
                put( "ping", (java.util.function.Function<Client, Object>) Bybit.this::ping );
                put( "keepAlive", 18000 );
            }} );
        }});
    }
    ...
    public Object parseWsOHLCV(Object ohlcv, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        Object volumeIndex = ((Helpers.isTrue((Helpers.GetValue(market, "inverse"))))) ? "turnover" : "volume";
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            } else
            {
                ...
                Object selectedLimits = this.safeList2(limits, Helpers.GetValue(market, "type"), "default");
    ...
    public java.util.concurrent.CompletableFuture<Object> loadPositionsSnapshot(Client client, Object messageHash2)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object fetchFunctions = new java.util.ArrayList<Object>(java.util.Arrays.asList(this.fetchPositions(null, new java.util.HashMap<String, Object>() {{
        put( "type", "swap" );
        put( "subType", "linear" );
    }}), this.fetchPositions(null, new java.util.HashMap<String, Object>() {{
        put( "type", "swap" );
        put( "subType", "inverse" );
    }})));
    ...
    public void handleLiquidation(Client client, Object message)
    {
        ...
        //     }
        //
        if (Helpers.isTrue(((Helpers.GetValue(message, "data") instanceof java.util.List) || (Helpers.GetValue(message, "data").getClass().isArray()))))
        {
    ...
    public Object parseWsLiquidation(Object liquidation, Object... optionalArgs)
    {
        ...
        return this.safeLiquidation(new java.util.HashMap<String, Object>() {{
            ...
            put( "side", Bybit.this.safeStringLower(liquidation, "side", "S") );
            put( "baseValue", null );
            put( "quoteValue", null );
            put( "timestamp", timestamp );
            put( "datetime", Bybit.this.iso8601(timestamp) );
    ...
    public void handleOrder(Client client, Object message)
    {
        ...
        Object symbolsArray = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)symbols).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object url, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(authenticated, null)))
            {
                ...
                Object request = new java.util.HashMap<String, Object>() {{
                    put( "op", "auth" );
                    put( "args", new java.util.ArrayList<Object>(java.util.Arrays.asList(Bybit.this.apiKey, expires, signature)) );
                }};
                Object message = this.extend(request, parameters);
    ...
    public Object handleUnSubscribe(Client client, Object message)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map)client.subscriptions).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
        {
