...
public class Bitvavo extends BitvavoApi
{
   ...
   public Bitvavo (Object options) {
    ...
    public Object parseCurrenciesCustom(Object currencies)
    {
        //
        //     [
        //         {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencies)); i++)
        {
            ...
            Object networksArray = this.safeList(currency, "networks", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            Object deposit = Helpers.isEqual(this.safeString(currency, "depositStatus"), "OK");
            Object withdrawal = Helpers.isEqual(this.safeString(currency, "withdrawalStatus"), "OK");
    ...
    put( "id", id );
    put( "code", code );
    put( "name", Bitvavo.this.safeString(currency, "name") );
    put( "active", active );
    put( "deposit", finalDeposit );
    put( "withdraw", withdrawal );
