...
public class Ndax extends NdaxApi
{
   ...
   public Ndax (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "id", id );
        put( "name", Ndax.this.safeString(currency, "ProductFullName") );
        put( "code", code );
        put( "type", finalType );
        put( "precision", Ndax.this.safeNumber(currency, "TickSize") );
        put( "info", currency );
        put( "active", !Helpers.isTrue(Ndax.this.safeBool(currency, "IsDisabled")) );
        put( "deposit", Ndax.this.safeBool(currency, "DepositEnabled") );
        put( "withdraw", Ndax.this.safeBool(currency, "WithdrawEnabled") );
        put( "fee", null );
        ...
        put( "margin", Ndax.this.safeBool(currency, "MarginEnabled") );
    }}));
            }
            return result;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object parseMarket(Object market)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "future", false );
            put( "option", false );
            put( "active", (Helpers.isTrue(sessionRunning) && !Helpers.isTrue(isDisable)) );
            put( "contract", false );
            put( "linear", null );
            put( "inverse", null );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "high", Ndax.this.safeString(ticker, "SessionHigh") );
            put( "low", Ndax.this.safeString(ticker, "SessionLow") );
            put( "bid", Ndax.this.safeString(ticker, "BestBid") );
            put( "bidVolume", null );
            put( "ask", Ndax.this.safeString(ticker, "BestOffer") );
            put( "askVolume", null );
            put( "vwap", null );
            put( "open", open );
            put( "close", last );
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type2, Object side2, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "TimeInForce", 1 );
                put( "Side", orderSide );
                put( "Quantity", Helpers.parseFloat(Ndax.this.amountToPrecision(symbol, amount)) );
