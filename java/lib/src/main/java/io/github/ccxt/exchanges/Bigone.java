   ...
   public Bigone (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object currency = Helpers.GetValue(currenciesData, i);
                Object id = this.safeString(currency, "symbol");
                Object code = this.safeCurrencyCode(id);
                Object name = this.safeString(currency, "name");
                Object networks = new java.util.HashMap<String, Object>() {{}};
                Object chains = this.safeList(currency, "binding_gateways", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        put( "info", chain );
                ...
                Object type = null;
                if (Helpers.isTrue(this.safeBool(currency, "is_fiat")))
                {
                    type = "fiat";
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "change", Bigone.this.safeString2(ticker, "daily_change", "last24hPriceChange") );
            put( "percentage", null );
            put( "average", null );
    ...
    {
        Object bidsAsksKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)bidsAsks).keySet());
        Object result = new java.util.ArrayList<Object>(java.util.Arrays.asList());
    ...
    put( "currency", makerCode );
        ...
        } else if (Helpers.isTrue(!Helpers.isEqual(takerFeeCost, null)))
        {
            ...
            final Object finalTakerFeeCost = takerFeeCost;
            Helpers.addElementToObject(result, "fee", new java.util.HashMap<String, Object>() {{
    put( "cost", finalTakerFeeCost );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", response );
                put( "currency", code );
                put( "network", Bigone.this.networkIdToCode(selectedNetworkId) );
                put( "address", address );
                put( "tag", tag );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
