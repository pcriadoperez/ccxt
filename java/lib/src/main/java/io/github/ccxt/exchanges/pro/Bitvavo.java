...
public class Bitvavo extends io.github.ccxt.exchanges.Bitvavo
{
   ...
   public Bitvavo (Object options) {
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(Helpers.GetValue(orderbook, "nonce"), null)))
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(watchingOrderBookSnapshot, null)))
            {
                ...
                this.spawn(() -> { try { Thread.sleep(((Number)delay).longValue()); this.watchOrderBookSnapshot(client, message, subscription); } catch(Exception _e) {} });
            }
    ...
    public void handleWithdraws(Client client, Object message)
    {
        ...
        Object response = this.safeList(message, "response");
        Object messageHash = this.safeString(message, "requestId");
        Object withdrawals = this.parseTransactions(response, null, null, null, new java.util.HashMap<String, Object>() {{
            put( "type", "withdrawal" );
        }});
    ...
    public Object handleSubscriptionStatus(Client client, Object message)
    {
        ...
        Object names = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)subscriptions).keySet());
    ...
    public Object handleErrorMessage(Client client, Object message)
    {
        ...
        try
        {
            this.handleErrors(code, error, client.url, "", new java.util.HashMap<String, Object>() {{}}, error, message, new java.util.HashMap<String, Object>() {{}}, new java.util.HashMap<String, Object>() {{}});
        } catch(Exception e)
        {
            rejected = true;
