   ...
   public Htx (Object options) {
                        ...
                        put( "api", new java.util.HashMap<String, Object>() {{
                            ...
                            put( "future", new java.util.HashMap<String, Object>() {{
                                put( "linear", new java.util.HashMap<String, Object>() {{
                                    put( "public", "wss://api.hbdm.com/linear-swap-ws" );
                                    put( "private", "wss://api.hbdm.com/linear-swap-notification" );
                                }} );
                                put( "inverse", new java.util.HashMap<String, Object>() {{
                                    put( "public", "wss://api.hbdm.com/ws" );
                                    put( "private", "wss://api.hbdm.com/notification" );
                                }} );
                            }} );
                            put( "swap", new java.util.HashMap<String, Object>() {{
                                put( "inverse", new java.util.HashMap<String, Object>() {{
                                    put( "public", "wss://api.hbdm.com/swap-ws" );
                                    put( "private", "wss://api.hbdm.com/swap-notification" );
                                }} );
                                put( "linear", new java.util.HashMap<String, Object>() {{
                                    put( "public", "wss://api.hbdm.com/linear-swap-ws" );
                                    put( "private", "wss://api.hbdm.com/linear-swap-notification" );
            ...
            if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(sequence, null))) || Helpers.isTrue((Helpers.isLessThan(nonce, sequence)))))
            {
                ...
                if (Helpers.isTrue(Helpers.isLessThan(numAttempts, maxAttempts)))
                {
                    ...
                    if (Helpers.isTrue(Helpers.inOp(client.subscriptions, messageHash)))
                    {
                        ...
                        this.spawn(() -> { try { Thread.sleep(((Number)delayTime).longValue()); this.watchOrderBookSnapshot(client, message, subscription); } catch(Exception _e) {} });
                    }
                } else
                {
    ...
    public java.util.concurrent.CompletableFuture<Object> pong(Client client, Object message)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                var error = new NetworkError(Helpers.add(Helpers.add(this.id, " pong failed "), this.json(e)));
                client.reset(error);
            }
            return null;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(feeCurrency, null)))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "cost", Htx.this.safeString(trade, "transactFee") );
