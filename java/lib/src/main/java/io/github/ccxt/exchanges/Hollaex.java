   ...
   public Hollaex (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)pairs).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)coins).keySet());
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
            {
                ...
                Object networkIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)rawNetworks).keySet());
        ...
        put( "id", id );
        put( "numericId", Hollaex.this.safeInteger(currency, "id") );
        put( "code", code );
        put( "info", currency );
        put( "name", Hollaex.this.safeString(currency, "fullname") );
        put( "active", Hollaex.this.safeBool(currency, "active") );
        put( "deposit", Hollaex.this.safeBool(currency, "allow_deposit") );
        put( "withdraw", Hollaex.this.safeBool(currency, "allow_withdrawal") );
        put( "fee", Hollaex.this.safeNumber(currency, "withdrawal_fee") );
        put( "precision", Hollaex.this.safeNumber(currency, "increment_unit") );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", Hollaex.this.safeNumber(currency, "min") );
                put( "max", Hollaex.this.safeNumber(currency, "max") );
            }} );
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", null );
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.currencies_by_id).keySet());
    ...
    put( "percentage", false );
        ...
        {
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)withdrawalFees).keySet());
