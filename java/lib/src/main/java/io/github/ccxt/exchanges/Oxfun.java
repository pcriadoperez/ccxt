...
public class Oxfun extends OxfunApi
{
   public Oxfun () {
       super();
   }

   public Oxfun (Object options) {
       super(options);
   }
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "maker", Oxfun.this.parseNumber("0.00020") );
                    put( "taker", Oxfun.this.parseNumber("0.00070") );
                    put( "tiers", new java.util.HashMap<String, Object>() {{
                        put( "maker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(Oxfun.this.parseNumber("0"), Oxfun.this.parseNumber("0.00020"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Oxfun.this.parseNumber("2500000"), Oxfun.this.parseNumber("0.00010"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Oxfun.this.parseNumber("25000000"), Oxfun.this.parseNumber("0"))))) );
                        put( "taker", new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.ArrayList<Object>(java.util.Arrays.asList(Oxfun.this.parseNumber("0"), Oxfun.this.parseNumber("0.00070"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Oxfun.this.parseNumber("2500000"), Oxfun.this.parseNumber("0.00050"))), new java.util.ArrayList<Object>(java.util.Arrays.asList(Oxfun.this.parseNumber("25000000"), Oxfun.this.parseNumber("0.00040"))))) );
                    }} );
                }} );
            }} );
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "taker", Helpers.GetValue(Helpers.GetValue(Oxfun.this.fees, "trading"), "taker") );
            put( "maker", Helpers.GetValue(Helpers.GetValue(Oxfun.this.fees, "trading"), "maker") );
            ...
            put( "precision", new java.util.HashMap<String, Object>() {{
                put( "amount", null );
                put( "price", Oxfun.this.safeNumber(market, "tickSize") );
            }} );
            put( "limits", new java.util.HashMap<String, Object>() {{
                ...
                put( "amount", new java.util.HashMap<String, Object>() {{
                    put( "min", Oxfun.this.safeNumber(market, "minSize") );
                    put( "max", null );
                }} );
            ...
            put( "created", Oxfun.this.safeInteger(market, "listedAt") );
            put( "index", null );
            put( "info", market );
        }});
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "margin", null );
        put( "deposit", Oxfun.this.safeBool(chain, "canDeposit") );
        put( "withdraw", Oxfun.this.safeBool(chain, "canWithdraw") );
        put( "active", null );
        put( "fee", null );
        put( "precision", Oxfun.this.parseNumber(Oxfun.this.parsePrecision(Oxfun.this.safeString(chain, "transactionPrecision"))) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "deposit", new java.util.HashMap<String, Object>() {{
                put( "min", Oxfun.this.safeNumber(chain, "minDeposit") );
                put( "max", null );
            }} );
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Oxfun.this.safeNumber(chain, "minWithdrawal") );
                put( "max", null );
            }} );
        }} );
        put( "info", chain );
            ...
            Object allKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)result).keySet());
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Oxfun.this.iso8601(timestamp) );
            put( "high", Oxfun.this.safeString(ticker, "high24h") );
            put( "low", Oxfun.this.safeString(ticker, "low24h") );
            put( "bid", null );
            put( "bidVolume", null );
            put( "ask", null );
            put( "askVolume", null );
            put( "vwap", null );
            put( "open", Oxfun.this.safeString(ticker, "open24h") );
            put( "close", last );
            put( "last", last );
            ...
            put( "percentage", null );
            put( "average", null );
            put( "baseVolume", Oxfun.this.safeString(ticker, "currencyVolume24h") );
            put( "quoteVolume", null );
            put( "markPrice", Oxfun.this.safeString(ticker, "markPrice") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingRate(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            Object request = new java.util.HashMap<String, Object>() {{
                put( "marketCode", Oxfun.this.marketId(symbol) );
            }};
    ...
    public Object parseFundingRate(Object fundingRate, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "markPrice", null );
            put( "indexPrice", null );
            put( "interestRate", Oxfun.this.parseNumber("0") );
            put( "estimatedSettlePrice", null );
            put( "timestamp", estFundingRateTimestamp );
            put( "datetime", Oxfun.this.iso8601(estFundingRateTimestamp) );
            put( "fundingRate", Oxfun.this.safeNumber(fundingRate, "estFundingRate") );
    ...
    public Object parseFundingRateHistory(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", info );
            put( "symbol", symbol );
            put( "fundingRate", Oxfun.this.safeNumber(info, "fundingRate") );
            put( "timestamp", timestamp );
            put( "datetime", Oxfun.this.iso8601(timestamp) );
        }};
    }
...
final Object finalMarket = market;
                ...
                put( "tier", Oxfun.this.safeNumber(tier, "tier") );
                put( "symbol", Oxfun.this.safeSymbol(marketId, finalMarket) );
                put( "currency", Helpers.GetValue(finalMarket, "settle") );
                put( "minNotional", Oxfun.this.safeNumber(tier, "positionFloor") );
                put( "maxNotional", Oxfun.this.safeNumber(tier, "positionCap") );
                put( "maintenanceMarginRate", Oxfun.this.safeNumber(tier, "maintenanceMargin") );
                put( "maxLeverage", Oxfun.this.safeNumber(tier, "leverage") );
                put( "info", tier );
            }});
        }
        return tiers;
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        Object fee = new java.util.HashMap<String, Object>() {{
            put( "cost", Oxfun.this.safeString(trade, "fee") );
            put( "currency", Oxfun.this.safeCurrencyCode(Oxfun.this.safeString(trade, "feeAsset")) );
        }};
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "id", Oxfun.this.safeString(trade, "matchId") );
            put( "timestamp", timestamp );
            put( "datetime", Oxfun.this.iso8601(timestamp) );
            put( "symbol", symbol );
            put( "type", null );
            put( "order", Oxfun.this.safeString(trade, "orderId") );
            put( "side", Oxfun.this.safeStringLower(trade, "side") );
            put( "takerOrMaker", Oxfun.this.safeStringLower2(trade, "matchType", "orderMatchType") );
            put( "price", Oxfun.this.safeString(trade, "matchPrice") );
            put( "amount", Oxfun.this.safeString2(trade, "matchQuantity", "matchedQuantity") );
            put( "cost", null );
            put( "fee", fee );
            put( "info", trade );
        }}, market);
    ...
    public Object parseAccount(Object account)
    {
        ...
        //
        return new java.util.HashMap<String, Object>() {{
            put( "id", Oxfun.this.safeString(account, "accountId") );
            put( "type", null );
            put( "code", null );
            put( "info", account );
        }};
    ...
    public java.util.concurrent.CompletableFuture<Object> transfer(Object code, Object amount, Object fromAccount, Object toAccount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "quantity", Oxfun.this.currencyToPrecision(code, amount) );
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Oxfun.this.safeString(transfer, "id") );
            put( "timestamp", timestamp );
            put( "datetime", Oxfun.this.iso8601(timestamp) );
            put( "currency", Oxfun.this.safeCurrencyCode(currencyId, currency) );
            put( "amount", Oxfun.this.safeNumber(transfer, "quantity") );
            put( "fromAccount", Oxfun.this.safeString(transfer, "fromAccount") );
            put( "toAccount", Oxfun.this.safeString(transfer, "toAccount") );
            put( "status", Oxfun.this.parseTransferStatus(Oxfun.this.safeString(transfer, "status")) );
            put( "info", transfer );
        }};
    }
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "liquidationPrice", Oxfun.this.safeNumber(position, "estLiquidationPrice") );
            put( "entryPrice", Oxfun.this.safeNumber(position, "entryPrice") );
            put( "unrealizedPnl", Oxfun.this.safeNumber(position, "positionPnl") );
            put( "realizedPnl", null );
            put( "percentage", null );
            put( "contracts", Oxfun.this.safeNumber(position, "position") );
            put( "contractSize", null );
            put( "markPrice", Oxfun.this.safeNumber(position, "markPrice") );
            put( "lastPrice", null );
            put( "side", null );
            put( "hedged", null );
            put( "timestamp", null );
            put( "datetime", null );
            put( "lastUpdateTimestamp", Oxfun.this.safeInteger(position, "lastUpdatedAt") );
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrders(Object orders, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "timestamp", Oxfun.this.milliseconds() );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(feeCurrency, null)))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "currency", Oxfun.this.safeCurrencyCode(finalFeeCurrency) );
                put( "cost", Oxfun.this.safeNumber(order, "fees") );
            }};
        }
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "id", Oxfun.this.safeString(order, "orderId") );
            put( "clientOrderId", Oxfun.this.safeString(order, "clientOrderId") );
            put( "timestamp", timestamp );
            put( "datetime", Oxfun.this.iso8601(timestamp) );
            put( "lastTradeTimestamp", Oxfun.this.safeInteger(order, "lastMatchedAt") );
            put( "lastUpdateTimestamp", Oxfun.this.safeInteger(order, "lastModifiedAt") );
            put( "status", Oxfun.this.parseOrderStatus(finalStatus) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", Oxfun.this.parseOrderType(Oxfun.this.safeString(order, "orderType")) );
            put( "timeInForce", Oxfun.this.parseOrderTimeInForce(Oxfun.this.safeString(order, "timeInForce")) );
            put( "side", Oxfun.this.safeStringLower(order, "side") );
            put( "price", Oxfun.this.safeStringN(order, new java.util.ArrayList<Object>(java.util.Arrays.asList("price", "matchPrice", "limitPrice"))) );
            put( "average", null );
            put( "amount", Oxfun.this.safeString2(order, "totalQuantity", "quantity") );
            put( "filled", Oxfun.this.safeString2(order, "cumulativeMatchedQuantity", "matchQuantity") );
            put( "remaining", Oxfun.this.safeString(order, "remainQuantity") );
            put( "triggerPrice", triggerPrice );
            put( "stopLossPrice", triggerPrice );
            put( "cost", Oxfun.this.omitZero(Oxfun.this.safeString(order, "amount")) );
            put( "trades", null );
            put( "fee", finalFee );
            put( "info", order );
        }}, market);
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(api, "private")))
        {
            ...
            headers = new java.util.HashMap<String, Object>() {{
                ...
                put( "AccessKey", Oxfun.this.apiKey );
