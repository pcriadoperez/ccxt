...
public class Mexc extends MexcApi
{
   ...
   public Mexc (Object options) {
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "urls", new java.util.HashMap<String, Object>() {{
                ...
                put( "api", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "contract", new java.util.HashMap<String, Object>() {{
                        put( "public", "https://contract.mexc.com/api/v1/contract" );
                        put( "private", "https://contract.mexc.com/api/v1/private" );
                    }} );
            ...
            put( "options", new java.util.HashMap<String, Object>() {{
                ...
                put( "unavailableContracts", new java.util.HashMap<String, Object>() {{
                    put( "BTC/USDT:USDT", true );
                    put( "LTC/USDT:USDT", true );
                    put( "ETH/USDT:USDT", true );
                }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "id", id );
        put( "code", code );
        put( "name", Mexc.this.safeString(currency, "name") );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
    ...
    final Object finalQuote = quote;
                            ((java.util.List<Object>)result).add(new java.util.HashMap<String, Object>() {{
                    put( "id", id );
                    put( "symbol", Helpers.add(Helpers.add(Helpers.add(Helpers.add(base, "/"), finalQuote), ":"), settle) );
                    put( "base", base );
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", (Helpers.isEqual(state, "0")) );
                    put( "contract", true );
                    put( "linear", isLinear );
    ...
    public java.util.concurrent.CompletableFuture<Object> createSwapOrder(Object market, Object type2, Object side2, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            Object symbol = Helpers.GetValue(market, "symbol");
            Object unavailableContracts = this.safeValue(this.options, "unavailableContracts", new java.util.HashMap<String, Object>() {{}});
            Object isContractUnavaiable = this.safeBool(unavailableContracts, symbol, false);
            if (Helpers.isTrue(isContractUnavaiable))
            {
                throw new NotSupported((String)Helpers.add(Helpers.add(this.id, " createSwapOrder() does not support yet this symbol:"), symbol)) ;
            }
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "vol", Helpers.parseFloat(Mexc.this.amountToPrecision(symbol, amount)) );
                put( "type", finalType );
...
final Object finalRiskIncrVol = riskIncrVol;
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "network", Mexc.this.networkIdToCode(networkId, currencyId) );
            put( "address", address );
    ...
    public java.util.concurrent.CompletableFuture<Object> transfer(Object code, Object amount, Object fromAccount, Object toAccount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)accounts).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositionMode(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", response );
                put( "hedged", (Helpers.isEqual(positionMode, 1)) );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> setMarginMode(Object marginMode, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "openType", ((Helpers.isTrue((Helpers.isEqual(marginModeLower, "isolated"))))) ? 1 : 2 );
            }};
            if (Helpers.isTrue(!Helpers.isEqual(symbol, null)))
            {
                Helpers.addElementToObject(request, "symbol", Helpers.GetValue(market, "id"));
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(section, "spot")) || Helpers.isTrue(Helpers.isEqual(section, "broker"))))
        {
            ...
            if (Helpers.isTrue(Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)urlParams).keySet()))))
            {
