...
public class Bittrade extends BittradeApi
{
   ...
   public Bittrade (Object options) {
    ...
    final Object finalBase = base;
                    ...
                    put( "id", Helpers.add(baseId, quoteId) );
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", (Helpers.isEqual(state, "online")) );
                    put( "contract", false );
                    put( "linear", null );
                    put( "inverse", null );
                    put( "taker", fee );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        {
            if (Helpers.isTrue(((Helpers.GetValue(ticker, "bid") instanceof java.util.List) || (Helpers.GetValue(ticker, "bid").getClass().isArray()))))
            {
        ...
        {
            if (Helpers.isTrue(((Helpers.GetValue(ticker, "ask") instanceof java.util.List) || (Helpers.GetValue(ticker, "ask").getClass().isArray()))))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
            Object request = new java.util.HashMap<String, Object>() {{
                put( "language", Helpers.GetValue(Bittrade.this.options, "language") );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type2, Object side2, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "type", Helpers.add(Helpers.add(side, "-"), type) );
            }};
