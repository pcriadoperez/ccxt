...
public class Coinone extends CoinoneApi
{
   ...
   public Coinone (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "code", finalCode );
        put( "info", entry );
        put( "name", Coinone.this.safeString(entry, "name") );
        put( "active", null );
        put( "deposit", isDepositEnabled );
        put( "withdraw", isWithdrawEnabled );
        put( "fee", Coinone.this.safeNumber(entry, "withdrawal_fee") );
        put( "precision", Coinone.this.parseNumber(Coinone.this.parsePrecision(Coinone.this.safeString(entry, "max_precision"))) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Coinone.this.safeNumber(entry, "withdrawal_min_amount") );
                put( "max", null );
            }} );
        }} );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(feeCostString, null)))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "cost", finalFeeCostString );
                put( "rate", Coinone.this.safeString(order, "feeRate") );
                put( "currency", feeCurrencyCode );
            }};
        }
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "cost", null );
            put( "average", Coinone.this.safeString(order, "averageExecutedPrice") );
            put( "amount", finalAmountString );
            put( "filled", Coinone.this.safeString(order, "executedQty") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddresses(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)walletAddress).keySet());
            Object result = new java.util.HashMap<String, Object>() {{}};
