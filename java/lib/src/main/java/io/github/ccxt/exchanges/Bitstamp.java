   ...
   public Bitstamp (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "exceptions", new java.util.HashMap<String, Object>() {{
                put( "exact", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "Price is more than 20% below market price.", InvalidOrder.class );
    ...
    final Object finalQuote = quote;
                final Object finalBase = base;
                    ...
                    put( "id", Bitstamp.this.safeString(market, "url_symbol") );
                    put( "marketId", Helpers.add(Helpers.add(baseId, "_"), quoteId) );
                    ...
                    put( "swap", false );
                    put( "option", false );
                    put( "active", (Helpers.isEqual(status, "Enabled")) );
                    put( "contract", false );
                    put( "linear", null );
                    put( "inverse", null );
                    ...
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Bitstamp.this.safeNumber(parts, 0) );
                            put( "max", null );
                        }} );
                    }} );
                    put( "created", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarketsFromCache(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object response = (this.publicGetTradingPairsInfo(parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(response)); i++)
            {
                ...
                if (!Helpers.isTrue((Helpers.inOp(result, base))))
                {
                ...
                if (!Helpers.isTrue((Helpers.inOp(result, quote))))
                {
    ...
    public Object getCurrencyIdFromTransaction(Object transaction)
    {
        ...
        Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)transaction).keySet());
    ...
    public Object getMarketFromTrade(Object trade)
    {
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)trade).keySet());
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        {
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)trade).keySet());
        ...
        Object priceId = ((Helpers.isTrue((!Helpers.isEqual(rawMarketId, null))))) ? rawMarketId : Helpers.GetValue(market, "marketId");
    ...
    public Object parseLedgerEntry(Object item, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(type, "trade")))
        {
            ...
            Object market = null;
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)item).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (Helpers.callDynamically(this, method, new Object[] { parameters })).join();
    ...
    public Object handleErrors(Object httpCode, Object reason, Object url, Object method, Object headers, Object body, Object response, Object requestHeaders, Object requestBody)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(status, "error"))) || Helpers.isTrue((!Helpers.isEqual(error, null)))))
        {
            ...
            {
                Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)error).keySet());
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
                {
