   ...
   public Htx (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)types).keySet());
    ...
    final Object finalId = id;
                ...
                final Object finalCreated = created;
                    ...
                    put( "type", finalType );
                    put( "spot", spot );
                    put( "margin", (Helpers.isTrue(spot) && Helpers.isTrue(hasLeverage)) );
                    put( "swap", finalSwap );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        {
            if (Helpers.isTrue(Helpers.isTrue(!Helpers.isEqual(Helpers.GetValue(ticker, "bid"), null)) && Helpers.isTrue(((Helpers.GetValue(ticker, "bid") instanceof java.util.List) || (Helpers.GetValue(ticker, "bid").getClass().isArray())))))
            {
        ...
        {
            if (Helpers.isTrue(Helpers.isTrue(!Helpers.isEqual(Helpers.GetValue(ticker, "ask"), null)) && Helpers.isTrue(((Helpers.GetValue(ticker, "ask") instanceof java.util.List) || (Helpers.GetValue(ticker, "ask").getClass().isArray())))))
            {
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Htx.this.iso8601(finalTimestamp) );
            put( "symbol", symbol );
            put( "type", finalType );
            put( "side", finalSide );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (!Helpers.isTrue(((trades instanceof java.util.List) || (trades.getClass().isArray()))))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "code", code );
        put( "id", currencyId );
        put( "active", Helpers.isEqual(Htx.this.safeString(entry, "instStatus"), "normal") );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        put( "name", null );
    ...
    public Object networkIdToCode(Object... optionalArgs)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)Helpers.GetValue(this.options, "networkNamesByChainIds")).keySet());
    ...
    public Object networkCodeToId(Object networkCode, Object... optionalArgs)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)Helpers.GetValue(this.options, "networkChainIdsByNames")).keySet());
        Object keysLength = Helpers.getArrayLength(keys);
        if (Helpers.isTrue(Helpers.isEqual(keysLength, 0)))
        {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            marginMode = ((java.util.List<Object>) marginModeparametersVariable).get(0);
            parameters = ((java.util.List<Object>) marginModeparametersVariable).get(1);
            parameters = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("defaultSubType", "subType")));
            ...
            Object response = null;
            if (Helpers.isTrue(Helpers.isTrue(spot) || Helpers.isTrue(margin)))
            {
                    ...
                    if (Helpers.isTrue(isolated))
                    {
                        ...
                        for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(isolated_swap)); j++)
                        {
                            ...
                            Object subBalance = new java.util.HashMap<String, Object>() {{
                                ...
                                put( "free", Htx.this.safeNumber(balance, "margin_available") );
                            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrder(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(((order instanceof java.util.List) || (order.getClass().isArray()))))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrdersAfter(Object timeout2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            Object request = new java.util.HashMap<String, Object>() {{
                put( "timeout", ((Helpers.isTrue((Helpers.isGreaterThan(timeout, 0))))) ? Htx.this.parseToInt(Helpers.divide(timeout, 1000)) : 0 );
            }};
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "address", address );
            put( "tag", tag );
            put( "network", Htx.this.networkIdToCode(networkId) );
            put( "note", note );
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Htx.this.iso8601(timestamp) );
            put( "network", Htx.this.networkIdToCode(finalNetworkId) );
    ...
    public java.util.concurrent.CompletableFuture<Object> transfer(Object code, Object amount, Object fromAccount2, Object toAccount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "currency", Helpers.GetValue(currency, "id") );
                put( "amount", Helpers.parseFloat(Htx.this.currencyToPrecision(code, amount)) );
            }};
            Object subType = null;
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "maintenanceMargin", Htx.this.parseNumber(maintenanceMargin) );
            put( "maintenanceMarginPercentage", Htx.this.parseNumber(maintenanceMarginPercentage) );
            put( "marginRatio", Htx.this.parseNumber(marginRatio) );
            put( "timestamp", null );
            put( "datetime", null );
            put( "hedged", null );
    ...
    public Object parseLiquidation(Object liquidation, Object... optionalArgs)
    {
        ...
        return this.safeLiquidation(new java.util.HashMap<String, Object>() {{
            ...
            put( "price", Htx.this.safeNumber(liquidation, "price") );
            put( "side", Htx.this.safeStringLower(liquidation, "direction") );
