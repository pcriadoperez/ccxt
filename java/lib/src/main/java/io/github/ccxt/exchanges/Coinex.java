...
public class Coinex extends CoinexApi
{
   ...
   public Coinex (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(chains)); j++)
                {
                    ...
                    Object network = new java.util.HashMap<String, Object>() {{
                        ...
                        put( "name", null );
                        put( "active", Helpers.isTrue(canDepositChain) && Helpers.isTrue(canWithdrawChain) );
                        put( "deposit", canDepositChain );
                        put( "withdraw", canWithdrawChain );
                        put( "fee", Coinex.this.parseNumber(feeString) );
                        put( "precision", Coinex.this.parseNumber(precisionString) );
                        put( "limits", new java.util.HashMap<String, Object>() {{
                            put( "amount", new java.util.HashMap<String, Object>() {{
                                put( "min", null );
                                put( "max", null );
                            ...
                            put( "deposit", new java.util.HashMap<String, Object>() {{
                                put( "min", Coinex.this.parseNumber(minNetworkDepositString) );
                                put( "max", null );
                            }} );
                            put( "withdraw", new java.util.HashMap<String, Object>() {{
                                put( "min", Coinex.this.parseNumber(minNetworkWithdrawString) );
                                put( "max", null );
                            }} );
                        }} );
                        put( "info", chain );
        ...
        put( "code", code );
        put( "name", null );
        put( "active", Helpers.isTrue(canDeposit) && Helpers.isTrue(canWithdraw) );
        put( "deposit", canDeposit );
        put( "withdraw", canWithdraw );
        put( "fee", null );
        put( "precision", Coinex.this.parseNumber(firstPrecisionString) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", null );
                put( "max", null );
    ...
    final Object finalBase = base;
                    ...
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            ...
                            put( "max", Coinex.this.safeNumber(leverages, Helpers.subtract(leveragesLength, 1)) );
                        }} );
                        put( "amount", new java.util.HashMap<String, Object>() {{
...
final Object finalI = i;
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Coinex.this.iso8601(timestamp) );
            put( "network", Coinex.this.networkIdToCode(networkId) );
            put( "address", address );
    ...
    public Object parseMarginLoan(Object info, Object... optionalArgs)
    {
        ...
        Object timestamp = this.safeInteger(info, "expired_at");
        return new java.util.HashMap<String, Object>() {{
            put( "id", Coinex.this.safeInteger(info, "borrow_id") );
            put( "currency", Coinex.this.safeCurrencyCode(currencyId, currency) );
            put( "amount", Coinex.this.safeString(info, "borrow_amount") );
        ...
        } else
        {
            ...
            } else if (Helpers.isTrue(Helpers.isEqual(version, "v2")))
            {
                ...
                headers = new java.util.HashMap<String, Object>() {{
                    ...
                    put( "X-COINEX-TIMESTAMP", finalNonce );
                }};
                if (Helpers.isTrue(!Helpers.isEqual(method, "POST")))
                {
