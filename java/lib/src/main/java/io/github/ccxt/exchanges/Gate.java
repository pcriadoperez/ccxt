   ...
   public Gate (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "exceptions", new java.util.HashMap<String, Object>() {{
                put( "exact", new java.util.HashMap<String, Object>() {{
                    put( "INVALID_PARAM_VALUE", InvalidOrder.class );
    ...
    public Object createExpiredOptionMarket(Object symbol)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(finalBase, "_"), quote), "-"), "20"), finalExpiry), "-"), strike), "-"), optionType) );
            put( "symbol", Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(finalBase, "/"), quote), ":"), settle), "-"), finalExpiry), "-"), strike), "-"), optionType) );
            put( "base", finalBase );
            put( "quote", quote );
            put( "settle", settle );
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(spotMarketsResponse)); i++)
            {
                ...
                ((java.util.List<Object>)result).add(new java.util.HashMap<String, Object>() {{
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", (Helpers.isEqual(tradeStatus, "tradable")) );
                    put( "contract", false );
                    put( "linear", null );
                    put( "inverse", null );
                    ...
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            ...
                            put( "max", ((Helpers.isTrue(margin))) ? Gate.this.safeNumber(market, "max_quote_amount") : null );
                        }} );
                    }} );
    ...
    final Object finalSymbol = symbol;
                    final Object finalBase = base;
                        ...
                        put( "created", Gate.this.safeTimestamp(market, "create_time") );
                        put( "info", market );
                    }});
                }
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "active", null );
        put( "deposit", !Helpers.isTrue(Gate.this.safeBool(chain, "deposit_disabled")) );
        put( "withdraw", !Helpers.isTrue(Gate.this.safeBool(chain, "withdraw_disabled")) );
        put( "fee", null );
        ...
        put( "id", currencyId );
        put( "code", code );
        put( "name", Gate.this.safeString(entry, "name") );
        put( "type", type );
        put( "active", !Helpers.isTrue(Gate.this.safeBool(entry, "delisted")) );
        put( "deposit", !Helpers.isTrue(Gate.this.safeBool(entry, "deposit_disabled")) );
        put( "withdraw", !Helpers.isTrue(Gate.this.safeBool(entry, "withdraw_disabled")) );
        put( "fee", null );
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", Gate.this.safeString(currency, "code") );
            put( "address", address );
            put( "tag", Gate.this.safeString(depositAddress, "payment_id") );
            put( "network", Gate.this.networkIdToCode(Gate.this.safeString(depositAddress, "chain")) );
        }};
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(response)); i++)
            {
                ...
                {
                    Object networkIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)withdrawFixOnChains).keySet());
    ...
    public Object parseDepositWithdrawFee(Object fee, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(withdrawFixOnChains, null)))
        {
            Object chainKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)withdrawFixOnChains).keySet());
    ...
    put( "withdraw", new java.util.HashMap<String, Object>() {{
        put( "fee", Gate.this.parseNumber(Helpers.GetValue(withdrawFixOnChains, chainKey)) );
        put( "percentage", false );
    }} );
    put( "deposit", new java.util.HashMap<String, Object>() {{
        put( "fee", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.inOp(data, "balances")))
            {
                ...
                Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)balances).keySet());
...
final Object finalPointFee = pointFee;
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "network", Gate.this.networkIdToCode(networkId) );
            put( "address", address );
            put( "addressTo", null );
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        parameters = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("stopPrice", "triggerPrice", "stopLossPrice", "takeProfitPrice", "reduceOnly", "timeInForce", "postOnly")));
        ...
        if (Helpers.isTrue(nonTriggerOrder))
        {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(clientOrderId, null)))
            {
                ...
                parameters = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("text", "clientOrderId", "textIsRequired")));
            ...
            } else
            {
                ...
                request = new java.util.HashMap<String, Object>() {{
                    put( "put", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "amount", Gate.this.amountToPrecision(symbol, finalAmount) );
                        put( "account", finalMarginMode );
...
final Object finalRebate = rebate;
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "reduceOnly", Gate.this.safeValue(order, "is_reduce_only") );
            put( "side", finalSide );
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "initialMargin", Gate.this.parseNumber(finalInitialMarginString) );
            put( "initialMarginPercentage", Gate.this.parseNumber(Precise.stringDiv(finalInitialMarginString, notional)) );
            put( "maintenanceMargin", Gate.this.parseNumber(Precise.stringMul(maintenanceRate, notional)) );
            put( "maintenanceMarginPercentage", Gate.this.parseNumber(maintenanceRate) );
            ...
            put( "unrealizedPnl", Gate.this.safeNumber(position, "unrealised_pnl") );
            ...
            put( "lastPrice", null );
            put( "collateral", Gate.this.safeNumber(position, "margin") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarketLeverageTiers(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicFuturesGetSettleRiskLimitTiers(this.extend(request, requestParams))).join();
            //
            //     [
            //         {
            //             "maintenance_rate": "0.004",
    ...
    public Object parseEmulatedLeverageTiers(Object info, Object... optionalArgs)
    {
        ...
        while (Precise.stringLt(floor, riskLimitMax))
        {
            ...
            Object maintenanceMarginRateParsed = this.parseNumber(maintenanceMarginRate);
            Object maxLev = this.parseNumber(Precise.stringDiv("1", initialMarginRatio));
            ((java.util.List<Object>)tiers).add(new java.util.HashMap<String, Object>() {{
                ...
                put( "maintenanceMarginRate", maintenanceMarginRateParsed );
    ...
    public Object parseMarketLeverageTiers(Object info, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        if (!Helpers.isTrue(((info instanceof java.util.List) || (info.getClass().isArray()))))
        {
...
final Object finalI = i;
    ...
    public Object parseMarginLoan(Object info, Object... optionalArgs)
    {
        ...
        final Object finalTimestamp = timestamp;
        return new java.util.HashMap<String, Object>() {{
            put( "id", Gate.this.safeInteger(info, "id") );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue(containsSettle) && Helpers.isTrue(((String)path).endsWith(((String)"batch_cancel_orders")))))
        {
            ...
            query = newParams;
        } else if (Helpers.isTrue(((parameters instanceof java.util.List) || (parameters.getClass().isArray()))))
        {
        ...
        } else
        {
            ...
            } else
            {
                ...
                if (Helpers.isTrue(Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)urlQueryParams).keySet()))))
                {
            ...
            Object payloadArray = new java.util.ArrayList<Object>(java.util.Arrays.asList(((String)method).toUpperCase(), signaturePath, queryString, bodySignature, timestampString));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMySettlementHistory(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
            {
                throw new ArgumentsRequired((String)Helpers.add(this.id, " fetchMySettlementHistory() requires a symbol argument")) ;
            }
            (this.loadMarkets()).join();
            Object market = this.market(symbol);
            Object type = null;
            ...
            Object response = (this.privateOptionsGetMySettlements(this.extend(request, parameters))).join();
            //
            //     [
            //         {
            //             "size": -1,
    ...
    public Object parseGreeks(Object greeks, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", null );
            put( "datetime", null );
            put( "delta", Gate.this.safeNumber(greeks, "delta") );
            put( "gamma", Gate.this.safeNumber(greeks, "gamma") );
            put( "theta", Gate.this.safeNumber(greeks, "theta") );
            put( "vega", Gate.this.safeNumber(greeks, "vega") );
            put( "rho", null );
            put( "bidSize", Gate.this.safeNumber(greeks, "bid1_size") );
            put( "askSize", Gate.this.safeNumber(greeks, "ask1_size") );
            put( "bidImpliedVolatility", Gate.this.safeNumber(greeks, "bid_iv") );
            put( "askImpliedVolatility", Gate.this.safeNumber(greeks, "ask_iv") );
            put( "markImpliedVolatility", Gate.this.safeNumber(greeks, "mark_iv") );
            put( "bidPrice", Gate.this.safeNumber(greeks, "bid1_price") );
            put( "askPrice", Gate.this.safeNumber(greeks, "ask1_price") );
            put( "markPrice", Gate.this.safeNumber(greeks, "mark_price") );
            put( "lastPrice", Gate.this.safeNumber(greeks, "last_price") );
            put( "underlyingPrice", Gate.this.parseNumber(Helpers.GetValue(Helpers.GetValue(market, "info"), "underlying_price")) );
            put( "info", greeks );
        }};
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchLeverage(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.GetValue(market, "spot")))
            {
                ...
                {
                    response = (this.publicMarginGetCurrencyPairsCurrencyPair(this.extend(request, parameters))).join();
                }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchLeverages(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                response = (this.publicMarginGetCurrencyPairs(parameters)).join();
            }
    ...
    public Object parseOption(Object chain, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "bidPrice", Gate.this.safeNumber(chain, "bid1_price") );
            put( "askPrice", Gate.this.safeNumber(chain, "ask1_price") );
            put( "midPrice", null );
            put( "markPrice", Gate.this.safeNumber(chain, "mark_price") );
            put( "lastPrice", Gate.this.safeNumber(chain, "last_price") );
            put( "underlyingPrice", Gate.this.safeNumber(chain, "underlying_price") );
            put( "change", null );
            put( "percentage", null );
            put( "baseVolume", null );
