...
public class Hyperliquid extends HyperliquidApi
{
   ...
   public Hyperliquid (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "status", ((Helpers.isTrue((Helpers.isEqual(status, null))))) ? "ok" : "maintenance" );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "name", name );
        put( "code", code );
        put( "precision", Hyperliquid.this.parsePrecision(Hyperliquid.this.safeString(data, "weiDecimals")) );
        put( "info", data );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchHip3Markets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 1; Helpers.isLessThan(i, Helpers.getArrayLength(fetchDexes)); i++)
            {
                ...
                Object offset = Helpers.add(110000, Helpers.multiply((Helpers.subtract(i, 1)), 10000));
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(promises)); i++)
            {
                ...
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(universe)); j++)
                {
                    ...
                    Helpers.addElementToObject(data, "baseId", Helpers.add(j, offset));
    ...
    public java.util.concurrent.CompletableFuture<Object> initializeClient()
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                (Helpers.promiseAll(new java.util.ArrayList<Object>(java.util.Arrays.asList(this.handleBuilderFeeApproval(), this.setRef())))).join();
            } catch(Exception e)
            {
                return false;
            }
    ...
    put( "b", wallet );
    put( "f", Hyperliquid.this.safeInteger(Hyperliquid.this.options, "feeInt", 10) );
}});
        }
    ...
    public Object cancelOrdersRequest(Object ids, Object... optionalArgs)
    {
        ...
        */
        ...
        if (Helpers.isTrue(!Helpers.isEqual(clientOrderId, null)))
        {
            if (!Helpers.isTrue(((clientOrderId instanceof java.util.List) || (clientOrderId.getClass().isArray()))))
            {
...
final Object finalClientOrderId = clientOrderId;
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrdersAfter(Object timeout, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object cancelAction = new java.util.HashMap<String, Object>() {{
                ...
                put( "time", Helpers.add(nonce, timeout) );
            }};
            Object vaultAddress = null;
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "filled", Precise.stringSub(totalAmount, remaining) );
    ...
    public Object parseIncome(Object income, Object... optionalArgs)
    {
        ...
        Object marketSymbol = Helpers.add(baseId, "/USDC:USDC");
