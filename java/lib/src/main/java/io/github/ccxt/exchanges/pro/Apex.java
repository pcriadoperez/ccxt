   ...
   public Apex (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> loadPositionsSnapshot(Client client, Object messageHash2)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object fetchFunctions = new java.util.ArrayList<Object>(java.util.Arrays.asList(this.fetchPositions(null)));
    ...
    public java.util.concurrent.CompletableFuture<Object> pong(Client client, Object message)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                var error = new NetworkError(Helpers.add(Helpers.add(this.id, " handlePing failed with error "), this.json(e)));
                client.reset(error);
            }
            return null;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
