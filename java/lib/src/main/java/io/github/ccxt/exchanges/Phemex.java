   ...
   public Phemex (Object options) {
    ...
    public Object parseSwapMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "future", false );
            put( "option", false );
            put( "active", Helpers.isEqual(status, "Listed") );
            put( "contract", true );
            put( "linear", isLinear );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "info", currency );
        put( "code", code );
        put( "name", Phemex.this.safeString(currency, "name") );
        put( "active", Helpers.isEqual(Phemex.this.safeString(currency, "status"), "Listed") );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Phemex.this.iso8601(timestamp) );
            put( "network", Phemex.this.networkIdToCode(networkId) );
            put( "address", address );
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        {
            side = ((Helpers.isTrue((Helpers.isEqual(rawSide, "Buy"))))) ? "long" : "short";
        }
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "realizedPnl", Phemex.this.safeNumber(position, "curTermRealisedPnlRv") );
            ...
            put( "timestamp", null );
            put( "lastUpdateTimestamp", Phemex.this.safeIntegerProduct(position, "transactTimeNs", 0.000001) );
...
final Object finalI = i;
            final Object finalMarket = market;
                ...
                put( "maintenanceMarginRate", Phemex.this.safeString(tier, "maintenanceMargin") );
