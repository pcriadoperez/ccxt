...
public class Exmo extends ExmoApi
{
   public Exmo () {
       super();
   }
   ...
   public Exmo (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    ...
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "maker", Exmo.this.parseNumber("0.004") );
                    put( "taker", Exmo.this.parseNumber("0.004") );
                }} );
    ...
    public Object parseMarginModification(Object data, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", data );
            put( "symbol", Exmo.this.safeSymbol(null, market) );
            put( "type", null );
            put( "marginMode", "isolated" );
            put( "amount", null );
            put( "total", null );
            put( "code", Exmo.this.safeValue(market, "quote") );
            put( "status", "ok" );
            put( "timestamp", null );
            put( "datetime", null );
        }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //
            Object result = new java.util.HashMap<String, Object>() {{}};
            Object cryptoListKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)cryptoList).keySet());
    ...
    put( "fee", Exmo.this.parseFixedFloatValue(Exmo.this.safeString(finalSplitCommissionDesc, 0)) );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "code", code );
        put( "name", Exmo.this.safeString(currency, "description") );
        put( "type", finalType );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        put( "precision", Exmo.this.parseNumber("1e-8") );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", null );
                put( "max", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)spotResponse).keySet());
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
            {
                ...
                ((java.util.List<Object>)result).add(new java.util.HashMap<String, Object>() {{
                    ...
                    put( "type", "spot" );
                    put( "spot", true );
                    put( "margin", !Helpers.isEqual(marginMarket, null) );
                    put( "swap", false );
                    put( "future", false );
                    put( "option", false );
                    put( "active", null );
                    ...
                    put( "linear", null );
                    put( "inverse", null );
                    put( "taker", Exmo.this.parseNumber(Precise.stringDiv(takerString, "100")) );
                    put( "maker", Exmo.this.parseNumber(Precise.stringDiv(makerString, "100")) );
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Exmo.this.parseNumber("1e-8") );
                        put( "price", Exmo.this.parseNumber(Exmo.this.parsePrecision(Exmo.this.safeString(market, "price_precision"))) );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            put( "min", null );
                            put( "max", Exmo.this.safeNumber(market, "leverage") );
                        }} );
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", Exmo.this.safeNumber(market, "min_quantity") );
                            put( "max", Exmo.this.parseNumber(Precise.stringMax(maxQuantity, marginMaxQuantity)) );
                        }} );
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", Exmo.this.safeNumber(market, "min_price") );
                            put( "max", Exmo.this.safeNumber(market, "max_price") );
                        }} );
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Exmo.this.safeNumber(market, "min_amount") );
                            put( "max", Exmo.this.safeNumber(market, "max_amount") );
                        }} );
                    }} );
                    put( "created", null );
                    put( "info", market );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "resolution", Exmo.this.safeString(Exmo.this.timeframes, timeframe, timeframe) );
            }};
    ...
    public Object parseBalance(Object response)
    {
        ...
        {
            Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)wallets).keySet());
        ...
        } else
        {
            ...
            Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)free).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyIds)); i++)
            {
                Object currencyId = Helpers.GetValue(currencyIds, i);
                Object code = this.safeCurrencyCode(currencyId);
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Exmo.this.iso8601(timestamp) );
            put( "high", Exmo.this.safeString(ticker, "high") );
            put( "low", Exmo.this.safeString(ticker, "low") );
            put( "bid", Exmo.this.safeString(ticker, "buy_price") );
            put( "bidVolume", null );
            put( "ask", Exmo.this.safeString(ticker, "sell_price") );
            put( "askVolume", null );
            put( "vwap", null );
            put( "open", null );
            put( "close", last );
            ...
            put( "change", null );
            put( "percentage", null );
            put( "average", Exmo.this.safeString(ticker, "avg") );
            put( "baseVolume", Exmo.this.safeString(ticker, "vol") );
            put( "quoteVolume", Exmo.this.safeString(ticker, "vol_curr") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object result = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            Object marketIdsInner = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Exmo.this.iso8601(timestamp) );
            put( "timestamp", timestamp );
            put( "lastTradeTimestamp", Exmo.this.safeIntegerProduct(order, "updated", 0.000001) );
            put( "status", Exmo.this.parseStatus(Exmo.this.safeString(order, "order_status")) );
            put( "symbol", symbol );
            put( "type", finalType );
    ...
    public Object getMarketFromTrades(Object trades)
    {
        ...
        Object symbols = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tradesBySymbol).keySet());
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "id", Exmo.this.safeString2(transaction, "order_id", "task_id") );
            put( "txid", finalTxid );
            put( "type", finalType );
            put( "currency", code );
            put( "network", Exmo.this.safeString(transaction, "provider") );
            put( "amount", Exmo.this.parseNumber(finalAmountString) );
            put( "status", Exmo.this.parseTransactionStatus(Exmo.this.safeStringLower(transaction, "status")) );
            put( "timestamp", timestamp );
            put( "datetime", Exmo.this.iso8601(timestamp) );
            put( "address", finalAddress );
            ...
            put( "tagFrom", null );
            put( "tagTo", null );
            put( "updated", Exmo.this.safeTimestamp(transaction, "updated") );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        } else if (Helpers.isTrue(Helpers.isEqual(api, "private")))
        {
            ...
            headers = new java.util.HashMap<String, Object>() {{
                ...
                put( "Key", Exmo.this.apiKey );
                put( "Sign", Exmo.this.hmac(Exmo.this.encode(finalBody), Exmo.this.encode(Exmo.this.secret), sha512()) );
            }};
        }
