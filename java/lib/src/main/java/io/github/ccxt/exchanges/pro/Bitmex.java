   ...
   public Bitmex (Object options) {
    ...
    public void handleLiquidation(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawLiquidations)); i++)
        {
            ...
            Object symbol = Helpers.GetValue(liquidation, "symbol");
        ...
        Object symbols = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)liquidationsBySymbol).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
        {
            Object symbol = Helpers.GetValue(symbols, i);
    ...
    public void handleTrades(Client client, Object message)
    {
        ...
        Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)dataByMarketIds).keySet());
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        Object messageHashes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)results).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(messageHashes)); i++)
        {
            Object messageHash = Helpers.GetValue(messageHashes, i);
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        } else
        {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                Helpers.addElementToObject(numUpdatesByMarketId, marketId, this.sum(numUpdatesByMarketId, 1));
                Object market = this.safeMarket(marketId);
                Object symbol = Helpers.GetValue(market, "symbol");
                Object orderbook = Helpers.GetValue(this.orderbooks, symbol);
            ...
            Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)numUpdatesByMarketId).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketIds)); i++)
            {
                Object marketId = Helpers.GetValue(marketIds, i);
                Object market = this.safeMarket(marketId);
