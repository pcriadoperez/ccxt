...
public class Coinspot extends CoinspotApi
{
   ...
   public Coinspot (Object options) {
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "markets", new java.util.HashMap<String, Object>() {{
                ...
                put( "RFOX/AUD", Coinspot.this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
                    put( "id", "rfox" );
                    put( "symbol", "RFOX/AUD" );
                    put( "base", "RFOX" );
                    put( "quote", "AUD" );
    ...
    public Object parseBalance(Object response)
    {
        ...
        if (Helpers.isTrue(((balances instanceof java.util.List) || (balances.getClass().isArray()))))
        {
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(balances)); i++)
            {
                Object currencies = Helpers.GetValue(balances, i);
                Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currencies).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object result = new java.util.HashMap<String, Object>() {{}};
            Object prices = this.safeDict(response, "prices", new java.util.HashMap<String, Object>() {{}});
            Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)prices).keySet());
