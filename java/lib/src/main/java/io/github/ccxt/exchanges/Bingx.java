   ...
   public Bingx (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "type", "crypto" );
                ...
                } else
                {
                    ...
                    Object newNetworkCodes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)networks).keySet());
            ...
            Object codes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)result).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (!Helpers.isTrue(((ohlcvs instanceof java.util.List) || (ohlcvs.getClass().isArray()))))
            {
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "id", Bingx.this.safeStringN(trade, new java.util.ArrayList<Object>(java.util.Arrays.asList("id", "t"))) );
            put( "info", trade );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingRates(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.swapV2PublicGetQuotePremiumIndex(parameters)).join();
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkPrice(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(((Helpers.GetValue(response, "data") instanceof java.util.List) || (Helpers.GetValue(response, "data").getClass().isArray()))))
            {
        ...
        } else
        {
            if (Helpers.isTrue(isTwapOrder))
            {
                ...
                Object twapRequest = new java.util.HashMap<String, Object>() {{
                    ...
                    put( "positionSide", ((Helpers.isTrue((Helpers.isEqual(side, "buy"))))) ? "LONG" : "SHORT" );
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "network", Bingx.this.networkIdToCode(finalNetwork) );
    ...
    public Object parseMarginModification(Object data, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", data );
            put( "symbol", Bingx.this.safeString(market, "symbol") );
            put( "type", ((Helpers.isTrue((Helpers.isEqual(type, "1"))))) ? "add" : "reduce" );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositWithdrawFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object responseCodes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
    ...
    public Object parseParams(Object parameters)
    {
        ...
        Object rawKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)parameters).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositionMode(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", response );
                put( "hedged", (Helpers.isEqual(dualSidePosition, "true")) );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        Object isSandbox = this.safeBool(this.options, "sandboxMode", false);
        if (Helpers.isTrue(Helpers.isTrue(isSandbox) && Helpers.isTrue((!Helpers.isEqual(type, "swap")))))
        {
