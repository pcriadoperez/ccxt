   ...
   public Coinbaseinternational (Object options) {
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "network", Coinbaseinternational.this.networkIdToCode(Coinbaseinternational.this.safeString(transaction, "network_name")) );
            put( "address", null );
    ...
    public Object parseCurrency(Object currency)
    {
        ...
        return this.safeCurrencyStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "precision", null );
            put( "info", currency );
            put( "active", (Helpers.isEqual(statusId, "ACTIVE")) );
            put( "deposit", null );
            put( "withdraw", null );
            put( "networks", null );
            put( "fee", null );
    ...
    public Object safeNetwork(Object network)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "id", networkId );
            put( "name", Coinbaseinternational.this.safeString(network, "name") );
            put( "network", Coinbaseinternational.this.safeString(network, "network") );
            put( "active", Coinbaseinternational.this.safeBool(network, "active", isEnabled) );
            put( "deposit", finalDepositEnabled );
            put( "withdraw", finalWithdrawEnabled );
            put( "fee", Coinbaseinternational.this.safeNumber(network, "fee") );
            put( "precision", Coinbaseinternational.this.safeNumber(network, "precision") );
            put( "limits", new java.util.HashMap<String, Object>() {{
                put( "withdraw", new java.util.HashMap<String, Object>() {{
                    put( "min", Coinbaseinternational.this.safeNumber(withdraw, "min") );
                    put( "max", finalWithdrawMax );
                }} );
                put( "deposit", new java.util.HashMap<String, Object>() {{
                    put( "min", Coinbaseinternational.this.safeNumber(deposit, "min") );
