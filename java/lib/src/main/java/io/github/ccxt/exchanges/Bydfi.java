   ...
   public Bydfi (Object options) {
            ...
            put( "api", new java.util.HashMap<String, Object>() {{
                put( "public", new java.util.HashMap<String, Object>() {{
                    put( "get", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "v1/swap/market/exchange_info", 1 );
                        put( "v1/swap/market/depth", 1 );
                        put( "v1/swap/market/trades", 1 );
                        put( "v1/swap/market/klines", 1 );
                        put( "v1/swap/market/ticker/24hr", 1 );
                        put( "v1/swap/market/ticker/price", 1 );
                        put( "v1/swap/market/mark_price", 1 );
                        put( "v1/swap/market/funding_rate", 1 );
                        put( "v1/swap/market/funding_rate_history", 1 );
                        put( "v1/swap/market/risk_limit", 1 );
                    }} );
                }} );
                put( "private", new java.util.HashMap<String, Object>() {{
                    put( "get", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "v1/swap/trade/open_order", 1 );
                        put( "v1/swap/trade/plan_order", 1 );
                        put( "v1/swap/trade/leverage", 1 );
                        put( "v1/swap/trade/history_order", 1 );
                        put( "v1/swap/trade/history_trade", 1 );
                        put( "v1/swap/trade/position_history", 1 );
                        put( "v1/swap/trade/positions", 1 );
                        put( "v1/swap/account/balance", 1 );
                        put( "v1/swap/user_data/assets_margin", 1 );
                        put( "v1/swap/user_data/position_side/dual", 1 );
                    ...
                    put( "post", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "v1/swap/trade/place_order", 1 );
                        put( "v1/swap/trade/batch_place_order", 1 );
                        put( "v1/swap/trade/edit_order", 1 );
                        put( "v1/swap/trade/batch_edit_order", 1 );
                        put( "v1/swap/trade/cancel_all_order", 1 );
                        put( "v1/swap/trade/leverage", 1 );
                        put( "v1/swap/trade/batch_leverage_margin", 1 );
                        put( "v1/swap/user_data/margin_type", 1 );
                        put( "v1/swap/user_data/position_side/dual", 1 );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketExchangeInfo(parameters)).join();
            //
            //     {
            //         "code": "200",
            //         "message": "success",
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "future", false );
            put( "option", false );
            put( "active", Helpers.isEqual(status, "NORMAL") );
            put( "contract", true );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketDepth(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTrades(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketTrades(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapTradeHistoryTrade(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketKlines(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 1, new java.util.HashMap<String, Object>() {{}});
            (this.loadMarkets()).join();
            Object response = (this.publicGetV1SwapMarketTicker24hr(parameters)).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTicker(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketTicker24hr(this.extend(request, parameters))).join();
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingRate(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketFundingRate(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingRateHistory(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetV1SwapMarketFundingRateHistory(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privatePostV1SwapTradePlaceOrder(orderRequest)).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrders(Object orders, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privatePostV1SwapTradeBatchPlaceOrder(this.extend(request, parameters))).join();
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> editOrder(Object id, Object symbol, Object type, Object side, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privatePostV1SwapTradeEditOrder(request)).join();
            Object data = this.safeDict(response, "data", new java.util.HashMap<String, Object>() {{}});
    ...
    public java.util.concurrent.CompletableFuture<Object> editOrders(Object orders, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privatePostV1SwapTradeBatchEditOrder(this.extend(request, parameters))).join();
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            return this.parseOrders(data);
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privatePostV1SwapTradeCancelAllOrder(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOpenOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (!Helpers.isTrue(trigger))
            {
                ...
                //     }
                //
                response = (this.privateGetV1SwapTradeOpenOrder(this.extend(request, parameters))).join();
            } else
            {
                response = (this.privateGetV1SwapTradePlanOrder(this.extend(request, parameters))).join();
            }
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCanceledAndClosedOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapTradeHistoryOrder(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> setLeverage(Object leverage, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privatePostV1SwapTradeLeverage(this.extend(request, parameters))).join();
            Object data = this.safeDict(response, "data", new java.util.HashMap<String, Object>() {{}});
            return data;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchLeverage(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapTradeLeverage(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositions(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapTradePositions(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositionHistory(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapTradePositionHistory(this.extend(request, parameters))).join();
            //
            //
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarginMode(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapUserDataAssetsMargin(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> setMarginMode(Object marginMode2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.privatePostV1SwapUserDataMarginType(this.extend(request, parameters))).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> setPositionMode(Object hedged, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //     }
            //
            return (this.privatePostV1SwapUserDataPositionSideDual(this.extend(request, parameters))).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositionMode(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetV1SwapUserDataPositionSideDual(this.extend(request, parameters))).join();
            //
            //     {
            //         "code": 200,
            //         "message": "success",
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{}};
            Object response = null;
            if (Helpers.isTrue(!Helpers.isEqual(accountType, "swap")))
            {
            ...
            } else
            {
                ...
                //         "success": true
                //     }
                response = (this.privateGetV1SwapAccountBalance(this.extend(request, parameters))).join();
            }
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionsHelper(Object type2, Object code2, Object since, Object limit2, Object... optionalArgs)
    {
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "type", null );
            put( "currency", code );
            put( "network", Bydfi.this.networkIdToCode(Bydfi.this.safeString(transaction, "network")) );
