   ...
   public Toobit (Object options) {
    ...
    public Object parseMyTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "takerOrMaker", ((Helpers.isTrue(Toobit.this.safeBool(trade, "m")))) ? "maker" : "taker" );
    ...
    public Object parseWsPosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            put( "info", position );
            put( "id", null );
            put( "symbol", Toobit.this.safeSymbol(marketId, null) );
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(authenticated, null)))
            {
                ...
                if (Helpers.isTrue(Helpers.isGreaterThan(Helpers.subtract(time, lastAuthenticatedTime), delay)))
                {
                    ...
                    {
                        var err = new AuthenticationError(Helpers.add(Helpers.add(this.id, " "), this.json(e)));
