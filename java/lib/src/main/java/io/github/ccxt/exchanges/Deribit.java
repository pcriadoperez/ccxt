...
public class Deribit extends DeribitApi
{
   ...
   public Deribit (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "code", code );
        put( "id", currencyId );
        put( "name", Deribit.this.safeString(currency, "currency_long") );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
        put( "type", "crypto" );
        put( "fee", Deribit.this.safeNumber(currency, "withdrawal_fee") );
        put( "precision", null );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "status", ((Helpers.isTrue((Helpers.isEqual(locked, "false"))))) ? "ok" : "maintenance" );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "average", null );
            put( "baseVolume", null );
            put( "quoteVolume", Deribit.this.safeString(stats, "volume") );
    ...
    public Object parseTransfer(Object transfer, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "fromAccount", ((Helpers.isTrue(!Helpers.isEqual(direction, "payment")))) ? account : null );
            put( "toAccount", ((Helpers.isTrue(Helpers.isEqual(direction, "payment")))) ? account : null );
            put( "timestamp", timestamp );
            put( "datetime", Deribit.this.iso8601(timestamp) );
        }};
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingRate(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "instrument_name", Helpers.GetValue(market, "id") );
                put( "start_timestamp", Helpers.subtract(time, (Helpers.multiply(Helpers.multiply(Helpers.multiply(8, 60), 60), 1000))) );
                put( "end_timestamp", time );
            }};
