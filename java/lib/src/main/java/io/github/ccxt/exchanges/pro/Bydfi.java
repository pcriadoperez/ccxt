...
public class Bydfi extends io.github.ccxt.exchanges.Bydfi
{
   ...
   public Bydfi (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "urls", new java.util.HashMap<String, Object>() {{
                put( "api", new java.util.HashMap<String, Object>() {{
                    put( "ws", "wss://stream.bydfi.com/v1/public/swap" );
                }} );
            }} );
    ...
    public Object getMessageHashesForTickersUnsubscription()
    {
        ...
        Object messageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)subscriptions).keySet());
    ...
    public void handleOrder(Client client, Object message)
    {
        ...
        {
            Object hash = Helpers.GetValue(messageHashes, i);
            if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(hash, symbolMessageHash)) || Helpers.isTrue(Helpers.isEqual(hash, messageHash))))
            {
                match = true;
                break;
            }
        }
        if (Helpers.isTrue(match))
        {
    ...
    public Object parseWsPosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", null );
            put( "lastUpdateTimestamp", null );
            put( "hedged", (!Helpers.isEqual(positionMode, "ONEWAY")) );
