...
public class Novadax extends NovadaxApi
{
   public Novadax () {
       super();
   }
   ...
   public Novadax (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    put( "tierBased", false );
                    put( "percentage", true );
                    put( "taker", Novadax.this.parseNumber("0.005") );
                    put( "maker", Novadax.this.parseNumber("0.0025") );
                }} );
            }} );
    ...
    public Object parseMarket(Object market)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "future", false );
            put( "option", false );
            put( "active", (Helpers.isEqual(status, "ONLINE")) );
            put( "contract", false );
            put( "linear", null );
            put( "inverse", null );
            ...
            put( "precision", new java.util.HashMap<String, Object>() {{
                put( "amount", Novadax.this.parseNumber(Novadax.this.parsePrecision(Novadax.this.safeString(market, "amountPrecision"))) );
                put( "price", Novadax.this.parseNumber(Novadax.this.parsePrecision(Novadax.this.safeString(market, "pricePrecision"))) );
            }} );
            put( "limits", new java.util.HashMap<String, Object>() {{
                ...
                put( "amount", new java.util.HashMap<String, Object>() {{
                    put( "min", Novadax.this.safeNumber(market, "minOrderAmount") );
                    put( "max", null );
                }} );
                ...
                put( "cost", new java.util.HashMap<String, Object>() {{
                    put( "min", Novadax.this.safeNumber(market, "minOrderValue") );
                    put( "max", null );
                }} );
            }} );
            put( "created", null );
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Novadax.this.iso8601(timestamp) );
            put( "high", Novadax.this.safeString(ticker, "high24h") );
            put( "low", Novadax.this.safeString(ticker, "low24h") );
            put( "bid", Novadax.this.safeString(ticker, "bid") );
            put( "bidVolume", null );
            put( "ask", Novadax.this.safeString(ticker, "ask") );
            put( "askVolume", null );
            put( "vwap", null );
            put( "open", open );
            put( "close", last );
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(feeString, null)))
        {
            ...
            fee = new java.util.HashMap<String, Object>() {{
                put( "cost", Novadax.this.safeString(trade, "feeAmount") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "unit", Novadax.this.safeString(Novadax.this.timeframes, timeframe, timeframe) );
            }};
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "side", side );
            put( "price", price );
            put( "triggerPrice", Novadax.this.safeNumber(order, "stopPrice") );
            put( "amount", amount );
            put( "cost", cost );
            put( "average", average );
            put( "filled", filled );
    ...
    public java.util.concurrent.CompletableFuture<Object> transfer(Object code, Object amount, Object fromAccount2, Object toAccount2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "transferAmount", Novadax.this.currencyToPrecision(code, amount) );
                put( "currency", Helpers.GetValue(currency, "id") );
                put( "subId", ((Helpers.isTrue((Helpers.isEqual(type, "master-transfer-in"))))) ? toAccount : fromAccount );
    ...
    public java.util.concurrent.CompletableFuture<Object> withdraw(Object code, Object amount, Object address, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "amount", Novadax.this.currencyToPrecision(code, amount) );
                put( "wallet", address );
            }};
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        } else if (Helpers.isTrue(Helpers.isEqual(api, "private")))
        {
            ...
            headers = new java.util.HashMap<String, Object>() {{
                put( "X-Nova-Access-Key", Novadax.this.apiKey );
