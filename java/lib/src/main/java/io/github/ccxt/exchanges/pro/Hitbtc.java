...
public class Hitbtc extends io.github.ccxt.exchanges.Hitbtc
{
   ...
   public Hitbtc (Object options) {
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        Object data = ((Helpers.isTrue(snapshot))) ? snapshot : update;
        Object type = ((Helpers.isTrue(snapshot))) ? "snapshot" : "update";
        Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)data).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                if (!Helpers.isTrue(((newTickers instanceof java.util.List) || (newTickers.getClass().isArray()))))
                {
