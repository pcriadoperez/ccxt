...
public class Gate extends io.github.ccxt.exchanges.Gate
{
   ...
   public Gate (Object options) {
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)marketIds).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> loadPositionsSnapshot(Client client, Object messageHash2, Object type2)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object type = type3;
            Object positions = (this.fetchPositions(null, new java.util.HashMap<String, Object>() {{
                put( "type", type );
            }})).join();
            Helpers.addElementToObject(this.positions, type, new ArrayCache.ArrayCacheBySymbolBySide());
    ...
    public void handleLiquidation(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawLiquidations)); i++)
        {
            ...
            client.resolve(liquidations, Helpers.add("myLiquidations::", symbol));
        }
    ...
    public Object getMarketTypeByUrl(Object url)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)findBy).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
        {
