   ...
   public Cryptocom (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currencyMap).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)depositAddresses).keySet());
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "quoteVolume", ((Helpers.isTrue((Helpers.isEqual(quote, "USD"))))) ? Cryptocom.this.safeString(ticker, "vv") : null );
            put( "info", ticker );
        }}, market);
    }
    ...
    public Object paramsToString(Object obj, Object level)
    {
        ...
        if (Helpers.isTrue(((obj instanceof java.util.List) || (obj.getClass().isArray()))))
        {
            paramsKeys = obj;
        } else
        {
            Object sorted = this.keysort(obj);
            paramsKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)sorted).keySet());
        }
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(paramsKeys)); i++)
        {
            ...
            } else if (Helpers.isTrue(((value instanceof java.util.List) || (value.getClass().isArray()))))
            {
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        } else
        {
            ...
            Object paramsKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)requestParams).keySet());
