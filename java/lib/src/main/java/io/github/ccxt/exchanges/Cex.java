...
public class Cex extends CexApi
{
   ...
   public Cex (Object options) {
    ...
    public Object parseCurrency(Object rawCurrency)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)rawNetworks).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type2, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "orderType", Cex.this.capitalize(((String)type).toLowerCase()) );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddress(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "accountId", finalAccountId );
                put( "currency", Helpers.GetValue(currency, "id") );
                put( "blockchain", Cex.this.networkCodeToId(finalNetworkCode) );
            }};
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "network", Cex.this.networkIdToCode(Cex.this.safeString(depositAddress, "blockchain")) );
            put( "address", address );
            put( "tag", null );
        }};
    }
