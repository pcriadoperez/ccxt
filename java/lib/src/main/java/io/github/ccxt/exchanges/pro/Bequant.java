...
public class Bequant extends io.github.ccxt.exchanges.Bequant
{
   ...
   public Bequant (Object options) {
    ...
    public Object describe()
    {
        ...
        Object describeExtended = this.getDescribeForExtendedWsExchange(new io.github.ccxt.exchanges.Bequant(), new io.github.ccxt.exchanges.Hitbtc(), super.describe());
        return this.deepExtend(describeExtended, new java.util.HashMap<String, Object>() {{
            put( "id", "bequant" );
            put( "name", "Bequant" );
