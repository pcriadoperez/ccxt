...
public class Bitget extends io.github.ccxt.exchanges.Bitget
{
   ...
   public Bitget (Object options) {
    ...
    public Object getInstType(Object market, Object... optionalArgs)
    {
        Object uta = Helpers.getArg(optionalArgs, 0, false);
        Object parameters = Helpers.getArg(optionalArgs, 1, new java.util.HashMap<String, Object>() {{}});
        if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(uta, null))) || !Helpers.isTrue(uta)))
        {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.watchPublic(messageHash, args, parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object tickers = (this.watchPublicMultiple(messageHashes, topics, parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object ohlcv = (this.watchPublic(messageHash, args, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.unWatchChannel(symbol, channel, messageHash, parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.unWatchChannel(symbol, channel, "orderbook", parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object trades = (this.watchPublicMultiple(messageHashes, topics, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTrades(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.unWatchChannel(symbol, channelTopic, "trade", parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPositions(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object newPositions = (this.watchPrivate(messageHash, subscriptionHash, args, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
                return newPositions;
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orders = (this.watchPrivate(messageHash, subscriptionHash, args, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object trades = (this.watchPrivate(messageHash, subscriptionHash, args, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPublic(Object messageHash, Object args, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(uta))
            {
                url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "utaPublic");
            } else
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPublicMultiple(Object messageHashes, Object argsArray, Object... optionalArgs)
    {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPrivate(Object messageHash, Object subscriptionHash, Object args, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(uta))
            {
                url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "utaPrivate");
            } else
            {
                url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "private");
            }
            Object sandboxMode = this.safeBool2(this.options, "sandboxMode", "sandbox", false);
            if (Helpers.isTrue(sandboxMode))
            {
    ...
    public Object handleUnSubscriptionStatus(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(argsList)); i++)
        {
            ...
            } else if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(channel, "trade"))) || Helpers.isTrue((Helpers.isEqual(channel, "publicTrade")))))
            {
            ...
            } else if (Helpers.isTrue(((String)channel).startsWith(((String)"kline"))))
            {
                this.handleOHLCVUnSubscription(client, message);
            }
        }
