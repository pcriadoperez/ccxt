...
public class Bullish extends BullishApi
{
   ...
   public Bullish (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", Bullish.this.safeNumber(currency, "minFee") );
    ...
    public Object parseMarket(Object market)
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                symbol = Helpers.add(symbol, Helpers.add("-", datePart));
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "symbol", symbol );
            put( "type", Bullish.this.parseOrderType(type) );
            put( "timeInForce", timeInForce );
            put( "postOnly", Helpers.isEqual(type, "POST_ONLY") );
            put( "side", side );
            put( "price", price );
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Bullish.this.iso8601(timestamp) );
            put( "network", Bullish.this.networkIdToCode(network) );
    ...
    public Object parseDepositAddress(Object depositAddress, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "currency", Bullish.this.safeCurrencyCode(id, currency) );
            put( "network", Bullish.this.networkIdToCode(network) );
