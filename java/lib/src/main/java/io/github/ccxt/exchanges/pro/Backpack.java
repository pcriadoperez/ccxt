    ...
    public java.util.concurrent.CompletableFuture<Object> watchPrivate(Object topics, Object messageHashes, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "method", method );
                put( "params", topics );
                put( "signature", new java.util.ArrayList<Object>(java.util.Arrays.asList("apiKey", signature, ts, recvWindow)) );
            }};
            Object message = this.deepExtend(request, parameters);
            if (Helpers.isTrue(unwatch))
            {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(messageHashes)); i++)
        {
            ...
            } else if (Helpers.isTrue(Helpers.isGreaterThanOrEqual(Helpers.getIndexOf(messageHash, "orders"), 0)))
            {
                if (Helpers.isTrue(Helpers.isEqual(messageHash, "unsubscribe:orders")))
                {
                    ...
                    Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)cache).keySet());
