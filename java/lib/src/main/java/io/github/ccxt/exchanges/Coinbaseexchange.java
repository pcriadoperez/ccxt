...
public class Coinbaseexchange extends CoinbaseexchangeApi
{
   ...
   public Coinbaseexchange (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(response)); i++)
            {
                ...
                Object details = this.safeDict(currency, "details", new java.util.HashMap<String, Object>() {{}});
                Object networks = new java.util.HashMap<String, Object>() {{}};
                Object supportedNetworks = this.safeList(currency, "supported_networks", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        put( "name", name );
        put( "active", Helpers.isEqual(Coinbaseexchange.this.safeString(currency, "status"), "online") );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        put( "precision", Coinbaseexchange.this.safeNumber(currency, "max_precision") );
        put( "limits", new java.util.HashMap<String, Object>() {{
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(((ticker instanceof java.util.List) || (ticker.getClass().isArray()))))
        {
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "type", finalType );
            put( "currency", code );
            put( "network", Coinbaseexchange.this.networkIdToCode(networkId) );
