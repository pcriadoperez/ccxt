...
public class Paradex extends ParadexApi
{
   ...
   public Paradex (Object options) {
            ...
            put( "api", new java.util.HashMap<String, Object>() {{
                ...
                put( "private", new java.util.HashMap<String, Object>() {{
                    put( "get", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "points_data/{market}/{program}", 1 );
                    ...
                    put( "post", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "account/profile/max_slippage", 1 );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "status", ((Helpers.isTrue((Helpers.isEqual(status, "ok"))))) ? "ok" : "maintenance" );
                put( "updated", null );
                put( "eta", null );
                put( "url", null );
                put( "info", response );
    ...
    public Object parseMarket(Object market)
    {
        ...
        Object isOption = (Helpers.isEqual(assetKind, "PERP_OPTION"));
        ...
        if (Helpers.isTrue(isOption))
        {
            ...
            symbol = Helpers.add(Helpers.add(Helpers.add(Helpers.add(symbol, "-"), strikePrice), "-"), optionTypeSuffix);
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "side", side );
            put( "price", price );
            put( "triggerPrice", Paradex.this.safeString(order, "trigger_price") );
    ...
    public Object convertShortString(Object str)
    {
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orderReq = new java.util.HashMap<String, Object>() {{
                put( "timestamp", Helpers.multiply(now, 1000) );
                put( "market", Paradex.this.convertShortString(Helpers.GetValue(request, "market")) );
                put( "side", ((Helpers.isTrue((Helpers.isEqual(orderSide, "BUY"))))) ? "1" : "2" );
                put( "orderType", Paradex.this.convertShortString(Helpers.GetValue(request, "type")) );
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        Object url = Helpers.add(Helpers.add(this.implodeHostname(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), this.version)), "/"), this.implodeParams(path, parameters));
