...
public class Bitbns extends BitbnsApi
{
   ...
   public Bitbns (Object options) {
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)data).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOpenOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "uppercaseId") );
                put( "page", 0 );
                put( "side", ((Helpers.isTrue(isTrigger))) ? (Helpers.add(quoteSide, "StopOrders")) : (Helpers.add(quoteSide, "Orders")) );
            }};
