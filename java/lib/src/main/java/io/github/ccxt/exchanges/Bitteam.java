...
public class Bitteam extends BitteamApi
{
   ...
   public Bitteam (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencies)); i++)
            {
                ...
                Object networkIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)feesByNetworkId).keySet());
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue(Helpers.isTrue(Helpers.isTrue((!Helpers.isEqual(bids, null))) && Helpers.isTrue((((bids instanceof java.util.List) || (bids.getClass().isArray()))))) && Helpers.isTrue((!Helpers.isEqual(asks, null)))) && Helpers.isTrue((((asks instanceof java.util.List) || (asks.getClass().isArray()))))))
        {
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object rawCurrencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)balanceByCurrencies).keySet());
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Bitteam.this.iso8601(timestamp) );
            put( "network", Bitteam.this.networkIdToCode(finalNetworkId) );
