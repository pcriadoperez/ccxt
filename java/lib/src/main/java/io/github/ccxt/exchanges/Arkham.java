...
public class Arkham extends ArkhamApi
{
   public Arkham () {
       super();
   }

   public Arkham (Object options) {
       super(options);
   }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "id", networkId );
        put( "network", network );
        put( "title", Arkham.this.safeString(chain, "name") );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        ...
        put( "id", id );
        put( "code", code );
        put( "name", Arkham.this.safeString(currency, "name") );
        put( "active", Helpers.isEqual(Arkham.this.safeString(currency, "status"), "listed") );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", Arkham.this.safeNumber(currency, "withdrawalFee") );
        put( "precision", null );
        put( "limits", new java.util.HashMap<String, Object>() {{
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Arkham.this.safeNumber(currency, "minWithdrawal") );
                put( "max", null );
            }} );
            put( "deposit", new java.util.HashMap<String, Object>() {{
                put( "min", Arkham.this.safeNumber(currency, "minDeposit") );
                put( "max", null );
            }} );
        }} );
        put( "type", "crypto" );
    ...
    final Object finalSymbol = symbol;
                ...
                final Object finalMarketType = marketType;
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", Helpers.isEqual(Arkham.this.safeString(market, "status"), "listed") );
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "price", Arkham.this.safeNumber(market, "minTickPrice") );
                        put( "amount", Arkham.this.safeNumber(market, "minLotSize") );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", Arkham.this.safeNumber(market, "minSize") );
                            put( "max", Arkham.this.safeNumber(market, "maxSize") );
                        }} );
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", Arkham.this.safeNumber(market, "minPrice") );
                            put( "max", Arkham.this.safeNumber(market, "maxPrice") );
                        }} );
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Arkham.this.safeNumber(market, "minNotional") );
                            put( "max", null );
                        }} );
                    }} );
                    put( "created", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "symbol", Helpers.GetValue(market, "id") );
                put( "duration", Arkham.this.safeString(Arkham.this.timeframes, timeframe, timeframe) );
            }};
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            put( "info", ticker );
            put( "symbol", Arkham.this.safeSymbol(marketId, finalMarket) );
            put( "high", Arkham.this.safeNumber(ticker, "high24h") );
            put( "low", Arkham.this.safeNumber(ticker, "low24h") );
            put( "bid", Arkham.this.safeNumber(ticker, "bid") );
            put( "last", Arkham.this.safeNumber(ticker, "price") );
            put( "open", Arkham.this.safeNumber(ticker, "price24hAgo") );
            put( "change", Arkham.this.safeNumber(ticker, "priceChange") );
            put( "percentage", Arkham.this.safeNumber(ticker, "priceChangePercent") );
            put( "baseVolume", Arkham.this.safeNumber(ticker, "volume24h") );
            put( "quoteVolume", Arkham.this.safeNumber(ticker, "usdVolume24h") );
            put( "markPrice", Arkham.this.safeNumber(ticker, "markPrice") );
            put( "indexPrice", Arkham.this.safeNumber(ticker, "indexPrice") );
            put( "vwap", null );
            put( "average", null );
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "info", trade );
            put( "id", Arkham.this.safeString(trade, "revisionId") );
            put( "timestamp", timestamp );
            put( "datetime", Arkham.this.iso8601(timestamp) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", null );
            put( "side", Arkham.this.safeString2(trade, "userSide", "takerSide") );
            put( "takerOrMaker", null );
            put( "price", Arkham.this.safeString(trade, "price") );
            put( "amount", Arkham.this.safeString(trade, "size") );
            put( "cost", null );
            put( "fee", finalFee );
            put( "order", Arkham.this.safeString(trade, "orderId") );
        }}, market);
    }
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        Object request = new java.util.HashMap<String, Object>() {{
            put( "symbol", Helpers.GetValue(market, "id") );
            put( "side", side );
            put( "size", Arkham.this.amountToPrecision(finalSymbol, amount) );
        }};
...
final Object finalQuoteFeePaid = quoteFeePaid;
            final Object finalMarket = market;
                ...
                put( "currency", Arkham.this.safeString(finalMarket, "quote") );
            }});
        }
...
final Object finalArkmFeePaid = arkmFeePaid;
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "id", Arkham.this.safeString2(order, "orderId", "triggerOrderId") );
            put( "clientOrderId", Arkham.this.safeString(order, "clientOrderId") );
            put( "timestamp", timestamp );
            put( "datetime", Arkham.this.iso8601(timestamp) );
            put( "lastTradeTimeStamp", null );
            put( "lastUpdateTimestamp", Arkham.this.safeIntegerProduct(order, "lastTime", 0.001) );
            put( "status", Arkham.this.parseOrderStatus(Arkham.this.safeString(order, "status")) );
            put( "symbol", Helpers.GetValue(finalMarket, "symbol") );
            put( "type", orderType );
            put( "timeInForce", timeInForce );
            put( "postOnly", null );
            put( "side", Arkham.this.safeString(order, "side") );
            put( "price", Arkham.this.safeNumber(order, "price") );
            put( "triggerPrice", null );
            put( "cost", Arkham.this.safeNumber(order, "executedNotional") );
            put( "average", Arkham.this.safeNumberOmitZero(order, "avgPrice") );
            put( "amount", Arkham.this.safeNumber(order, "size") );
            put( "filled", Arkham.this.safeNumber(order, "") );
            put( "remaining", null );
            put( "trades", null );
            put( "fees", fees );
            put( "reduceOnly", Arkham.this.safeBool(order, "reduceOnly") );
            put( "info", order );
        }}, market);
    }
    ...
    public Object parseAccount(Object account)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Arkham.this.safeString(account, "id") );
            put( "type", null );
            put( "code", null );
            put( "info", account );
        }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddressesByNetwork(Object code, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            final Object finalNetworkCode = networkCode;
            Object request = new java.util.HashMap<String, Object>() {{
                put( "chain", Arkham.this.networkCodeToId(finalNetworkCode) );
            }};
    ...
    public Object parseDepositAddress(Object entry, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", entry );
            put( "currency", Arkham.this.safeString(currency, "code") );
            put( "network", null );
            put( "address", entry );
            put( "tag", null );
        }};
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "id", Arkham.this.safeString(transaction, "id") );
            put( "txid", Arkham.this.safeString(transaction, "transactionHash") );
            put( "type", null );
            put( "currency", code );
            put( "network", Arkham.this.networkIdToCode(Arkham.this.safeString(transaction, "chain")) );
            put( "amount", Arkham.this.safeNumber(transaction, "amount") );
    ...
    public Object parseIncome(Object income, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "info", income );
            put( "symbol", Arkham.this.safeSymbol(marketId, market) );
            put( "code", Arkham.this.safeCurrencyCode(currencyId) );
            put( "timestamp", timestamp );
            put( "datetime", Arkham.this.iso8601(timestamp) );
            put( "id", Arkham.this.safeString(income, "id") );
            put( "amount", Arkham.this.safeNumber(income, "amount") );
        }};
    }
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "id", null );
            put( "symbol", Arkham.this.safeSymbol(marketId, market) );
            put( "notional", Arkham.this.parseNumber(Precise.stringAbs(notional)) );
            put( "marginMode", null );
            put( "liquidationPrice", null );
            put( "entryPrice", Arkham.this.safeNumber(position, "averageEntryPrice") );
            put( "unrealizedPnl", Arkham.this.safeNumber(position, "pnl") );
            put( "realizedPnl", null );
            put( "percentage", null );
            put( "contracts", Arkham.this.parseNumber(baseAbs) );
            put( "contractSize", null );
            put( "markPrice", Arkham.this.safeNumber(position, "markPrice") );
            put( "lastPrice", null );
            put( "side", side );
            put( "hedged", null );
            put( "timestamp", null );
            put( "datetime", null );
            put( "lastUpdateTimestamp", Arkham.this.safeInteger(position, "lastUpdateTime") );
            put( "maintenanceMargin", Arkham.this.safeNumber(position, "maintenanceMargin") );
            put( "maintenanceMarginPercentage", null );
            put( "collateral", null );
            put( "initialMargin", Arkham.this.safeNumber(position, "initialMargin") );
    ...
    public java.util.concurrent.CompletableFuture<Object> withdraw(Object code, Object amount, Object address2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "amount", Arkham.this.currencyToPrecision(code, amount) );
                put( "subaccountId", Arkham.this.safeInteger(finalParameters, "subAccountId", 0) );
            }};
            Object networkCode = null;
            var networkCodeparametersVariable = this.handleNetworkCodeAndParams(parameters);
            networkCode = ((java.util.List<Object>) networkCodeparametersVariable).get(0);
...
final Object finalI = i;
            final Object finalMarket = market;
                ...
                put( "tier", Arkham.this.sum(finalI, 1) );
                put( "symbol", Arkham.this.safeSymbol(marketId, finalMarket, null, "swap") );
                put( "currency", curr );
                put( "minNotional", notional );
                put( "maxNotional", maxNotional );
                put( "maintenanceMarginRate", Arkham.this.safeNumber(tier, "marginRate") );
                put( "maxLeverage", Arkham.this.safeInteger(tier, "leverageRate") );
                put( "info", tier );
            }});
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(access, "private")))
        {
            ...
            headers = new java.util.HashMap<String, Object>() {{
                ...
                put( "Arkham-Api-Key", Arkham.this.apiKey );
