   ...
   public Kraken (Object options) {
    ...
    final Object finalBase = base;
                ...
                final Object finalPrecisionAmount = precisionAmount;
                    ...
                    put( "type", "spot" );
                    put( "spot", finalSpot );
                    put( "margin", (Helpers.isGreaterThan(leverageBuyLength, 0)) );
                    put( "swap", false );
                    put( "future", false );
                    put( "option", false );
                    put( "active", isActive );
                    ...
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        put( "leverage", new java.util.HashMap<String, Object>() {{
                            ...
                            put( "max", Kraken.this.safeNumber(leverageBuy, Helpers.subtract(leverageBuyLength, 1), 1) );
                        }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "status", ((Helpers.isTrue((Helpers.isEqual(statusRaw, "online"))))) ? "ok" : "maintenance" );
                put( "updated", null );
                put( "eta", null );
                put( "url", null );
                put( "info", response );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currencies).keySet());
        ...
        put( "code", finalCode );
        put( "info", currency );
        put( "name", Kraken.this.safeString(currency, "altname") );
        put( "active", Helpers.isEqual(Kraken.this.safeString(currency, "status"), "enabled") );
        put( "type", ((Helpers.isTrue(isFiat))) ? "fiat" : "crypto" );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        put( "precision", Kraken.this.parseNumber(Kraken.this.parsePrecision(Kraken.this.safeString(currency, "decimals"))) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", null );
                put( "max", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tickers).keySet());
            Object result = new java.util.HashMap<String, Object>() {{}};
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(ids)); i++)
            {
                Object id = Helpers.GetValue(ids, i);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchLedger(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)ledger).keySet());
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        Object fee = null;
        Object symbol = null;
        if (Helpers.isTrue(((trade instanceof java.util.List) || (trade.getClass().isArray()))))
        {
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)balances).keySet());
...
final Object finalId = id;
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderTrades(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var j = 0; Helpers.isLessThan(j, numBatches); j++)
            {
                ...
                Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)rawTrades).keySet());
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(ids)); i++)
                {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrdersByIds(Object ids, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orderIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)result).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrdersAfter(Object timeout2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            Object request = new java.util.HashMap<String, Object>() {{
                put( "timeout", ((Helpers.isTrue((Helpers.isGreaterThan(timeout, 0))))) ? (Kraken.this.parseToInt(Helpers.divide(timeout, 1000))) : 0 );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOpenOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orders = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            Object orderIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)open).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(orderIds)); i++)
            {
                Object id = Helpers.GetValue(orderIds, i);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchClosedOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orders = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            Object orderIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)closed).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(orderIds)); i++)
            {
                Object id = Helpers.GetValue(orderIds, i);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchWithdrawals(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (!Helpers.isTrue(((result instanceof java.util.List) || (result.getClass().isArray()))))
            {
