   ...
   public Bitso (Object options) {
    ...
    final Object finalQuote = quote;
                final Object finalBase = base;
                    ...
                    put( "optionType", null );
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Bitso.this.safeNumber(Helpers.GetValue(Bitso.this.options, "precision"), finalBase, Helpers.GetValue(Bitso.this.options, "defaultPrecision")) );
                        put( "price", Bitso.this.safeNumber(market, "tick_size", defaultPricePrecision) );
                    }} );
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrders(Object ids, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object symbol = Helpers.getArg(optionalArgs, 0, null);
            Object parameters = Helpers.getArg(optionalArgs, 1, new java.util.HashMap<String, Object>() {{}});
            if (!Helpers.isTrue(((ids instanceof java.util.List) || (ids.getClass().isArray()))))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrder(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(((payload instanceof java.util.List) || (payload.getClass().isArray()))))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionFees(Object... optionalArgs)
    {
        ...
        put( "info", new java.util.HashMap<String, Object>() {{
            ...
            Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)withdrawalFees).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyIds)); i++)
            {
                ...
                Helpers.addElementToObject(result, code, new java.util.HashMap<String, Object>() {{
        put( "deposit", Bitso.this.safeValue(Helpers.GetValue(result, code), "deposit") );
        put( "withdraw", Bitso.this.safeNumber(withdrawalFees, currencyId) );
        put( "info", new java.util.HashMap<String, Object>() {{
            put( "deposit", Bitso.this.safeValue(Helpers.GetValue(Helpers.GetValue(result, code), "info"), "deposit") );
            put( "withdraw", Bitso.this.safeNumber(withdrawalFees, currencyId) );
        }} );
    }});
            }
    ...
    put( "deposit", new java.util.HashMap<String, Object>() {{
        ...
        put( "percentage", !Helpers.isTrue(Bitso.this.safeValue(entry, "is_fixed")) );
    }} );
    ...
    put( "info", entry );
        ...
        Object withdrawalKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)withdrawalResponse).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> withdraw(Object code2, Object amount, Object address, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (Helpers.callDynamically(this, classMethod, new Object[] { this.extend(request, parameters) })).join();
            //
            //     {
            //         "success": true,
            //         "payload": [
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "address", ((Helpers.isTrue((!Helpers.isEqual(withdrawalAddress, null))))) ? withdrawalAddress : receivingAddress );
            put( "addressTo", withdrawalAddress );
            put( "amount", Bitso.this.safeNumber(transaction, "amount") );
            put( "type", ((Helpers.isTrue((Helpers.isEqual(withdrawId, null))))) ? "deposit" : "withdrawal" );
