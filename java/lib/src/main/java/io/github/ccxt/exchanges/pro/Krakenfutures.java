...
public class Krakenfutures extends io.github.ccxt.exchanges.Krakenfutures
{
   ...
   public Krakenfutures (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> subscribePrivate(Object name, Object messageHash, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object subscribe = new java.util.HashMap<String, Object>() {{
                ...
                put( "feed", name );
                put( "api_key", "apiKey");
                put( "original_challenge", Helpers.GetValue("options", "challenge") );
                put( "signed_challenge", Helpers.GetValue("options", "signedChallenge") );
            }};
            Object request = this.extend(subscribe, parameters);
            return (this.watch(url, messageHash, request, messageHash, null)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public Object parseWsPosition(Object position, Object... optionalArgs)
    {
        ...
        Object side = ((Helpers.isTrue((Helpers.isGreaterThan(balance, 0))))) ? "long" : "short";
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "contracts", Krakenfutures.this.parseNumber(Precise.stringAbs(Krakenfutures.this.numberToString(finalBalance))) );
    ...
    put( "rate", null );
    put( "cost", "0" );
    put( "currency", Krakenfutures.this.numberToString(Helpers.GetValue(Helpers.GetValue(trade, "fee"), "currency")) );
}});
                }
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "postOnly", null );
            put( "side", ((Helpers.isTrue((Helpers.isEqual(direction, 0))))) ? "buy" : "sell" );
            ...
            put( "amount", Krakenfutures.this.safeString(finalUnparsedOrder, "qty") );
            put( "cost", null );
            put( "average", null );
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        {
            Object holdingKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)holding).keySet()); // cashAccount
        ...
        {
            Object futuresKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)futures).keySet()); // marginAccount
        ...
        if (Helpers.isTrue(!Helpers.isEqual(flexFutures, null)))
        {
            ...
            Object flexFuturesKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)flexFutureCurrencies).keySet()); // multi-collateral margin account
    ...
    public void handleMyTrades(Client client, Object message)
    {
        ...
        Object tradeSymbolKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tradeSymbols).keySet());
