   ...
   public Okx (Object options) {
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "streaming", new java.util.HashMap<String, Object>() {{
                put( "ping", (java.util.function.Function<Client, Object>) Okx.this::ping );
                put( "keepAlive", 18000 );
            }} );
        }});
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                access = "business";
                final Object finalAccess0 = access;
                (this.authenticate(new java.util.HashMap<String, Object>() {{
                    put( "access", finalAccess0 );
                }})).join();
            }
            Object url = this.getUrl(channel, access);
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object symbol = Helpers.GetValue(symbols, i);
                ((java.util.List<Object>)messageHashes).add(Helpers.add(Helpers.add("unsubscribe:", channel), symbol));
                Object marketId = this.marketId(symbol);
                final Object finalChannel = channel;
                Object topic = new java.util.HashMap<String, Object>() {{
                    put( "channel", finalChannel );
            ...
            {
                access = "business";
                final Object finalAccess1 = access;
                (this.authenticate(new java.util.HashMap<String, Object>() {{
                    put( "access", finalAccess1 );
                }})).join();
            }
            Object url = this.getUrl(channel, access);
            return (this.watchMultiple(url, messageHashes, request, messageHashes, null)).join();
     ...
     */
    public java.util.concurrent.CompletableFuture<Object> watchFundingRates(Object symbols2, Object... optionalArgs)
    {
        final Object symbols3 = symbols2;
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            Object symbols = symbols3;
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyLiquidationsForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        put( "channel", channel );
            ...
            Object newLiquidations = (this.watchMultiple(url, messageHashes, this.deepExtend(request, parameters, null), messageHashes, null)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
                return newLiquidations;
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object future = client.reusableFuture((String) messageHash);
    ...
    public void handlePositions(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(Helpers.GetValue(position, "contracts"), 0)))
            {
    ...
    public void handleMyTrades(Client client, Object message)
    {
        ...
        Object tradeSymbols = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)symbols).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> editOrderWs(Object id, Object symbol, Object type, Object side, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.watch(url, messageHash, this.extend(request, parameters, null), messageHash, null)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrderWs(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object arg = new java.util.HashMap<String, Object>() {{
                put( "instId", Okx.this.marketId(finalSymbol) );
            }};
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "id", messageHash );
                put( "op", "cancel-order" );
                put( "args", new java.util.ArrayList<Object>(java.util.Arrays.asList(Okx.this.extend(finalArg, finalParameters2))) );
            }};
            return (this.watch(url, messageHash, request, messageHash, null)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrdersWs(Object ids, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.watch(url, messageHash, this.deepExtend(request, parameters, null), messageHash, null)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
