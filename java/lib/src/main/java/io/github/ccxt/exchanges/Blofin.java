   ...
   public Blofin (Object options) {
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            ...
            put( "linear", ((Helpers.isTrue(contract))) ? (Helpers.isEqual(quoteId, settleId)) : null );
            put( "inverse", ((Helpers.isTrue(contract))) ? (Helpers.isEqual(baseId, settleId)) : null );
    ...
    public Object parseBalanceByType(Object response)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue((!Helpers.isEqual(data, null))) && Helpers.isTrue(((data instanceof java.util.List) || (data.getClass().isArray())))))
        {
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        {
            Object key = ((Helpers.isTrue((!Helpers.isEqual(triggerPrice, null))))) ? "orderPrice" : "price";
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object hasTriggerPrice = !Helpers.isEqual(this.safeString(parameters, "triggerPrice"), null);
            Object isType2Order = (Helpers.isTrue(isStopLossPriceDefined) || Helpers.isTrue(isTakeProfitPriceDefined));
            Object response = null;
            ...
            Object isTpslOrder = Helpers.isTrue(Helpers.isTrue(tpsl) || Helpers.isTrue((Helpers.isEqual(method, "privatePostTradeOrderTpsl")))) || Helpers.isTrue(isType2Order);
            Object isTriggerOrder = Helpers.isTrue(hasTriggerPrice) || Helpers.isTrue((Helpers.isEqual(method, "privatePostTradeOrderAlgo")));
            if (Helpers.isTrue(isTpslOrder))
            {
            ...
            if (Helpers.isTrue(Helpers.isTrue(isTpslOrder) || Helpers.isTrue(isTriggerOrder)))
            {
    ...
    public Object createTpslOrderRequest(Object symbol, Object type, Object side, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(stopLossPrice, null)))
        {
            ...
            {
                Helpers.addElementToObject(request, "slOrderPrice", this.priceToPrecision(symbol, price));
            }
        } else if (Helpers.isTrue(!Helpers.isEqual(takeProfitPrice, null)))
        {
            ...
            {
                Helpers.addElementToObject(request, "tpOrderPrice", this.priceToPrecision(symbol, price));
            }
        }
        Helpers.addElementToObject(request, "marginMode", marginMode);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.privateGetTradeFillsHistory(this.extend(request, parameters))).join();
            Object data = this.safeList(response, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            return this.parseTrades(data, market, since, limit);
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    final Object finalIds = ids;
                        final Object finalI = i;
                                            ((java.util.List<Object>)request).add(new java.util.HashMap<String, Object>() {{
                            put( "orderId", Helpers.GetValue(finalIds, finalI) );
                            put( "instId", Helpers.GetValue(market, "id") );
                        }});
                    }
                }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositionMode(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "info", data );
                put( "hedged", Helpers.isEqual(positionMode, "long_short_mode") );
            }};
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
