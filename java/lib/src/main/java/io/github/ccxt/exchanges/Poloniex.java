   ...
   public Poloniex (Object options) {
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "average", null );
            put( "baseVolume", Poloniex.this.safeString2(ticker, "quantity", "qty") );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(response)); i++)
            {
                ...
                Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)item).keySet());
                Object id = this.safeString(ids, 0);
                Helpers.addElementToObject(currenciesDict, id, Helpers.GetValue(item, id));
            }
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currenciesDict).keySet());
        ...
        put( "numericId", Poloniex.this.safeInteger(chainEntry, "id") );
        put( "network", networkCode );
        put( "active", Poloniex.this.safeBool(chainEntry, "walletState") );
        put( "deposit", Helpers.isEqual(Poloniex.this.safeString(chainEntry, "walletDepositState"), "ENABLED") );
        put( "withdraw", Helpers.isEqual(Poloniex.this.safeString(chainEntry, "walletWithdrawalState"), "ENABLED") );
        put( "fee", Poloniex.this.safeNumber(chainEntry, "withdrawalFee") );
        put( "precision", null );
        put( "limits", new java.util.HashMap<String, Object>() {{
        ...
        put( "code", code );
        put( "id", id );
        put( "numericId", Poloniex.this.safeInteger(entry, "id") );
        put( "type", "crypto" );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        {
            if (!Helpers.isTrue(((resultingTrades instanceof java.util.List) || (resultingTrades.getClass().isArray()))))
            {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "postOnly", Helpers.isEqual(rawType, "LIMIT_MAKER") );
            put( "side", finalSide );
            put( "price", price );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositWithdrawFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(response)); i++)
            {
                ...
                Object currencies = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)entry).keySet());
    ...
    public Object parseDepositWithdrawFees(Object response, Object... optionalArgs)
    {
        ...
        Object responseKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.inOp(parameters, "symbol")))
        {
