...
public class Onetrading extends OnetradingApi
{
   ...
   public Onetrading (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "id", id );
        put( "code", code );
        put( "name", Onetrading.this.safeString(currency, "name") );
        put( "info", currency );
        put( "active", null );
        put( "fee", null );
        put( "precision", Onetrading.this.parseNumber(Onetrading.this.parsePrecision(Onetrading.this.safeString(currency, "precision"))) );
        put( "withdraw", null );
        put( "deposit", null );
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "symbol", symbol );
            put( "type", Onetrading.this.parseOrderType(type) );
