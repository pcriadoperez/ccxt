...
public class Zaif extends ZaifApi
{
   ...
   public Zaif (Object options) {
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)funds).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTrades(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(numTrades, 1)))
            {
                ...
                if (!Helpers.isTrue(Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)firstTrade).keySet()))))
                {
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type2, Object side2, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "action", ((Helpers.isTrue((Helpers.isEqual(side, "buy"))))) ? "bid" : "ask" );
                put( "amount", amount );
                put( "price", price );
            }};
