...
public class Woo extends io.github.ccxt.exchanges.Woo
{
   ...
   public Woo (Object options) {
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isGreaterThanOrEqual(amount, totalExecQuantity)))
        {
            remaining = Helpers.subtract(remaining, totalExecQuantity);
        }
    ...
    public void handlePositions(Client client, Object message)
    {
        ...
        Object postitionsIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)rawPositions).keySet());
