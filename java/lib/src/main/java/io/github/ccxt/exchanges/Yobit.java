...
public class Yobit extends YobitApi
{
   public Yobit () {
       super();
   }
   ...
   public Yobit (Object options) {
    ...
    public Object parseBalance(Object response)
    {
        ...
        Object result = new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Yobit.this.iso8601(timestamp) );
        }};
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.extend(free, total)).keySet());
    ...
    final Object finalQuote = quote;
                ...
                final Object finalFeeString = feeString;
                    ...
                    put( "future", false );
                    put( "option", false );
                    put( "active", (Helpers.isEqual(hidden, 0)) );
                    put( "contract", false );
                    put( "linear", null );
                    put( "inverse", null );
                    put( "taker", Yobit.this.parseNumber(finalFeeString) );
                    put( "maker", Yobit.this.parseNumber(finalFeeString) );
                    ...
                    put( "precision", new java.util.HashMap<String, Object>() {{
                        put( "amount", Yobit.this.parseNumber(Yobit.this.parsePrecision(Yobit.this.safeString(market, "decimal_places"))) );
                        put( "price", Yobit.this.parseNumber(Yobit.this.parsePrecision(Yobit.this.safeString(market, "decimal_places"))) );
                    }} );
                    put( "limits", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "amount", new java.util.HashMap<String, Object>() {{
                            put( "min", Yobit.this.safeNumber(market, "min_amount") );
                            put( "max", Yobit.this.safeNumber(market, "max_amount") );
                        }} );
                        put( "price", new java.util.HashMap<String, Object>() {{
                            put( "min", Yobit.this.safeNumber(market, "min_price") );
                            put( "max", Yobit.this.safeNumber(market, "max_price") );
                        }} );
                        put( "cost", new java.util.HashMap<String, Object>() {{
                            put( "min", Yobit.this.safeNumber(market, "min_total") );
                            put( "max", null );
                        }} );
                    }} );
                    put( "created", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderBooks(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.publicGetDepthPair(this.extend(request, parameters))).join();
            Object result = new java.util.HashMap<String, Object>() {{}};
            ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            put( "symbol", Yobit.this.safeSymbol(null, market) );
            put( "timestamp", timestamp );
            put( "datetime", Yobit.this.iso8601(timestamp) );
            put( "high", Yobit.this.safeString(ticker, "high") );
            put( "low", Yobit.this.safeString(ticker, "low") );
            put( "bid", Yobit.this.safeString(ticker, "buy") );
            put( "bidVolume", null );
            put( "ask", Yobit.this.safeString(ticker, "sell") );
            put( "askVolume", null );
            put( "vwap", null );
            put( "open", null );
            put( "close", last );
            ...
            put( "change", null );
            put( "percentage", null );
            put( "average", Yobit.this.safeString(ticker, "avg") );
            put( "baseVolume", Yobit.this.safeString(ticker, "vol_cur") );
            put( "quoteVolume", Yobit.this.safeString(ticker, "vol") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickersHelper(Object idsString, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object result = new java.util.HashMap<String, Object>() {{}};
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)tickers).keySet());
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(isYourOrder, null)))
        {
            if (Helpers.isTrue(Helpers.isEqual(fee, null)))
            {
                ...
                fee = new java.util.HashMap<String, Object>() {{
                    put( "currency", Yobit.this.safeString(feeInNumbers, "currency") );
                    put( "cost", Yobit.this.safeString(feeInNumbers, "cost") );
                    put( "rate", Yobit.this.safeString(feeInNumbers, "rate") );
                }};
            }
        }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTradingFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)pairs).keySet());
            Object result = new java.util.HashMap<String, Object>() {{}};
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type2, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "pair", Helpers.GetValue(market, "id") );
                put( "type", side );
                put( "amount", Yobit.this.amountToPrecision(symbol, amount) );
                put( "rate", Yobit.this.priceToPrecision(symbol, price) );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)trades).keySet());
            Object result = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(ids)); i++)
            {
