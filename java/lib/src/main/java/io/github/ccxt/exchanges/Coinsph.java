...
public class Coinsph extends CoinsphApi
{
   ...
   public Coinsph (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "id", id );
        put( "name", Coinsph.this.safeString(entry, "name") );
        put( "code", code );
        put( "type", ((Helpers.isTrue(isFiat))) ? "fiat" : "crypto" );
        put( "precision", Coinsph.this.parseNumber(Coinsph.this.parsePrecision(Coinsph.this.safeString(entry, "transferPrecision"))) );
        put( "info", entry );
        put( "active", null );
        put( "deposit", Coinsph.this.safeBool(entry, "depositAllEnable") );
        put( "withdraw", Coinsph.this.safeBool(entry, "withdrawAllEnable") );
    ...
    public Object urlEncodeQuery(Object... optionalArgs)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
        {
            ...
            if (Helpers.isTrue(((Helpers.GetValue(query, key) instanceof java.util.List) || (Helpers.GetValue(query, key).getClass().isArray()))))
            {
