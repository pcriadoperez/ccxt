   ...
   public Onetrading (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)subscription).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketIds)); i++)
            {
                Object marketIdtimeframes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)Helpers.GetValue(subscription, Helpers.GetValue(marketIds, i))).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMany(Object messageHash, Object request, Object subscriptionHash, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.markets_by_id).keySet());
            } else
            {
            ...
            Helpers.addElementToObject(Helpers.GetValue(Helpers.GetValue(request, "channels"), 0), "instrument_codes", new java.util.ArrayList<Object>(((java.util.Map<String, Object>)subscription).keySet()));
