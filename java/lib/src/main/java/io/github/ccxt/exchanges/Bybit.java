   ...
   public Bybit (Object options) {
            ...
            put( "api", new java.util.HashMap<String, Object>() {{
                ...
                put( "private", new java.util.HashMap<String, Object>() {{
                    put( "get", new java.util.HashMap<String, Object>() {{
                        ...
                        put( "v5/account/transaction-log", 1 );
    ...
    public Object createExpiredOptionMarket(Object symbol)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(finalBase, "-"), convertedExpireDate), "-"), strike), "-"), optionType) );
            put( "symbol", Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(finalBase, "/"), finalQuote), ":"), finalSettle), "-"), finalExpiry), "-"), strike), "-"), optionType) );
            put( "base", finalBase );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object linearMarkets = this.safeList(promises, 1, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            Object inverseMarkets = this.safeList(promises, 2, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            Object btcOptionMarkets = this.safeList(promises, 3, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            Object ethOptionMarkets = this.safeList(promises, 4, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            Object solOptionMarkets = this.safeList(promises, 5, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        put( "status", "PreLaunch" );
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(markets)); i++)
            {
                ...
                Object parsedMarket = this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
                    ...
                    put( "future", future );
                    put( "option", false );
                    put( "active", (Helpers.isEqual(status, "Trading")) );
                    put( "contract", true );
                    put( "linear", linear );
                    put( "inverse", inverse );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingRateHistory(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(paginate))
            {
                return (this.fetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", parameters, 200)).join();
            }
            if (Helpers.isTrue(Helpers.isEqual(limit, null)))
            {
                limit = 200;
            ...
            } else
            {
                if (Helpers.isTrue(!Helpers.isEqual(since, null)))
                {
                    ...
                    Helpers.addElementToObject(request, "endTime", Helpers.add(since, Helpers.multiply(limit, fundingInterval)));
                }
            }
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        Object feeCoins = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)cumFeeDetail).keySet());
    ...
    public Object createOrderRequest(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(endpointIsTradingStop))
        {
            ...
            if (Helpers.isTrue(Helpers.isTrue(isStopLossOrder) || Helpers.isTrue(isTakeProfitOrder)))
            {
                ...
                if (Helpers.isTrue(!Helpers.isEqual(tpslModeSl, tpslModeTp)))
                {
                ...
                Helpers.addElementToObject(request, "tpslMode", tpslModeSl); // same as tpslModeTp
                parameters = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("stopLossLimitPrice", "takeProfitLimitPrice")));
            }
        } else
        {
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrdersAfter(Object timeout2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            Object request = new java.util.HashMap<String, Object>() {{
                put( "timeWindow", Bybit.this.parseToInt(Helpers.divide(timeout, 1000)) );
            }};
            Object type = null;
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", Bybit.this.iso8601(timestamp) );
            put( "network", Bybit.this.networkIdToCode(Bybit.this.safeString(transaction, "chain")) );
            put( "address", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositions(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object symbol = null;
            if (Helpers.isTrue(Helpers.isTrue((!Helpers.isEqual(symbols, null))) && Helpers.isTrue(((symbols instanceof java.util.List) || (symbols.getClass().isArray())))))
            {
                Object symbolsLength = Helpers.getArrayLength(symbols);
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        Object marginMode = null;
        if (Helpers.isTrue(Helpers.isTrue((!Helpers.isTrue(Helpers.GetValue(this.options, "enableUnifiedAccount")))) || Helpers.isTrue((Helpers.isTrue(Helpers.GetValue(this.options, "enableUnifiedAccount")) && Helpers.isTrue(Helpers.GetValue(market, "inverse"))))))
        {
            // tradeMode would work for classic and UTA(inverse)
            if (!Helpers.isTrue(isHistory))
            {
                marginMode = ((Helpers.isTrue((Helpers.isEqual(tradeMode, 1))))) ? "isolated" : "cross";
            }
        }
        ...
        Object hedged = Helpers.isTrue((!Helpers.isEqual(positionIdx, null))) && Helpers.isTrue((!Helpers.isEqual(positionIdx, "0")));
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "initialMarginPercentage", Bybit.this.parseNumber(Precise.stringDiv(finalInitialMarginString, notional)) );
            ...
            put( "notional", Bybit.this.parseNumber(notional) );
            put( "leverage", Bybit.this.parseNumber(leverage) );
            put( "unrealizedPnl", Bybit.this.parseNumber(unrealisedPnl) );
            put( "realizedPnl", Bybit.this.safeNumber(position, "closedPnl") );
    ...
    public Object parseMarginLoan(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", null );
            put( "currency", Bybit.this.safeCurrencyCode(currencyId, currency) );
            put( "amount", Bybit.this.safeString(info, "amount") );
            put( "symbol", null );
            put( "timestamp", null );
            put( "datetime", null );
            put( "info", info );
    ...
    public Object parseLeverageTiers(Object response, Object... optionalArgs)
    {
        ...
        Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)grouped).keySet());
