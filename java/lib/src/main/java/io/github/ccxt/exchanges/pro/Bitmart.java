...
public class Bitmart extends io.github.ccxt.exchanges.Bitmart
{
   public Bitmart () {
       super();
   }
   ...
   public Bitmart (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> subscribe(Object channel, Object symbol, Object type2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                messageHash = Helpers.add(Helpers.add(Helpers.add("spot/", channel), ":"), Helpers.GetValue(market, "id"));

                final Object finalMessageHash = messageHash;
                request = new java.util.HashMap<String, Object>() {{
                    put( "op", finalRequestOp );
                    put( "args", new java.util.ArrayList<Object>(java.util.Arrays.asList(finalMessageHash)) );
                }};
            } else
            {
                messageHash = Helpers.add(Helpers.add(Helpers.add("futures/", channel), ":"), Helpers.GetValue(market, "id"));
                ...
                final Object finalMessageHash2 = messageHash;
                request = new java.util.HashMap<String, Object>() {{
                    put( "action", finalRequestOp );
                    put( "args", new java.util.ArrayList<Object>(java.util.Arrays.asList(finalMessageHash2)) );
                }};
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> subscribeMultiple(Object channel, Object type2, Object... optionalArgs)
    {
        final Object type3 = type2;
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            Object type = type3;
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
            {
                ...
                Object message = Helpers.add(Helpers.add(Helpers.add(Helpers.add(channelType, "/"), channel), ":"), Helpers.GetValue(market, "id"));
                Object subHash = Helpers.add(prefix, message);
                Object messageHash = Helpers.add(Helpers.add(Helpers.add(prefix, channel), ":"), Helpers.GetValue(market, "symbol"));
                ((java.util.List<Object>)rawSubscriptions).add(message);
                ((java.util.List<Object>)subHashes).add(subHash);
            ...
            return (this.watchMultiple(url, messageHashes, this.deepExtend(request, parameters), subHashes, null)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> loadBalanceSnapshot(Client client, Object messageHash2, Object type)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.fetchBalance(new java.util.HashMap<String, Object>() {{
                put( "type", type );
            }})).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object trades = (this.subscribeMultiple(channelName, marketType, symbols, parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.subscribeMultiple(channelName, marketType, symbols, parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            marketType = ((java.util.List<Object>) marketTypeparametersVariable).get(0);
            parameters = ((java.util.List<Object>) marketTypeparametersVariable).get(1);
            Object ticker = (this.subscribeMultiple("ticker", marketType, symbols, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.subscribeMultiple("ticker", marketType, symbols, parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBidsAsks(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object channelType = ((Helpers.isTrue((Helpers.isEqual(marketType, "spot"))))) ? "spot" : "futures";
            ...
            {
                Object market = this.market(Helpers.GetValue(symbols, i));
                ((java.util.List<Object>)rawSubscriptions).add(Helpers.add(Helpers.add(channelType, "/ticker:"), Helpers.GetValue(market, "id")));
                ((java.util.List<Object>)messageHashes).add(Helpers.add("bidask:", Helpers.GetValue(symbols, i)));
            }
            if (Helpers.isTrue(!Helpers.isEqual(marketType, "spot")))
            {
                rawSubscriptions = new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.add(channelType, "/ticker")));
            }
            ...
            Object newTickers = (this.watchMultiple(url, messageHashes, request, rawSubscriptions, null)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
                Object tickers = new java.util.HashMap<String, Object>() {{}};
    ...
    public Object parseWsBidAsk(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "ask", Bitmart.this.safeString2(ticker, "ask_px", "ask_price") );
            put( "askVolume", Bitmart.this.safeString2(ticker, "ask_sz", "ask_vol") );
            put( "bid", Bitmart.this.safeString2(ticker, "bid_px", "bid_price") );
            put( "bidVolume", Bitmart.this.safeString2(ticker, "bid_sz", "bid_vol") );
            put( "info", ticker );
        }}, market);
    }
    ...
    public void handleOrders(Client client, Object message)
    {
        ...
        Object messageHash = "orders";
        Object symbolKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)symbols).keySet());
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        } else
        {
            ...
            return this.safeOrder(new java.util.HashMap<String, Object>() {{
                ...
                put( "symbol", symbol );
                put( "id", orderId );
                put( "clientOrderId", Bitmart.this.safeString(orderInfo, "client_order_id") );
                put( "timestamp", timestamp );
                put( "datetime", Bitmart.this.iso8601(timestamp) );
                put( "lastTradeTimestamp", updatedTimestamp );
                put( "type", Bitmart.this.safeString(orderInfo, "type") );
                put( "timeInForce", null );
                put( "postOnly", null );
                put( "side", Bitmart.this.parseWsOrderSide(Bitmart.this.safeString(orderInfo, "side")) );
                put( "price", Bitmart.this.safeString(orderInfo, "price") );
                put( "stopPrice", null );
                put( "triggerPrice", null );
                put( "amount", Bitmart.this.safeString(orderInfo, "size") );
                put( "cost", null );
                put( "average", Bitmart.this.safeString(orderInfo, "deal_avg_price") );
                put( "filled", Bitmart.this.safeString(orderInfo, "deal_size") );
                put( "remaining", null );
                put( "status", Bitmart.this.parseWsOrderStatus(Bitmart.this.safeString(order, "action")) );
                put( "fee", null );
    ...
    public Object parseWsPosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", Bitmart.this.iso8601(openTimestamp) );
            put( "lastUpdateTimestamp", timestamp );
            put( "hedged", null );
            put( "side", ((Helpers.isTrue((Helpers.isEqual(side, 1))))) ? "long" : "short" );
            put( "contracts", Bitmart.this.safeNumber(position, "hold_volume") );
            put( "contractSize", Bitmart.this.safeNumber(finalMarket, "contractSize") );
            put( "entryPrice", Bitmart.this.safeNumber(position, "open_avg_price") );
            put( "markPrice", Bitmart.this.safeNumber(position, "hold_avg_price") );
            put( "lastPrice", null );
            put( "notional", null );
            put( "leverage", null );
            put( "collateral", null );
            ...
            put( "liquidationPrice", Bitmart.this.safeNumber(position, "liquidate_price") );
            put( "marginMode", ((Helpers.isTrue((Helpers.isEqual(marginModeId, 1))))) ? "isolated" : "cross" );
            put( "percentage", null );
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            put( "info", trade );
            put( "id", Bitmart.this.safeString(trade, "trade_id") );
            put( "order", null );
            ...
            put( "type", null );
            put( "side", finalSide );
            put( "price", Bitmart.this.safeString2(trade, "price", "deal_price") );
            put( "amount", Bitmart.this.safeString2(trade, "size", "deal_vol") );
            put( "cost", null );
    ...
    public Object parseWsSwapTicker(Object ticker, Object... optionalArgs)
    {
        ...
        Object marketId = this.safeString(ticker, "symbol");
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            put( "symbol", Bitmart.this.safeSymbol(marketId, market, "", "swap") );
            put( "timestamp", null );
            put( "datetime", null );
            put( "high", null );
            put( "low", null );
            put( "bid", Bitmart.this.safeString(ticker, "bid_price") );
            put( "bidVolume", Bitmart.this.safeString(ticker, "bid_vol") );
            put( "ask", Bitmart.this.safeString(ticker, "ask_price") );
            put( "askVolume", Bitmart.this.safeString(ticker, "ask_vol") );
            put( "vwap", null );
            put( "open", null );
            put( "close", null );
            put( "last", Bitmart.this.safeString(ticker, "last_price") );
            put( "previousClose", null );
            put( "change", null );
            put( "percentage", null );
            put( "average", null );
            put( "baseVolume", null );
            put( "quoteVolume", Bitmart.this.safeString(ticker, "volume_24") );
            put( "info", ticker );
            put( "markPrice", Bitmart.this.safeString(ticker, "mark_price") );
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object ohlcv = (this.subscribe(name, symbol, type, parameters)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.subscribe(name, symbol, type, parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBook(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orderbook = (this.subscribe(depth, symbol, type, parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOrderBook(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.subscribe(depth, symbol, type, parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(isSpot))
        {
            Object channel = Helpers.replace((String)channelName, (String)"spot/", (String)"");
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(datas)); i++)
            {
                ...
                Object messageHash = Helpers.add(Helpers.add(channelName, ":"), marketId);
                client.resolve(orderbook, messageHash);
                // resolve ForSymbols
                Object messageHashForMulti = Helpers.add(Helpers.add(channel, ":"), symbol);
                client.resolve(orderbook, messageHashForMulti);
            }
        } else
        {
            Object tableParts = Helpers.split(channelName, ":");
            Object channel = Helpers.replace((String)Helpers.GetValue(tableParts, 0), (String)"futures/", (String)"");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object orderbook = (this.subscribeMultiple(channel, type, symbols, parameters)).join();
            return Helpers.callDynamically(orderbook, "limit", new Object[]{});
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.subscribeMultiple(channel, type, symbols, parameters)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(authenticated, null)))
            {
                ...
                if (Helpers.isTrue(Helpers.isEqual(type, "spot")))
                {
                    request = new java.util.HashMap<String, Object>() {{
                        put( "op", "login" );
                        put( "args", new java.util.ArrayList<Object>(java.util.Arrays.asList("apiKey", timestamp, signature)) );
                    }};
                } else
                {
                    request = new java.util.HashMap<String, Object>() {{
                        put( "action", "access" );
                        put( "args", new java.util.ArrayList<Object>(java.util.Arrays.asList("apiKey", timestamp, signature, "web")) );
                    }};
                }
