   ...
   public Indodax (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOpenOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)rawOrders).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositsWithdrawals(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)withdraw).keySet());
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
                {
                    Object key = Helpers.GetValue(keys, i);
                    transactions = this.arrayConcat(transactions, Helpers.GetValue(withdraw, key));
                }
                keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)deposit).keySet());
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
                {
                    Object key = Helpers.GetValue(keys, i);
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "type", ((Helpers.isTrue((Helpers.isEqual(depositId, null))))) ? "withdraw" : "deposit" );
            put( "currency", Indodax.this.safeCurrencyCode(null, currency) );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchDepositAddresses(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object addressKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)addresses).keySet());
            Object result = new java.util.HashMap<String, Object>() {{
                put( "info", data );
            }};
