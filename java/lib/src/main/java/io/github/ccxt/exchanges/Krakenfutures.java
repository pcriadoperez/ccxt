   ...
   public Krakenfutures (Object options) {
        ...
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "api", new java.util.HashMap<String, Object>() {{
                ...
                put( "private", new java.util.HashMap<String, Object>() {{
                    put( "get", new java.util.ArrayList<Object>(java.util.Arrays.asList("feeschedules/volumes", "openpositions", "notifications", "accounts", "openorders", "recentorders", "fills", "transfers", "leveragepreferences", "pnlpreferences", "assignmentprogram/current", "assignmentprogram/history")) );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "interval", Helpers.GetValue(Krakenfutures.this.timeframes, timeframe) );
            }};
            ...
            if (Helpers.isTrue(!Helpers.isEqual(since, null)))
            {
                ...
                limit = Helpers.mathMin(limit, 5000);
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "amount", ((Helpers.isTrue(linear))) ? amount : null );
            put( "cost", finalCost );
            put( "fee", null );
        }});
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchClosedOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.historyGetOrders(this.extend(request, parameters))).join();
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.inOp(details, "tradeable")))
        {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "price", finalPrice );
            put( "triggerPrice", Krakenfutures.this.safeString(finalDetails, "triggerPrice") );
    ...
    public Object parseFundingRate(Object ticker, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isGreaterThan(fundingRateResult, "0.25")))
        {
            fundingRateResult = "0.25";
        } else if (Helpers.isTrue(Helpers.isGreaterThan(fundingRateResult, "-0.25")))
        {
            fundingRateResult = "-0.25";
        }
        if (Helpers.isTrue(Helpers.isGreaterThan(nextFundingRateResult, "0.25")))
        {
            nextFundingRateResult = "0.25";
        } else if (Helpers.isTrue(Helpers.isGreaterThan(nextFundingRateResult, "-0.25")))
        {
            nextFundingRateResult = "-0.25";
        }
...
final Object finalI = i;
    ...
    public java.util.concurrent.CompletableFuture<Object> setLeverage(Object leverage, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                ...
                put( "symbol", ((String)Krakenfutures.this.marketId(symbol)).toUpperCase() );
            }};
            //
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(path, "batchorder")))
        {
            ...
            body = postData;
        } else if (Helpers.isTrue(Helpers.getArrayLength(new java.util.ArrayList<Object>(((java.util.Map<String, Object>)parameters).keySet()))))
        {
