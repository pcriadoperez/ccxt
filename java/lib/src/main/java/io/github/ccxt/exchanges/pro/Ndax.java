...
public class Ndax extends io.github.ccxt.exchanges.Ndax
{
   ...
   public Ndax (Object options) {
    ...
    public void handleTrades(Client client, Object message)
    {
        ...
        Object symbols = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)updates).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object payload = new java.util.HashMap<String, Object>() {{
                put( "OMSId", omsId );
                put( "InstrumentId", Helpers.parseInt(Helpers.GetValue(market, "id")) );
                put( "Interval", Helpers.parseInt(Ndax.this.safeString("timeframes", timeframe, timeframe)) );
                put( "IncludeLastCount", 100 );
            }};
            final Object finalName = name;
            Object request = new java.util.HashMap<String, Object>() {{
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(payload)); i++)
        {
            ...
            Object keys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.timeframes).keySet());
        ...
        Object name = "SubscribeTicker";
        Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)updates).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketIds)); i++)
        {
            Object marketId = Helpers.GetValue(marketIds, i);
            Object timeframes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)Helpers.GetValue(updates, marketId)).keySet());
