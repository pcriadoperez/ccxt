   ...
   public Whitebit (Object options) {
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "api", new java.util.HashMap<String, Object>() {{
                ...
                put( "v4", new java.util.HashMap<String, Object>() {{
                    put( "public", new java.util.HashMap<String, Object>() {{
                        put( "get", new java.util.ArrayList<Object>(java.util.Arrays.asList("assets", "collateral/markets", "fee", "orderbook/depth/{market}", "orderbook/{market}", "ticker", "trades/{market}", "time", "ping", "markets", "futures", "platform/status", "mining-pool")) );
                    }} );
                    put( "private", new java.util.HashMap<String, Object>() {{
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            // }
            //
            Object ids = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
        ...
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "deposit", new java.util.HashMap<String, Object>() {{
                put( "min", Whitebit.this.safeNumber(depositLimits, "min") );
                put( "max", Whitebit.this.safeNumber(depositLimits, "max") );
            }} );
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Whitebit.this.safeNumber(withdrawLimits, "min") );
                put( "max", Whitebit.this.safeNumber(withdrawLimits, "max") );
            }} );
        }} );
    }});
                }
        ...
        put( "name", null );
        put( "active", null );
        put( "deposit", Whitebit.this.safeBool(currency, "can_deposit") );
        put( "withdraw", Whitebit.this.safeBool(currency, "can_withdraw") );
        put( "fee", null );
        put( "networks", null );
        put( "type", ((Helpers.isTrue(hasProvider))) ? "fiat" : "crypto" );
        put( "precision", Whitebit.this.parseNumber(Whitebit.this.parsePrecision(Whitebit.this.safeString(currency, "currency_precision"))) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", null );
                put( "max", null );
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", Whitebit.this.safeNumber(currency, "min_withdraw") );
                put( "max", Whitebit.this.safeNumber(currency, "max_withdraw") );
            }} );
            put( "deposit", new java.util.HashMap<String, Object>() {{
                put( "min", Whitebit.this.safeNumber(currency, "min_deposit") );
                put( "max", Whitebit.this.safeNumber(currency, "max_deposit") );
            }} );
        }} );
    }}));
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //      }
            //
            Object currenciesIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
    ...
    public Object parseDepositWithdrawFees(Object response, Object... optionalArgs)
    {
        ...
        Object currencyIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyIds)); i++)
        {
            ...
            if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(codes, null))) || Helpers.isTrue((this.inArray(code, codes)))))
            {
                ...
                Object depositResult = new java.util.HashMap<String, Object>() {{
                    put( "fee", depositFee );
                    put( "percentage", ((Helpers.isTrue((!Helpers.isEqual(depositFee, null))))) ? false : null );
                }};
    ...
    put( "deposit", depositResult );
        ...
        Object depositWithdrawCodes = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)depositWithdrawFees).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTradingLimits(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)this.markets).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingLimits(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //
            Object result = new java.util.HashMap<String, Object>() {{}};
            Object currencyKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)currenciesData).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyKeys)); i++)
            {
                ...
                Object feeData = null;
                Object feeKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)feesData).keySet());
                ...
                if (Helpers.isTrue(feeData))
                {
                    ...
                    if (Helpers.isTrue(depositFee))
                    {
                        Object depositFeeData = new java.util.HashMap<String, Object>() {{
                            put( "fixed", Whitebit.this.safeNumber(depositFee, "fixed") );
                        }};
        ...
        put( "min", Whitebit.this.safeNumber(Helpers.GetValue(depositFee, "flex"), "min_fee") );
        put( "max", Whitebit.this.safeNumber(Helpers.GetValue(depositFee, "flex"), "max_fee") );
        put( "percent", Whitebit.this.safeNumber(Helpers.GetValue(depositFee, "flex"), "percent") );
    }});
                        }
                    ...
                    if (Helpers.isTrue(withdrawFee))
                    {
                        Object withdrawFeeData = new java.util.HashMap<String, Object>() {{
                            put( "fixed", Whitebit.this.safeNumber(withdrawFee, "fixed") );
                        }};
        ...
        put( "min", Whitebit.this.safeNumber(Helpers.GetValue(withdrawFee, "flex"), "min_fee") );
        put( "max", Whitebit.this.safeNumber(Helpers.GetValue(withdrawFee, "flex"), "max_fee") );
        put( "percent", Whitebit.this.safeNumber(Helpers.GetValue(withdrawFee, "flex"), "percent") );
    }});
                        }
    ...
    public Object parseTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "average", null );
            put( "baseVolume", Whitebit.this.safeStringN(ticker, new java.util.ArrayList<Object>(java.util.Arrays.asList("base_volume", "volume", "baseVolume24h"))) );
            put( "quoteVolume", Whitebit.this.safeStringN(ticker, new java.util.ArrayList<Object>(java.util.Arrays.asList("quote_volume", "deal", "quoteVolume24h"))) );
            put( "info", ticker );
        }}, market);
    }
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(checkExecuted))
            {
                try
                {
                    ...
                    Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
                    for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketIds)); i++)
                    {
                        Object marketId = Helpers.GetValue(marketIds, i);
                        Object marketNew = this.safeMarket(marketId, null, "_");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return new java.util.HashMap<String, Object>() {{
                put( "status", ((Helpers.isTrue((Helpers.isEqual(status, "pong"))))) ? "ok" : status );
                put( "updated", null );
                put( "eta", null );
                put( "url", null );
                put( "info", response );
    ...
    {
        Object balanceKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)response).keySet());
        Object result = new java.util.HashMap<String, Object>() {{}};
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchAccounts(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isTrue(subAccounts) && Helpers.isTrue(((subAccounts instanceof java.util.List) || (subAccounts.getClass().isArray())))))
            {
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(subAccounts)); i++)
                {
                    ...
                    if (Helpers.isTrue(accountId))
                    {
                        ((java.util.List<Object>)accounts).add(new java.util.HashMap<String, Object>() {{
                            put( "id", accountId );
                            put( "type", "subaccount" );
                            put( "name", Helpers.isTrue(accountName) || Helpers.isTrue(Helpers.add("SubAccount ", accountId)) );
                            put( "code", null );
                            put( "info", subAccount );
                        }});
                    }
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "addressFrom", ((Helpers.isTrue((Helpers.isEqual(method, "1"))))) ? address : null );
            put( "address", address );
            put( "addressTo", ((Helpers.isTrue((Helpers.isEqual(method, "2"))))) ? address : null );
            put( "amount", Whitebit.this.safeNumber(transaction, "amount") );
            put( "type", ((Helpers.isTrue((Helpers.isEqual(method, "1"))))) ? "deposit" : "withdrawal" );
    ...
    public Object parseBorrowRate(Object info, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "currency", Whitebit.this.safeCurrencyCode(currencyId, currency) );
            put( "rate", Whitebit.this.parseNumber(Precise.stringDiv(percent, "100")) );
            put( "period", Whitebit.this.safeInteger(info, "duration") );
            put( "timestamp", null );
            put( "datetime", null );
            put( "info", info );
        }};
        ...
        if (Helpers.isTrue(!Helpers.isEqual(response, null)))
        {
            ...
            if (Helpers.isTrue(Helpers.isTrue(hasErrorStatus) || Helpers.isTrue(!Helpers.isEqual(codeNew, null))))
            {
                ...
                } else
                {
                    ...
                    Object errorKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)errorObject).keySet());
