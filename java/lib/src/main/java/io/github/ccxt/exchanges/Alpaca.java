   ...
   public Alpaca (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object marketIds = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)snapshots).keySet());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketIds)); i++)
            {
                ...
                Object ticker = this.safeTicker(new java.util.HashMap<String, Object>() {{
                    ...
                    put( "quoteVolume", Alpaca.this.safeString(dailyBar, "n") );
                }}, market);
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "txid", Alpaca.this.safeString(transaction, "tx_hash") );
            put( "timestamp", Alpaca.this.parse8601(datetime) );
            put( "datetime", datetime );
            put( "network", Alpaca.this.safeString(transaction, "chain") );
            put( "address", Alpaca.this.safeString(transaction, "to_address") );
            put( "addressTo", Alpaca.this.safeString(transaction, "to_address") );
            put( "addressFrom", Alpaca.this.safeString(transaction, "from_address") );
            put( "tag", null );
            put( "tagTo", null );
            put( "tagFrom", null );
            put( "type", Alpaca.this.parseTransactionType(Alpaca.this.safeString(transaction, "direction")) );
            put( "amount", Alpaca.this.safeNumber(transaction, "amount") );
            put( "currency", code );
            put( "status", Alpaca.this.parseTransactionStatus(Alpaca.this.safeString(transaction, "status")) );
            put( "updated", null );
            put( "fee", fee );
            put( "comment", null );
            put( "internal", null );
