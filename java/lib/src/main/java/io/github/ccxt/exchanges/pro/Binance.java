   ...
   public Binance (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchLiquidationsForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), type), "/"), this.stream(type, streamHash, numSubscriptions));
            ...
            Object newLiquidations = (this.watchMultiple(url, messageHashes, this.extend(request, parameters, null), subscriptionHashes, subscribe)).join();
    ...
    public void handleLiquidation(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(liquidations, null)))
        {
            ...
            liquidations = new ArrayCache(((Number)limit).intValue());
        }
        Helpers.callDynamically(liquidations, "append", new Object[]{liquidation});
        Helpers.addElementToObject(this.liquidations, symbol, liquidations);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyLiquidationsForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), type), "/"), Helpers.GetValue(Helpers.GetValue(this.options, type), "listenKey"));
            Object message = null;
            Object newLiquidations = (this.watchMultiple(url, messageHashes, message, new java.util.ArrayList<Object>(java.util.Arrays.asList(type, null)), null)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
                return newLiquidations;
            }
    ...
    public void handleMyLiquidation(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(myLiquidations, null)))
        {
            Object limit = this.safeInteger(this.options, "myLiquidationsLimit", 1000);
            myLiquidations = new ArrayCache(((Number)limit).intValue());
        }
        Helpers.callDynamically(myLiquidations, "append", new Object[]{liquidation});
        Helpers.addElementToObject(this.myLiquidations, symbol, myLiquidations);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), type), "/"), this.stream(type, streamHash, messageHashesLength));
            Object requestId = this.requestId(url);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "method", "SUBSCRIBE" );
            ...
            Object orderbook = (this.watchMultiple(url, messageHashes, this.extend(request, parameters, null), messageHashes, subscription)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.watchMultiple(url, messageHashes, this.extend(request, parameters, null), messageHashes, subscription)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public void handleOrderBookSubscription(Client client, Object message, Object subscription)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
        {
            ...
            final Object finalSubscription = subscription;
            this.spawn(() -> { try { this.fetchOrderBookSnapshot(client, message, finalSubscription); } catch(Exception _e) { throw new RuntimeException(_e); } });
        }
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), type), "/"), this.stream(type, streamHash, subParamsLength));
            Object requestId = this.requestId(url);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "method", "SUBSCRIBE" );
                put( "params", subParams );
            ...
            Object trades = (this.watchMultiple(url, messageHashes, this.extend(request, query, null), messageHashes, subscribe)).join();
            if (Helpers.isTrue(this.newUpdates))
            {
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return (this.watchMultiple(url, messageHashes, this.extend(request, query, null), messageHashes, subscription)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCVForSymbols(Object symbolsAndTimeframes, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), type), "/"), this.stream(type, "multipleOHLCV"));
            Object requestId = this.requestId(url);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "method", "SUBSCRIBE" );
            ...
            parameters = this.omit(parameters, "callerMethodName");
            Object res = (this.watchMultiple(url, messageHashes, this.extend(request, parameters, null), messageHashes, subscribe)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCVForSymbols(Object symbolsAndTimeframes, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            parameters = this.omit(parameters, "callerMethodName");
            return (this.watchMultiple(url, messageHashes, this.extend(request, parameters, null), messageHashes, subscribe)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object tickers = (this.watchTickers(new java.util.ArrayList<Object>(java.util.Arrays.asList(symbol)), this.extend(parameters, new java.util.HashMap<String, Object>() {{
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMarkPrice(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            (this.loadMarkets()).join();
            symbol = this.symbol(symbol);
            Object tickers = (this.watchMarkPrices(new java.util.ArrayList<Object>(java.util.Arrays.asList(symbol)), this.extend(parameters, new java.util.HashMap<String, Object>() {{
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMultiTickerHelper(Object methodName, Object channelName2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), rawMarketType), "/"), this.stream(rawMarketType, streamHash));
            Object requestId = this.requestId(url);
            Object request = new java.util.HashMap<String, Object>() {{
            ...
            Object result = (this.watchMultiple(url, hashes, this.deepExtend(request, parameters, null), hashes, subscription)).join();
            if (Helpers.isTrue(isUnsubscribe))
            {
                return result;
            }
    ...
    public Object parseWsTicker(Object message, Object marketType)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(eventVar, "markPriceUpdate")))
        {
            ...
            return this.safeTicker(new java.util.HashMap<String, Object>() {{
                ...
                put( "info", message );
                put( "markPrice", Binance.this.safeString(message, "p") );
    ...
    public void handleTickersAndBidsAsks(Client client, Object message, Object methodType)
    {
        ...
        if (Helpers.isTrue(((message instanceof java.util.List) || (message.getClass().isArray()))))
        {
            rawTickers = message;
        } else
        {
    ...
    public java.util.concurrent.CompletableFuture<Object> ensureUserDataStreamWsSubscribeSignature(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object subscriptionsKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)subscriptions).keySet());
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object isCrossMargin = Helpers.isTrue((Helpers.isEqual(marginMode, "cross"))) || Helpers.isTrue((Helpers.isEqual(marginMode, null)));
            ...
            if (Helpers.isTrue(Helpers.isGreaterThan(Helpers.subtract(time, lastAuthenticatedTime), delay)))
            {
                ...
                } else if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(type, "margin")) && Helpers.isTrue(isCrossMargin)))
                {
                    response = (this.sapiPostUserDataStream(parameters)).join();
                } else if (Helpers.isTrue(isIsolatedMargin))
                {
                    if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
                    {
                        throw new ArgumentsRequired((String)Helpers.add(this.id, " authenticate() requires a symbol argument for isolated margin mode")) ;
                    }
                    ...
                    response = (this.sapiPostUserDataStreamIsolated(parameters)).join();
                } else
                {
        ...
        put( "listenKey", Binance.this.safeString(finalResponse, "listenKey") );
        put( "lastAuthenticatedTime", finalTime );
    }}));
                final Object finalParameters2 = parameters;
                this.spawn(() -> { try { Thread.sleep(((Number)listenKeyRefreshRate).longValue()); this.keepAliveListenKey(finalParameters2); } catch(Exception _e) {} });
                return null;
            }
            return null;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> keepAliveListenKey(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                ...
                } else
                {
                    ...
                    if (Helpers.isTrue(Helpers.isEqual(type, "margin")))
                    {
                        ...
                        (this.sapiPutUserDataStream(this.extend(request, parameters))).join();
                    } else
                    {
            ...
            } catch(Exception error)
            {
                ...
                Object url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), urlType), "/"), Helpers.GetValue(Helpers.GetValue(this.options, type), "listenKey"));
                Client client = this.client(url);
        ...
        put( "lastAuthenticatedTime", time );
            ...
            Object clients = new java.util.ArrayList<Object>(((java.util.Map)this.clients).values());
            Object listenKeyRefreshRate = this.safeInteger(this.options, "listenKeyRefreshRate", 1200000);
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(clients)); i++)
            {
                Client client = (Client)Helpers.GetValue(clients, i);
                Object subscriptionKeys = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)((java.util.Map)client.subscriptions)).keySet());
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(subscriptionKeys)); j++)
                {
                    ...
                    {
                        final Object finalParameters3 = parameters;
                        this.spawn(() -> { try { Thread.sleep(((Number)listenKeyRefreshRate).longValue()); this.keepAliveListenKey(finalParameters3); } catch(Exception _e) {} });
                        return null;
                    }
                }
                return null;
    ...
    public java.util.concurrent.CompletableFuture<Object> loadBalanceSnapshot(Client client, Object messageHash2, Object type2, Object isPortfolioMargin)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object response = (this.fetchBalance(parameters)).join();
            ...
            if (Helpers.isTrue(Helpers.inOp(client.futures, messageHash)))
            {
                Object future = Helpers.GetValue(client.futures, messageHash);
                Helpers.callDynamically(future, "resolve", new Object[]{null});
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalanceWs(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            final Object finalMethod2 = method;
            Object subscription = new java.util.HashMap<String, Object>() {{
                put( "method", ((Helpers.isTrue((Helpers.isEqual(finalMethod2, "account.status"))))) ? "handleAccountStatusWs" : "handleBalanceWs");
            }};
            return (this.watch(url, messageHash, message, messageHash, subscription)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public void handleBalanceWs(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(((Helpers.GetValue(message, "result") instanceof java.util.List) || (Helpers.GetValue(message, "result").getClass().isArray()))))
        {
            // account.balance
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(type, "spot")))
            {
                ...
                url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "ws-api"), type);
            } else
            {
                if (Helpers.isTrue(isPortfolioMargin))
                {
                ...
                url = Helpers.add(Helpers.add(Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), urlType), "/"), Helpers.GetValue(Helpers.GetValue(this.options, type), "listenKey"));
            }
            Client client = this.client(url);
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            ...
            put( "type", Binance.this.parseOrderType(Binance.this.safeStringLower(order, "o")) );
    ...
    public java.util.concurrent.CompletableFuture<Object> loadPositionsSnapshot(Client client, Object messageHash2, Object type2, Object isPortfolioMargin)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object positions = (this.fetchPositions(null, parameters)).join();
            Helpers.addElementToObject(this.positions, type, new ArrayCache.ArrayCacheBySymbolBySide());
    ...
    public void handleWsError(Client client, Object message)
    {
        ...
        } catch(Exception e)
        {
            ...
            Object subscriptionKeys = new java.util.ArrayList<Object>(((java.util.Map)client.subscriptions).keySet());
        ...
        {
            Helpers.callDynamically(client, "reset", new Object[]{message});
        }
    }
