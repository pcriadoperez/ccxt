   ...
   public Binance (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCVWs(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object payload = new java.util.HashMap<String, Object>() {{
                ...
                put( "interval", Helpers.GetValue("timeframes", timeframe) );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        put( "lastAuthenticatedTime", finalTime );
                ...
                this.spawn(() -> { try { Thread.sleep(((Number)listenKeyRefreshRate).longValue()); this.keepAliveListenKey(_final_parameters); } catch(Exception _e) {} });
            }
            return null;
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalanceWs(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object subscription = new java.util.HashMap<String, Object>() {{
                put( "finalMethod2", ((Helpers.isTrue((Helpers.isEqual(finalMethod2, "account.status"))))) ? "handleAccountStatusWs" : "handleBalanceWs");
            }};
            return (this.watch(url, messageHash, message, messageHash, subscription)).join();
        }, io.github.ccxt.Exchange.VIRTUAL_EXECUTOR);
