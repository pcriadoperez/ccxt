   ...
   public Gemini (Object options) {
    ...
    public void handleTradesForMultidata(Client client, Object trades, Object timestamp)
    {
        if (Helpers.isTrue(!Helpers.isEqual(trades, null)))
        {
            ...
            Object symbols = new java.util.ArrayList<Object>(((java.util.Map<String, Object>)storesForSymbols).keySet());
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        //     ]
        //
        Object isArray = ((message instanceof java.util.List) || (message.getClass().isArray()));
