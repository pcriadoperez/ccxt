...
public partial class kucoin : ccxt.kucoin
{
    ...
    public virtual void handleOHLCV(WebSocketClient client, object message)
    {
        ...
        object ohlcvs = this.createStreamOHLCV(symbol, timeframe, ohlcv);
    ...
    public virtual void handleOrderBook(WebSocketClient client, object message)
    {
        ...
        this.streamProduce("orderbooks", getValue(this.orderbooks, symbol));
    ...
    public virtual void handleBalance(WebSocketClient client, object message)
    {
        ...
        {
            this.streamProduce("balances", getValue(this.balance, uniformType));
