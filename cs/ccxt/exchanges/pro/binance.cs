...
public partial class binance : ccxt.binance
{
    ...
    public virtual object streamId(object type, object subscriptionHash, object numSubscriptions = null)
    {
        numSubscriptions ??= 1;
    ...
    public async override Task<object> watchLiquidationsForSymbols(object symbols, object since = null, object limit = null, object parameters = null)
    {
        ...
        object url = add(add(this.getWsUrl(type, this.getFutureWsCategory("forceOrder")), "/"), this.streamId(type, streamHash, numSubscriptions));
    ...
    public async override Task<object> watchOrderBookForSymbols(object symbols, object limit = null, object parameters = null)
    {
        ...
        object url = add(add(this.getWsUrl(type, this.getFutureWsCategory(name)), "/"), this.streamId(type, streamHash, messageHashesLength));
        object requestId = this.requestId(url);
        object request = new Dictionary<string, object>() {
            { "method", "SUBSCRIBE" },
            { "params", subParams },
    ...
    public async override Task<object> unWatchOrderBookForSymbols(object symbols, object parameters = null)
    {
        ...
        object url = add(add(this.getWsUrl(type, this.getFutureWsCategory("depth")), "/"), this.streamId(type, streamHash, messageHashesLength));
        object requestId = this.requestId(url);
        object request = new Dictionary<string, object>() {
            { "method", "UNSUBSCRIBE" },
            { "params", subParams },
    ...
    public async virtual Task fetchOrderBookSnapshot(WebSocketClient client, object message, object subscription)
    {
        ...
        } catch(Exception e)
        {
            ...
            this.streamProduce("orderbooks", null, e);
        }
    }
    ...
    public virtual void handleOrderBook(WebSocketClient client, object message)
    {
        ...
        } else
        {
            ...
            } catch(Exception e)
            {
                ...
                ((WebSocketClient)client).reject(e, messageHash);
                this.streamProduce("orderbooks", null, e);
                this.streamProduce(add("orderbooks::", symbol), null, e);
            }
        }
    }
    ...
    public async override Task<object> watchTradesForSymbols(object symbols, object since = null, object limit = null, object parameters = null)
    {
        ...
        object url = add(add(this.getWsUrl(type, this.getFutureWsCategory(name)), "/"), this.streamId(type, streamHash, subParamsLength));
        object requestId = this.requestId(url);
        object request = new Dictionary<string, object>() {
            { "method", "SUBSCRIBE" },
            { "params", subParams },
    ...
    public async override Task<object> watchOHLCVForSymbols(object symbolsAndTimeframes, object since = null, object limit = null, object parameters = null)
    {
        ...
        object url = add(add(this.getWsUrl(type, this.getFutureWsCategory(klineType)), "/"), this.streamId(type, "multipleOHLCV"));
        object requestId = this.requestId(url);
        object request = new Dictionary<string, object>() {
            { "method", "SUBSCRIBE" },
            { "params", rawHashes },
    ...
    public virtual void handleOHLCV(WebSocketClient client, object message)
    {
        ...
        object ohlcvs = this.createStreamOHLCV(symbol, unifiedTimeframe, parsed);
    ...
    public async virtual Task<object> watchMultiTickerHelper(object methodName, object channelName, object symbols = null, object parameters = null, object isUnsubscribe = null)
    {
        ...
        object url = add(add(this.getWsUrl(rawMarketType, this.getFutureWsCategory(channelName)), "/"), this.streamId(rawMarketType, streamHash));
        object requestId = this.requestId(url);
        object request = new Dictionary<string, object>() {
    ...
    public virtual void handleBalance(WebSocketClient client, object message)
    {
        ...
        this.streamProduce("balances", getValue(this.balance, accountType));
    ...
    public virtual void handleTradesWs(WebSocketClient client, object message)
    {
        ...
        {
            this.streamProduce("myTrades", getValue(trades, i));
        }
    ...
    public virtual void handleWsError(WebSocketClient client, object message)
    {
        ...
        if (isTrue(isTrue((!isEqual(codeString, null))) && isTrue((isEqual(getValue(codeString, 0), "5")))))
        {
            ...
            this.streamProduce("errors", null, message);
        }
    }
