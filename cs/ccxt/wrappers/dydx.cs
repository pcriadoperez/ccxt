...
public partial class dydx
{
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#get-candles"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#get-historical-funding"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#get-order"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#list-orders"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    ...
    /// </item>
    /// <item>
    /// <term>params.subAccountNumber</term>
    /// <description>
    /// string : sub account number
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#list-positions"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/interaction/trading#place-an-order"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>price</term>
    /// <description>
    ...
    /// </item>
    /// <item>
    /// <term>params.goodTillBlock</term>
    /// <description>
    /// float : expired block number for the order, required for market order and non limit GTT order, default value is latestBlockHeight + 20
    /// </description>
    /// </item>
    /// <item>
    /// <term>params.goodTillBlockTimeInSeconds</term>
    /// <description>
    /// float : expired time elapsed for the order, required for limit GTT order and conditional, default value is 30 days
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/interaction/trading/#cancel-an-order"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// <term>params.clientOrderId</term>
    /// <description>
    /// string : client order id used when creating the order
    /// </description>
    /// </item>
    /// <item>
    ...
    /// </item>
    /// <item>
    /// <term>params.orderFlags</term>
    /// <description>
    /// float : default is 64, orderFlags for the order, market order and non limit GTT order is 0, limit GTT order is 64 and conditional order is 32
    /// </description>
    /// </item>
    /// <item>
    /// <term>params.goodTillBlock</term>
    /// <description>
    /// float : expired block number for the order, required for market order and non limit GTT order (orderFlags = 0), default value is latestBlockHeight + 20
    /// </description>
    /// </item>
    /// <item>
    /// <term>params.goodTillBlockTimeInSeconds</term>
    /// <description>
    /// float : expired time elapsed for the order, required for limit GTT order and conditional (orderFlagss > 0), default value is 30 days
    /// </description>
    /// </item>
    /// <item>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#get-transfers"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>code</term>
    /// <description>
    ...
    public async Task<List<Dictionary<string, object>>> FetchTransactionsHelper(string code = null, Int64? since2 = 0, Int64? limit2 = 0, Dictionary<string, object> parameters = null)
    {
        var since = since2 == 0 ? null : (object)since2;
        var limit = limit2 == 0 ? null : (object)limit2;
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://docs.dydx.xyz/indexer-client/http#get-subaccounts"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
