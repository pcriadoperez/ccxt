...
public partial class ascendex
{
    ...
    /// </list>
    /// </remarks>
    /// <returns> <term>object[]</term> a list with a single [order structure]{@link https://docs.ccxt.com/?id=order-structure} with the response assigned to the info property.</returns>
