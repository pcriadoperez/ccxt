...
export default class Exchange {
    ...
    streamToSymbol(topic: Topic): (message: Message) => void;
    streamReconnectOnError(): (message: Message) => Promise<void>;
    streamOHLCVS(): (message: Message) => void;
    ...
    setupStream(): void;
    streamProduce(topic: Topic, payload?: any, error?: any): void;
    streamReconnect(): Promise<any[]>;
    describe(): any;
    ...
    subscribeLiquidations(symbol: string, callback: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeLiquidationsForSymbols(symbols: string[], callback: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeTrades(symbol: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribeTrades(symbol: string, callback: ConsumerFunction): boolean;
    unWatchOrders(symbol?: Str, params?: {}): Promise<any>;
    unWatchTrades(symbol: string, params?: {}): Promise<any>;
    watchTradesForSymbols(symbols: string[], since?: Int, limit?: Int, params?: {}): Promise<Trade[]>;
    subscribeTradesForSymbols(symbols: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeMyTradesForSymbols(symbols: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeOrdersForSymbols(symbols: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeOHLCVForSymbols(symbolsAndTimeframes: string[][], callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribeOHLCVForSymbols(symbolsAndTimeframes: string[][], callback: ConsumerFunction): boolean;
    unWatchOHLCVForSymbols(symbolsAndTimeframes: string[][], params?: {}): Promise<any>;
    watchOrderBookForSymbols(symbols: string[], limit?: Int, params?: {}): Promise<OrderBook>;
    subscribeOrderBookForSymbols(symbols: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeOrderBook(symbol: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeOHLCV(symbol: string, timeframe?: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribeOHLCV(symbol: string, callback: ConsumerFunction, timeframe?: string): boolean;
    ...
    subscribePosition(symbol: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribePosition(symbol: string, callback: ConsumerFunction): boolean;
    watchPositions(symbols?: Strings, since?: Int, limit?: Int, params?: {}): Promise<Position[]>;
    subscribePositions(symbols?: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribePositions(callback: ConsumerFunction, symbols?: string[]): boolean;
    watchPositionForSymbols(symbols?: Strings, since?: Int, limit?: Int, params?: {}): Promise<Position[]>;
    subscribePositionForSymbols(symbols?: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribePositionForSymbols(callback: ConsumerFunction, symbols?: string[]): boolean;
    ...
    subscribeBalance(callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeTicker(symbol: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    ...
    subscribeTickers(symbols?: string[], callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribeTickers(callback: ConsumerFunction, symbols?: string[]): boolean;
    ...
    subscribeRaw(callback: ConsumerFunction, params?: any): void;
    ...
    subscribeOrders(symbol?: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribeOrders(callback: ConsumerFunction, symbol?: string): boolean;
    ...
    subscribeMyTrades(symbol?: string, callback?: ConsumerFunction, params?: any): Promise<any>;
    unsubscribeMyTrades(callback: ConsumerFunction, symbol?: string): boolean;
    ...
    createStreamOHLCV(symbol: Str, timeframe: Str, data: any): Dictionary<any>;
